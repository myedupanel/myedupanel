    ...
    <>
      ...
      <section className="pricing-hero">
        <div className="container">
          ...
          <h2>Transparent, Per-Student Pricing</h2>
          <p className="pricing-description">Simple, predictable pricing that grows with your institution. All features included, no hidden fees.<br />Special discounts available for large institutions.</p>
        </div>
      </section>
      ...
      <section className="pricing-container" id="pricing-section">
        <div className="container">
          <div className="pricing-toggle">
            <button className={`toggle-btn ${pricingPeriod === 'monthly' ? 'active' : ''}`} onClick={() => setPricingPeriod('monthly')}>Monthly</button>
            <button className={`toggle-btn ${pricingPeriod === 'annually' ? 'active' : ''}`} onClick={() => setPricingPeriod('annually')}>Annually (Save 29%)</button>
          </div>
          <div className="pricing-box">
            <div className="pricing-details">
              <h2>{pricingPeriod === 'monthly' ? 'Monthly School License' : 'Annual License (Best Value)'}</h2>
              <p>{pricingPeriod === 'monthly' ? 'Get complete access to our comprehensive school management system with all features included. Perfect for schools of any size with flexible scaling options.' : 'Get the best value and save 29%! Pay for the full year and unlock all features without any interruptions.'}</p>
              <h3>Everything you need included</h3>
              <ul className="features-list">
                <li><span className="checkmark">✓</span> Complete Student Management System</li>
                <li><span className="checkmark">✓</span> Academic & Examination Tools</li>
                <li><span className="checkmark">✓</span> Parent-Teacher Communication Platform</li>
                <li><span className="checkmark">✓</span> Basic Financial Management</li>
                <li><span className="checkmark">✓</span> Attendance Tracking System</li>
                <li><span className="checkmark">✓</span> Real-time Notifications</li>
                <li><span className="checkmark">✓</span> 24/7 Customer Support</li>
                <li><span className="checkmark">✓</span> Regular System Updates</li>
              </ul>
            </div>
            <div className="pricing-card">
              <h4>Simple per-student pricing</h4>
              <div className="price">${pricingPeriod === 'monthly' ? '3' : (3 * (1 - 0.29)).toFixed(2)} <span className="price-unit">USD /student/month</span></div>
              <button className="cta-button">{pricingPeriod === 'monthly' ? 'Start Free Trial' : 'Lock In 29% Discount'}</button>
              <p className="trial-info">{pricingPeriod === 'monthly' ? '9-day free trial • No credit card required • Volume discounts available' : 'Billed annually • Unbeatable value • Limited time offer'}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="modal-overlay" onClick={hideOnOverlayClick}>
          <div className="features-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="features-modal-footer">
              {/* CHANGE HERE: Iska link /signup kar diya hai */}
