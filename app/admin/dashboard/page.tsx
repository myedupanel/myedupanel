...
// FIX: Changed the themes to only use colors that StatCard accepts (orange, green, purple).
const cardDetails = {
  "Total Students": { icon: <MdPeople />, theme: "purple" }, // Was "blue"
  ...
  "Total Staff": { icon: <MdBadge />, theme: "orange" }, // Was "red"
  "Total Classes": { icon: <MdClass />, theme: "green" }  // Was "teal"
} as const;
...
interface FormattedDashboardData {
  ...
  recentPayments: { _id: string; student: string; amount: string }[];
}
