...
interface Payment {
  _id?: string; // Add _id if it comes from backend
    ...
    <div className={styles.container}>
      ...
      <ul className={styles.paymentList}>
        ...
        {payments && payments.length > 0 ? (
          payments.map((payment) => ( // Use payment._id if available for a more stable key
            <li key={payment._id || Math.random()} className={styles.paymentItem}>
