...
exports.resource_by_assetid = function resource_by_assetid(assetid, callback, options = {}) {
  const uri = ["resources", assetid];
...
exports.resources_by_assetids = function resources_by_assetids(assetids, callback, options = {}) {
  let params, uri;
  uri = ["resources", "by_assetids"];
  params = pickOnlyExistingValues(options, "tags", "context", "moderations");
  params["assetids[]"] = assetids;
  return call_api("get", uri, params, callback, options);
}

exports.resources_byids = function resources_byids(publicids, callback, options = {}) {
...
exports.resource = function resource(publicid, callback, options = {}) {
  let resource_type, type, uri;
  resource_type = options.resource_type || "image";
  type = options.type || "upload";
  uri = ["resources", resource_type, type, publicid];
  return call_api("get", uri, getResourceParams(options), callback, options);
};

exports.restore = function restore(publicids, callback, options = {}) {
...
exports.update = function update(publicid, callback, options = {}) {
  let params, resource_type, type, uri;
  resource_type = options.resource_type || "image";
  type = options.type || "upload";
  uri = ["resources", resource_type, type, publicid];
...
exports.delete_resources = function delete_resources(publicids, callback, options = {}) {
  let resource_type, type, uri;
  resource_type = options.resource_type || "image";
  type = options.type || "upload";
  uri = ["resources", resource_type, type];
...
exports.add_related_assets_by_assetid = (assetId, assetsToRelate, callback, options = {}) => {
  const params = createRelationParams(assetsToRelate);
...
exports.delete_related_assets_by_assetid = (assetId, assetsToUnrelate, callback, options = {}) => {
  const params = deleteRelationParams(assetsToUnrelate);
  return call_api('delete', ['resources', 'related_assets', assetId], params, callback, options);
};

exports.delete_derived_resources = function delete_derived_resources(derived_resourceids, callback, options = {}) {
  let uri;
  uri = ["derived_resources"];
  return call_api("delete", uri, {
    "derived_resourceids[]": derived_resourceids
  }, callback, options);
};
...
exports.update_upload_preset = function update_upload_preset(name, callback, options = {}) {
  let params, uri;
  uri = ["upload_presets", name];
  params = utils.merge(utils.clear_blank(utils.build_upload_params(options)), pickOnlyExistingValues(options, "unsigned", "disallow_publicid", "live"));
...
exports.create_upload_preset = function create_upload_preset(callback, options = {}) {
  let params, uri;
  uri = ["upload_presets"];
  params = utils.merge(utils.clear_blank(utils.build_upload_params(options)), pickOnlyExistingValues(options, "name", "unsigned", "disallow_publicid", "live"));
  return call_api("post", uri, params, callback, options);
};
...
exports.publish_byids = function publish_byids(publicids, callback, options = {}) {
  return publishResource("publicids", publicids, callback, options);
};
...
exports.visual_search = function visual_search(params, callback, options = {}) {
  const allowedParams = pickOnlyExistingValues(params, 'image_url', 'image_assetid', 'text');
...
exports.update_resources_access_mode_byids = function update_resources_access_mode_byids(
  access_mode,
  ids,
  callback,
  options = {}
) {
  return updateResourcesAccessMode(access_mode, "publicids[]", ids, callback, options);
};
...
exports.add_metadata_field = function add_metadata_field(field, callback, options = {}) {
  const params = pickOnlyExistingValues(field, "externalid", "type", "label", "mandatory", "default_value", "validation", "datasource", "restrictions");
  options.content_type = "json";
 ...
 *
 * @see https://cloudinary.com/documentation/admin_api#delete_a_metadata_field_by_externalid
 *
 * @param {String}   field_externalid  The external id of the field to delete
 * @param {Function} callback           Callback function
 * @param {Object}   options            Configuration options
 *
 * @return {Object}
 */
exports.delete_metadata_field = function delete_metadata_field(field_externalid, callback, options = {}) {
  return call_api("delete", ["metadata_fields", field_externalid], {}, callback, options);
};

/**
 * Get a metadata field by external id
 *
 * @see https://cloudinary.com/documentation/admin_api#get_a_metadata_field_by_externalid
 *
 * @param {String}   externalid  The ID of the metadata field to retrieve
 * @param {Function} callback     Callback function
 * @param {Object}   options      Configuration options
 *
 * @return {Object}
 */
exports.metadata_field_by_fieldid = function metadata_field_by_fieldid(externalid, callback, options = {}) {
  return call_api("get", ["metadata_fields", externalid], {}, callback, options);
};
 ...
 *
 * @see https://cloudinary.com/documentation/admin_api#update_a_metadata_field_by_externalid
 *
 * @param {String}   externalid  The ID of the metadata field to update
 ...
 * @return {Object}
 */
exports.update_metadata_field = function update_metadata_field(externalid, field, callback, options = {}) {
  const params = pickOnlyExistingValues(field, "externalid", "type", "label", "mandatory", "default_value", "validation", "datasource", "restrictions");
  options.content_type = "json";
  return call_api("put", ["metadata_fields", externalid], params, callback, options);
};
 ...
 * update is partial: datasource entries with an existing externalid will be updated and entries with new
 * externalid’s (or without externalid’s) will be appended.
 *
 * @see https://cloudinary.com/documentation/admin_api#update_a_metadata_field_datasource
 *
 * @param {String}   field_externalid    The ID of the field to update
 * @param {Object}   entries_externalid  Updated values for datasource
 * @param {Function} callback             Callback function
 * @param {Object}   options              Configuration options
 *
 * @return {Object}
 */
exports.update_metadata_field_datasource = function update_metadata_field_datasource(field_externalid, entries_externalid, callback, options = {}) {
  const params = pickOnlyExistingValues(entries_externalid, "values");
  options.content_type = "json";
  return call_api("put", ["metadata_fields", field_externalid, "datasource"], params, callback, options);
};
 ...
 *
 * @param {String}   field_externalid    The ID of the metadata field
 * @param {Array}    entries_externalid  An array of IDs of datasource entries to delete
 * @param {Function} callback             Callback function
 * @param {Object}   options              Configuration options
 *
 * @return {Object}
 */
exports.delete_datasource_entries = function delete_datasource_entries(field_externalid, entries_externalid, callback, options = {}) {
  options.content_type = "json";
  const params = {externalids: entries_externalid};
  return call_api("delete", ["metadata_fields", field_externalid, "datasource"], params, callback, options);
};
 ...
 * @return {Object}
 */
exports.restore_metadata_field_datasource = function restore_metadata_field_datasource(field_externalid, entries_externalid, callback, options = {}) {
  options.content_type = "json";
  const params = {externalids: entries_externalid};
  return call_api("post", ["metadata_fields", field_externalid, "datasource_restore"], params, callback, options);
};
 ...
 * @return {Object}
 */
exports.order_metadata_field_datasource = function order_metadata_field_datasource(field_externalid, sort_by, direction, callback, options = {}) {
  options.content_type = "json";
  const params = {
    order_by: sort_by,
    direction: direction
  };
  return call_api("post", ["metadata_fields", field_externalid, "datasource", "order"], params, callback, options);
};

/**
 * Reorders metadata fields.
 *
 * @param {String}   order_by  Criteria for the order (one of the fields 'label', 'externalid', 'created_at').
 * @param {String}   direction Optional (gets either asc or desc).
 * @param {Function} callback  Callback function.
 * @param {Object}   options   Configuration options.
 *
...
exports.add_metadata_rule = function add_metadata_rule(metadata_rule, callback, options = {}) {
  options.content_type = 'json';
  const params = pickOnlyExistingValues(metadata_rule, 'metadata_fieldid', 'condition', 'result', 'name');
  return call_api('post', ['metadata_rules'], params, callback, options);
};

exports.update_metadata_rule = function update_metadata_rule(field_externalid, updated_metadata_rule, callback, options = {}) {
  options.content_type = 'json';
  const params = pickOnlyExistingValues(updated_metadata_rule, 'metadata_fieldid', 'condition', 'result', 'name', 'state');
  return call_api('put', ['metadata_rules', field_externalid], params, callback, options);
};

exports.delete_metadata_rule = function delete_metadata_rule(field_externalid, callback, options = {}) {
  return call_api('delete', ['metadata_rules', field_externalid], {}, callback, options);
};
