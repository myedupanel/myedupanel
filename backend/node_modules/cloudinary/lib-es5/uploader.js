...
exports.explicit = function explicit(publicid, callback) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
exports.destroy = function destroy(publicid, callback) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
exports.rename = function rename(from_publicid, to_publicid, callback) {
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
...
var TEXT_PARAMS = ["publicid", "font_family", "font_size", "font_color", "text_align", "font_weight", "font_style", "background", "opacity", "text_decoration", "font_hinting", "font_antialiasing"];
...
exports.explode = function explode(publicid, callback) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
exports.add_tag = function add_tag(tag) {
  var publicids = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
...
function call_tags_api(tag, command) {
  var publicids = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
...
function cacheResults(result, _ref) {
  ...
  if (result.responsive_breakpoints) {
    result.responsive_breakpoints.forEach(function (_ref2) {
      ...
      return Cache.set(result.publicid, { type, resource_type, raw_transformation: transformation, format: extname(breakpoints[0].url).slice(1) }, breakpoints.map(function (i) {
        return i.width;
      }));
    });
  }
...
function call_api(action, callback, options, get_params) {
  ...
  var boundary = utils.random_publicid();
 ...
 * @return {Object}
 */
exports.update_metadata = function update_metadata(metadata, publicids, callback) {
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
