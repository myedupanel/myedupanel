...
declare module 'cloudinary' {
    ...
    export type VisualSearchParams = { image_url: string } | { image_assetid: string } | { text: string };
    ...
    export interface UploadApiOptions {
        ...
        oauth_token?: string;
        use_asset_folder_as_publicid_prefix?: boolean;
    ...
    export interface MetadataRuleResultEnableWithActivate extends MetadataRuleResultCommon {
        enable?: boolean;
        activate_values: "all" | {
            externalids: string | Array<string> | null;
    ...
    export namespace v2 {
        ...
        function url(publicid: string, options?: TransformationOptions | ConfigAndUrlOptions): string;

        /****************************** Tags *************************************/

        function image(source: string, options?: ImageTransformationAndTagsOptions | ConfigAndUrlOptions): string;

        function picture(publicid: string, options?: ImageTransformationAndTagsOptions | ConfigAndUrlOptions): string;

        function source(publicid: string, options?: TransformationOptions | ConfigAndUrlOptions): string;

        function video(publicid: string, options?: VideoTransformationAndTagsOptions | ConfigAndUrlOptions): string;
        ...
        namespace utils {
            ...
            function video_thumbnail_url(publicid?: string, options?: VideoTransformationOptions | ConfigAndUrlOptions): string;

            function video_url(publicid?: string, options?: VideoTransformationOptions | ConfigAndUrlOptions): string;
            ...
            function download_backedup_asset(assetid?: string, versionid?: string, options?: ArchiveApiOptions | ConfigAndUrlOptions): string
        ...
        namespace api {
            ...
            function create_upload_preset(options?: AdminApiOptions | {
                name?: string,
                unsigned?: boolean,
                disallow_publicid?: boolean
            }, callback?: ResponseCallback): Promise<any>;

            function delete_all_resources(value?: AdminAndResourceOptions, callback?: ResponseCallback): Promise<any>;

            function delete_derived_by_transformation(publicids: string[], transformations: TransformationOptions, callback?: ResponseCallback): Promise<any>;

            function delete_derived_by_transformation(publicids: string[], transformations: TransformationOptions, options?: AdminApiOptions, callback?: ResponseCallback): Promise<any>;

            function delete_derived_resources(publicids: string[], callback?: ResponseCallback): Promise<any>;

            function delete_derived_resources(publicids: string[], options?: AdminAndResourceOptions, callback?: ResponseCallback): Promise<any>;
            ...
            function publish_byids(publicids: string[], options?: AdminAndPublishOptions, callback?: ResponseCallback): Promise<any>;

            function publish_byids(publicids: string[], callback?: ResponseCallback): Promise<any>;
            ...
            function resource(publicid: string, options?: AdminAndResourceOptions, callback?: ResponseCallback): Promise<any>;

            function resource(publicid: string, callback?: ResponseCallback): Promise<any>;
            ...
            function resources_by_assetids(assetids: string[] | string, options?: AdminAndResourceOptions, callback?: ResponseCallback): Promise<ResourceApiResponse>;

            function resources_by_assetids(assetids: string[] | string, callback?: ResponseCallback): Promise<ResourceApiResponse>;

            function resources_byids(publicids: string[] | string, options?: AdminAndResourceOptions, callback?: ResponseCallback): Promise<ResourceApiResponse>;

            function resources_byids(publicids: string[] | string, callback?: ResponseCallback): Promise<ResourceApiResponse>;
            ...
            function restore(publicids: string[], options?: AdminApiOptions | {
                resource_type: ResourceType,
                type: DeliveryType
            }, callback?: ResponseCallback): Promise<any>;

            function restore(publicids: string[], callback?: ResponseCallback): Promise<any>;
            ...
            function update(publicid: string, options?: AdminAndUpdateApiOptions, callback?: ResponseCallback): Promise<any>;

            function update(publicid: string, callback?: ResponseCallback): Promise<any>;

            function update_resources_access_mode_byids(access_mode: AccessMode, ids: string[], options?: AdminAndUpdateApiOptions, callback?: ResponseCallback): Promise<any>;

            function update_resources_access_mode_byids(access_mode: AccessMode, ids: string[], callback?: ResponseCallback): Promise<any>;
            ...
            function add_related_assets(publicid: string, publicids_to_relate: string | Array<string>, options?: AdminApiOptions, callback?: ResponseCallback): Promise<NewAssetRelationResponse>;

            function add_related_assets_by_assetid(assetid: string, publicids_to_relate: string | Array<string>, options?: AdminApiOptions, callback?: ResponseCallback): Promise<NewAssetRelationResponse>;

            function delete_related_assets(publicid: string, publicids_to_unrelate: string | Array<string>, options?: AdminApiOptions, callback?: ResponseCallback): Promise<DeleteAssetRelation>;

            function delete_related_assets_by_assetid(assetid: string, publicids_to_unrelate: string | Array<string>, options?: AdminApiOptions, callback?: ResponseCallback): Promise<DeleteAssetRelation>;
            ...
            function delete_metadata_field(field_externalid: string, options?: AdminApiOptions, callback?: ResponseCallback): Promise<DeleteApiResponse>;

            function delete_metadata_field(field_externalid: string, callback?: ResponseCallback): Promise<DeleteApiResponse>;

            function metadata_field_by_fieldid(externalid: string, options?: AdminApiOptions, callback?: ResponseCallback): Promise<MetadataFieldApiResponse>;

            function metadata_field_by_fieldid(externalid: string, callback?: ResponseCallback): Promise<MetadataFieldApiResponse>;

            function update_metadata_field(externalid: string, field: MetadataFieldApiOptions, options?: AdminApiOptions, callback?: ResponseCallback): Promise<MetadataFieldApiResponse>;

            function update_metadata_field(externalid: string, field: MetadataFieldApiOptions, callback?: ResponseCallback): Promise<MetadataFieldApiResponse>;

            function update_metadata_field_datasource(field_externalid: string, entries_externalid: DatasourceChange, options?: AdminApiOptions, callback?: ResponseCallback): Promise<DatasourceChange>;

            function update_metadata_field_datasource(field_externalid: string, entries_externalid: DatasourceChange, callback?: ResponseCallback): Promise<DatasourceChange>;

            function delete_datasource_entries(field_externalid: string, entries_externalid: string[], options?: AdminApiOptions, callback?: ResponseCallback): Promise<DatasourceChange>;

            function delete_datasource_entries(field_externalid: string, entries_externalid: string[], callback?: ResponseCallback): Promise<DatasourceChange>;

            function restore_metadata_field_datasource(field_externalid: string, entries_externalid: string[], options?: AdminApiOptions, callback?: ResponseCallback): Promise<DatasourceChange>;

            function restore_metadata_field_datasource(field_externalid: string, entries_externalid: string[], callback?: ResponseCallback): Promise<DatasourceChange>;
            ...
            function update_metadata_rule(externalid: string, rule: MetadataRule, options?: AdminApiOptions, callback?: ResponseCallback): Promise<MetadataRuleResponse>;

            function update_metadata_rule(externalid: string, rule: MetadataRule, callback?: ResponseCallback): Promise<MetadataRuleResponse>;

            function delete_metadata_rule(externalid: string, options?: AdminApiOptions, callback?: ResponseCallback): Promise<DeleteApiResponse>;

            function delete_metadata_rule(externalid: string, callback?: ResponseCallback): Promise<DeleteApiResponse>;
        ...
        namespace uploader {
            function add_context(context: string, publicids: string[], options?: {
                type?: DeliveryType,
                resource_type?: ResourceType
            }, callback?: ResponseCallback): Promise<any>;

            function add_context(context: string, publicids: string[], callback?: ResponseCallback): Promise<any>;

            function add_tag(tag: string, publicids: string[], options?: {
                type?: DeliveryType,
                resource_type?: ResourceType
            }, callback?: ResponseCallback): Promise<any>;

            function add_tag(tag: string, publicids: string[], callback?: ResponseCallback): Promise<any>;
            ...
            function destroy(publicid: string, options?: {
                resource_type?: ResourceType,
                type?: DeliveryType,
                invalidate?: boolean
            }, callback?: ResponseCallback,): Promise<any>;

            function destroy(publicid: string, callback?: ResponseCallback,): Promise<any>;

            function explicit(publicid: string, options?: UploadApiOptions, callback?: ResponseCallback): Promise<any>;

            function explicit(publicid: string, callback?: ResponseCallback): Promise<any>;

            function explode(publicid: string, options?: {
                page?: 'all',
                type?: DeliveryType,
            ...
            function explode(publicid: string, callback?: ResponseCallback): Promise<any>
            ...
            function remove_all_context(publicids: string[], options?: {
                context?: string,
                resource_type?: ResourceType,
                type?: DeliveryType
            }, callback?: ResponseCallback): Promise<any>;

            function remove_all_context(publicids: string[], callback?: ResponseCallback): Promise<any>;

            function remove_all_tags(publicids: string[], options?: {
                tag?: string,
                resource_type?: ResourceType,
                type?: DeliveryType
            }, callback?: ResponseCallback): Promise<any>;

            function remove_all_tags(publicids: string[], callback?: ResponseCallback): Promise<any>;

            function remove_tag(tag: string, publicids: string[], options?: {
                tag?: string,
                resource_type?: ResourceType,
                type?: DeliveryType
            }, callback?: ResponseCallback): Promise<any>;

            function remove_tag(tag: string, publicids: string[], callback?: ResponseCallback): Promise<any>;

            function rename(from_publicid: string, to_publicid: string, options?: {
                resource_type?: ResourceType,
                type?: DeliveryType,
            ...
            function rename(from_publicid: string, to_publicid: string, callback?: ResponseCallback): Promise<any>;

            function replace_tag(tag: string, publicids: string[], options?: {
                resource_type?: ResourceType,
                type?: DeliveryType
            }, callback?: ResponseCallback): Promise<any>;

            function replace_tag(tag: string, publicids: string[], callback?: ResponseCallback): Promise<any>;
            ...
            function update_metadata(metadata: string | Record<any, any>, publicids: string[], options?: UploadApiOptions, callback?: ResponseCallback): Promise<MetadataFieldApiResponse>;

            function update_metadata(metadata: string | Record<any, any>, publicids: string[], callback?: ResponseCallback): Promise<MetadataFieldApiResponse>;
        }
