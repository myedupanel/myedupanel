...
New functionality
-----------------
* Add support for `resources_by_assetids` Admin API (#529)
...
-----------------
  ...
  * Add support for `resource_by_assetid` Admin API (#522)
...
New functionality and features
------------------------------
* Add support for pending, prefix, and sub_accountid to users method (#417)
...
-----------------
  ...
  * Add publish API: `publish_by_prefix`, `publish_by_publicids`, `publish_by_tag`.
...
-----------------
  ...
  * Add invalidate to explicit. Encode publicids array with `[]` in URL. Replace cleanup code with TEST_TAG.
...
==================
  ...
  * all tests pass
  * fixed default type and publicid
