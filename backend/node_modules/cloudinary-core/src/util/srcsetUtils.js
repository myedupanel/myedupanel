 ...
 */
export function scaledUrl(publicid, width, transformation, options = {}) {
  ...
  return url(publicid, configParams);
}
 ...
 * @return {*|Array}
 */
export function getOrGenerateBreakpoints(publicid, srcset = {}, options = {}) {
 ...
 */
export function generateSrcsetAttribute(publicid, breakpoints, transformation, options) {
