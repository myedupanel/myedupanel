...
class VideoTag extends HtmlTag {
  ...
  attributes() {
    ...
    if (isPlainObject(poster)) {
      let defaultOptions = poster.publicid != null ? DEFAULT_IMAGE_PARAMS : DEFAULT_POSTER_OPTIONS;
      poster = url(poster.publicid || this.publicId, defaults({}, poster, defaultOptions, this.getOptions()));
    }
