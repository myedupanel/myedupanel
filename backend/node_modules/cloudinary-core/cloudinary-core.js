...
})(this, function(__WEBPACK_EXTERNAL_MODULE_lodash_assign__, __WEBPACK_EXTERNAL_MODULE_lodash_cloneDeep__, __WEBPACK_EXTERNAL_MODULE_lodash_compact__, __WEBPACK_EXTERNAL_MODULE_lodash_difference__, __WEBPACK_EXTERNAL_MODULE_lodash_functions__, __WEBPACK_EXTERNAL_MODULE_lodashidentity__, __WEBPACK_EXTERNAL_MODULE_lodash_includes__, __WEBPACK_EXTERNAL_MODULE_lodash_isArray__, __WEBPACK_EXTERNAL_MODULE_lodash_isElement__, __WEBPACK_EXTERNAL_MODULE_lodash_isFunction__, __WEBPACK_EXTERNAL_MODULE_lodash_isPlainObject__, __WEBPACK_EXTERNAL_MODULE_lodash_isString__, __WEBPACK_EXTERNAL_MODULE_lodash_merge__, __WEBPACK_EXTERNAL_MODULE_lodash_trim__) {
...
__webpack_require__.d(lodash_namespaceObject, "identity", function() { return identity_rootidentity_default.a; });
...
var identity_rootidentity_ = __webpack_require__("lodash/identity");
var identity_rootidentity_default = /*#__PURE__*/__webpack_require__.n(identity_rootidentity_);
    ...
    value: function toString() {
      ...
      if (this.options.text != null) {
        ...
        if (hasPublicId && hasStyle || !hasPublicId && !hasStyle) {
          throw "Must supply either style parameters or a publicid when providing text parameter in a text overlay/underlay, but not both!";
        }
        re = /\$\([a-zA-Z]\w*\)/g;
        start = 0;
...
var parameters_Param = /*#__PURE__*/function () {
  ...
  function Param(name, shortName) {
    var process = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : identity_rootidentity_default.a;
    ...
    this.param = function (value, name, abbr, defaultValue, process) {
      if (process == null) {
        if (isFunction_root_isFunction_default()(defaultValue)) {
          ...
          process = identity_rootidentity_default.a;
        }
      }
 ...
 */
function scaledUrl(publicid, width, transformation) {
  ...
  return url_url(publicid, configParams);
}
 ...
 * @return {*|Array}
 */
function getOrGenerateBreakpoints(publicid) {
 ...
 */
function generateSrcsetAttribute(publicid, breakpoints, transformation, options) {
  options = cloneDeep_root_cloneDeep_default.a(options);
  patchFetchFormat(options);
  return breakpoints.map(function (width) {
    return "".concat(scaledUrl(publicid, width, transformation, options), " ").concat(width, "w");
  }).join(', ');
}
...
var videotag_VideoTag = /*#__PURE__*/function (_HtmlTag) {
  ...
  return videotag_createClass(VideoTag, [{
     ...
     * - Object: transformation parameters to apply to the poster. May optionally include a publicid to use instead of the video publicid.
     * @returns {VideoTag} Returns this instance for chaining purposes.
     */
  }, {
    key: "setPoster",
    ...
    value: function attributes() {
      ...
      if (isPlainObject_root_isPlainObject_default()(poster)) {
        var defaultOptions = poster.publicid != null ? DEFAULT_IMAGE_PARAMS : videotag_DEFAULT_POSTER_OPTIONS;
        poster = url_url(poster.publicid || this.publicId, defaults({}, poster, defaultOptions, this.getOptions()));
      }
...
module.exports = __WEBPACK_EXTERNAL_MODULE_lodashidentity__;
