...
interface AuthJSONOptions {
    ...
    /**
     * An alias for {@link AuthJSONOptions.projectid `projectid`}.
     */
    projectId: AuthJSONOptions['projectid'];
    /**
     * The quota project ID. The quota project can be used by client libraries for the billing purpose.
     * See {@link https://cloud.google.com/docs/quota Working with quotas}
     */
    quota_projectid: string;
    /**
     * An alias for {@link AuthJSONOptions.quota_projectid `quota_projectid`}.
     */
    quotaProjectId: AuthJSONOptions['quota_projectid'];
    /**
