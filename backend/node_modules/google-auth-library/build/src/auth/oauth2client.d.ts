...
export interface GetTokenOptions {
     ...
     * will be used if not provided. Must match any clientid option passed to
...
export interface TokenInfo {
    ...
    sub?: string;
    /**
     * The clientid of the authorized presenter. This claim is only needed when
     * the party requesting the ID token is not the same as the audience of the ID
     * token. This may be the case at Google for hybrid apps where a web
     * application and Android app have a different clientid but share the same
     * project.
     */
    azp?: string;
    /**
...
export interface OAuth2ClientOptions extends AuthClientOptions, OAuth2JSONOptions {
     ...
     * The authentication client ID.
     *
     * @alias {@link OAuth2JSONOptions.clientid}
     */
    clientId?: string;
    /**
     * The authentication client secret.
