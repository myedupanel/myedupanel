...
class AuthClient extends events_1.EventEmitter {
    ...
    constructor(opts = {}) {
        ...
        this.projectId = options.get('projectid') ?? null;
        this.quotaProjectId = options.get('quota_projectid');
    ...
    addSharedMetadataHeaders(headers) {
        // quota_projectid, stored in application_default_credentials.json, is set in
