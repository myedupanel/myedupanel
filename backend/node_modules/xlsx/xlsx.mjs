...
function get_sstid(sst/*:SST*/, str/*:string*/, rev)/*:number*/ {
	...
	switch(cell.t) {
		...
		default: if(cell.v == null) { delete cell.t; break; }
			...
			if(opts && opts.bookSST) {
				v = writetag('v', ''+get_sstid(opts.Strings, cell.v, opts.revStrings));
				o.t = "s"; break;
			}
			o.t = "str"; break;
	}
...
function write_ws_bin_cell(ba/*:BufArray*/, cell/*:Cell*/, R/*:number*/, C/*:number*/, opts, ws/*:Worksheet*/, last_seen/*:boolean*/)/*:boolean*/ {
	...
	switch(cell.t) {
		case 's': case 'str':
			if(opts.bookSST) {
				vv = get_sstid(opts.Strings, (cell.v/*:any*/), opts.revStrings);
				o.t = "s"; o.v = vv;
...
function write_ws_biff8_cell(ba/*:BufArray*/, cell/*:Cell*/, R/*:number*/, C/*:number*/, opts) {
	...
	if(cell.bf) write_biff_rec(ba, 0x0006 /* Formula */, write_Formula(cell, R, C, opts, os));
		...
		case 's': case 'str':
			if(opts.bookSST) {
				var isst = get_sstid(opts.Strings, cell.v, opts.revStrings);
...
function wb_sheetidx(wb/*:Workbook*/, sh/*:number|string*/) {
	if(typeof sh == "number") {
