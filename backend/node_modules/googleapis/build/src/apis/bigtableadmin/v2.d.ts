...
export declare namespace bigtableadmin_v2 {
    ...
    export interface Schema$CopyBackupRequest {
        /**
         * Required. The id of the new backup. The `backupid` along with `parent` are combined as {parent\}/backups/{backupid\} to create the full backup name, of the form: `projects/{project\}/instances/{instance\}/clusters/{cluster\}/backups/{backupid\}`. This string must be between 1 and 50 characters in length and match the regex _a-zA-Z0-9*.
         */
    ...
    export interface Schema$CreateAuthorizedViewRequest {
        ...
        /**
         * Required. The id of the AuthorizedView to create. This AuthorizedView must not already exist. The `authorized_viewid` appended to `parent` forms the full AuthorizedView name of the form `projects/{project\}/instances/{instance\}/tables/{table\}/authorizedView/{authorized_view\}`.
         */
    ...
    export interface Schema$RestoreTableRequest {
        ...
        backup?: string | null;
        /**
         * Required. The id of the table to create and restore to. This table must not already exist. The `tableid` appended to `parent` forms the full table name of the form `projects//instances//tables/`.
         */
        tableId?: string | null;
    }
    /**
