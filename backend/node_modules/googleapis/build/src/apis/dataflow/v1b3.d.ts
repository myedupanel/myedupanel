...
export declare namespace dataflow_v1b3 {
    ...
    export interface Schema$CounterUpdate {
        ...
        /**
         * The service-generated short identifier for this counter. The shortid -\> (name, metadata) mapping is constant for the lifetime of a job.
         */
        shortId?: string | null;
        /**
    ...
    export interface Schema$GetDebugConfigRequest {
        ...
        /**
         * The [regional endpoint] (https://cloud.google.com/dataflow/docs/concepts/regional-endpoints) that contains the job specified by jobid.
         */
        location?: string | null;
        /**
    ...
    export interface Schema$WorkItemServiceState {
        ...
        leaseExpireTime?: string | null;
        /**
         * The short ids that workers should use in subsequent metric updates. Workers should strive to use short ids whenever possible, but it is ok to request the shortid again if a worker lost track of it (e.g. if the worker is recovering from a crash). NOTE: it is possible that the response may have short ids for a subset of the metrics.
         */
