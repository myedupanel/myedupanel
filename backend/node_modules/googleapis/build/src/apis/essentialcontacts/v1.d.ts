...
export declare namespace essentialcontacts_v1 {
    ...
    export interface Schema$GoogleCloudEssentialcontactsV1Contact {
        ...
        /**
         * Output only. The identifier for the contact. Format: {resource_type\}/{resourceid\}/contacts/{contactid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudEssentialcontactsV1SendTestMessageRequest {
        /**
         * Required. The list of names of the contacts to send a test message to. Format: organizations/{organizationid\}/contacts/{contactid\}, folders/{folderid\}/contacts/{contactid\} or projects/{projectid\}/contacts/{contactid\}
         */
    ...
    export class Resource$Folders$Contacts {
         ...
         *     // Required. The name of the resource to compute contacts for. Format: organizations/{organizationid\}, folders/{folderid\} or projects/{projectid\}
         ...
         *     // Required. The resource to save this contact for. Format: organizations/{organizationid\}, folders/{folderid\} or projects/{projectid\}
         *     parent: 'folders/my-folder',
         *
         ...
         *     // Required. The name of the contact to delete. Format: organizations/{organizationid\}/contacts/{contactid\}, folders/{folderid\}/contacts/{contactid\} or projects/{projectid\}/contacts/{contactid\}
         ...
         *     // Required. The name of the contact to retrieve. Format: organizations/{organizationid\}/contacts/{contactid\}, folders/{folderid\}/contacts/{contactid\} or projects/{projectid\}/contacts/{contactid\}
         *     name: 'folders/my-folder/contacts/my-contact',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Optional. If present, retrieves the next batch of results from the preceding call to this method. `page_token` must be the value of `next_page_token` from the previous response. The values of other method parameters should be identical to those in the previous call.
         *     pageToken: 'placeholder-value',
         *     // Required. The parent resource name. Format: organizations/{organizationid\}, folders/{folderid\} or projects/{projectid\}
         *     parent: 'folders/my-folder',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The name of the resource to send the test message for. All contacts must either be set directly on this resource or inherited from another resource that is an ancestor of this one. Format: organizations/{organizationid\}, folders/{folderid\} or projects/{projectid\}
