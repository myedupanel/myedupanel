...
export declare namespace factchecktools_v1alpha1 {
    ...
    export interface Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage {
        ...
        /**
         * The name of this `ClaimReview` markup page resource, in the form of `pages/{pageid\}`. Except for update requests, this field is output-only and should not be set by the user.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Pages {
         ...
         *     // The name of the resource to delete, in the form of `pages/{pageid\}`.
         *     name: 'pages/my-page',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // The name of the resource to get, in the form of `pages/{pageid\}`.
         *     name: 'pages/my-page',
         *   });
         *   console.log(res.data);
         *
