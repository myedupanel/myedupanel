...
export declare namespace iam_v1 {
    ...
    export interface Schema$WorkforcePool {
        ...
        expireTime?: string | null;
        /**
         * Identifier. The resource name of the pool. Format: `locations/{location\}/workforcePools/{workforce_poolid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$WorkforcePoolProvider {
        ...
        /**
         * Identifier. The resource name of the provider. Format: `locations/{location\}/workforcePools/{workforce_poolid\}/providers/{providerid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$WorkforcePoolProviderKey {
        ...
        /**
         * Identifier. The resource name of the key. Format: `locations/{location\}/workforcePools/{workforce_poolid\}/providers/{providerid\}/keys/{keyid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$WorkforcePoolProviderScimTenant {
        /**
         * Output only. Agentspace only. Represents the base URI as defined in [RFC 7644, Section 1.3](https://datatracker.ietf.org/doc/html/rfc7644#section-1.3). Clients must use this as the root address for managing resources under the tenant. Format: https://iamscim.googleapis.com/{version\}/{tenantid\}/
         */
        baseUri?: string | null;
        /**
    ...
    export class Resource$Locations$Workforcepools {
         ...
         *     // Required. The name of the pool to delete. Format: `locations/{location\}/workforcePools/{workforce_poolid\}`
         ...
         *     // Required. The name of the pool to retrieve. Format: `locations/{location\}/workforcePools/{workforce_poolid\}`
         *     name: 'locations/my-location/workforcePools/my-workforcePool',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The name of the pool to undelete. Format: `locations/{location\}/workforcePools/{workforce_poolid\}`
         *     name: 'locations/my-location/workforcePools/my-workforcePool',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Locations$Workforcepools$Providers {
         ...
         *     // Required. The pool to create this provider in. Format: `locations/{location\}/workforcePools/{workforce_poolid\}`
         ...
         *     // Required. The name of the provider to delete. Format: `locations/{location\}/workforcePools/{workforce_poolid\}/providers/{providerid\}`
         ...
         *     // Required. The name of the provider to retrieve. Format: `locations/{location\}/workforcePools/{workforce_poolid\}/providers/{providerid\}`
         *     name: 'locations/my-location/workforcePools/my-workforcePool/providers/my-provider',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The pool to list providers for. Format: `locations/{location\}/workforcePools/{workforce_poolid\}`
         *     parent: 'locations/my-location/workforcePools/my-workforcePool',
         ...
         *     // Required. The name of the provider to undelete. Format: `locations/{location\}/workforcePools/{workforce_poolid\}/providers/{providerid\}`
         *     name: 'locations/my-location/workforcePools/my-workforcePool/providers/my-provider',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Locations$Workforcepools$Providers$Keys {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The provider resource to list encryption keys for. Format: `locations/{location\}/workforcePools/{workforce_poolid\}/providers/{providerid\}`
         *     parent:
         *       'locations/my-location/workforcePools/my-workforcePool/providers/my-provider',
    ...
    export class Resource$Locations$Workforcepools$Subjects {
         ...
         *     // Required. The resource name of the WorkforcePoolSubject. Special characters, like `/` and `:`, must be escaped, because all URLs need to conform to the "When to Escape and Unescape" section of [RFC3986](https://www.ietf.org/rfc/rfc2396.txt). Format: `locations/{location\}/workforcePools/{workforce_poolid\}/subjects/{subjectid\}`
    ...
    export class Resource$Projects$Locations$Workloadidentitypools$Namespaces$Managedidentities {
         ...
         *       {
         *         // Optional. A query filter. Supports the following function: * `containerids()`: Returns only the AttestationRules under the specific container ids. The function expects a comma-delimited list with only project numbers and must use the format `projects/`. For example: `containerids(projects/, projects/,...)`.
