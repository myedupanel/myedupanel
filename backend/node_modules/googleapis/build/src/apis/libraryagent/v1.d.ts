...
export declare namespace libraryagent_v1 {
    ...
    export interface Schema$GoogleExampleLibraryagentV1Book {
        ...
        author?: string | null;
        /**
         * The resource name of the book. Book names have the form `shelves/{shelfid\}/books/{bookid\}`. The name is ignored when creating a book.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleExampleLibraryagentV1Shelf {
        /**
         * Output only. The resource name of the shelf. Shelf names have the form `shelves/{shelfid\}`. The name is ignored when creating a shelf.
         */
        name?: string | null;
        /**
