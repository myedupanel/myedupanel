...
export declare namespace games_v1 {
    ...
    export interface Schema$ApplicationVerifyResponse {
         ...
         */
        alternate_playerid?: string | null;
        /**
    ...
    export interface Schema$ScopedPlayerIds {
        /**
         * Identifier of the player across all games of the given developer. Every player has the same developer_player_key in all games of one developer. Developer player key changes for the game if the game is transferred to another developer. Note that game_playerid will stay unchanged.
         */
        developerPlayerKey?: string | null;
        /**
         * Game-scoped player identifier. This is the same id that is returned in GetPlayer game_playerid field.
         */
        gamePlayerId?: string | null;
    }
    /**
    ...
    export class Resource$Applications {
         ...
         *   // Example response
         *   // {
         *   //   "alternate_playerid": "my_alternate_playerid",
         *   //   "kind": "my_kind",
