...
export declare namespace resourcesettings_v1 {
    ...
    export interface Schema$GoogleCloudResourcesettingsV1Setting {
        ...
        /**
         * The resource name of the setting. Must be in one of the following forms: * `projects/{project_number\}/settings/{setting_name\}` * `folders/{folderid\}/settings/{setting_name\}` * `organizations/{organizationid\}/settings/{setting_name\}` For example, "/projects/123/settings/gcp-enableMyFeature"
         */
        name?: string | null;
    }
    /**
    ...
    export interface Params$Resource$Folders$Settings$List extends StandardParameters {
        ...
        pageToken?: string;
        /**
         * Required. The project, folder, or organization that is the parent resource for this setting. Must be in one of the following forms: * `projects/{project_number\}` * `projects/{projectid\}` * `folders/{folderid\}` * `organizations/{organizationid\}`
         */
        parent?: string;
        /**
         * The SettingView for this request.
