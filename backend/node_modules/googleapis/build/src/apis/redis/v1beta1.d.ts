...
export declare namespace redis_v1beta1 {
    ...
    export interface Schema$DatabaseResourceFeed {
        ...
        /**
         * Primary key associated with the Resource. resourceid is available in individual feed level as well.
         */
        resourceId?: Schema$DatabaseResourceId;
    ...
    export interface Schema$DatabaseResourceMetadata {
        ...
        resourceContainer?: string | null;
        /**
         * Required. Different from DatabaseResourceId.uniqueid, a resource name can be reused over time. That is, after a resource named "ABC" is deleted, the name "ABC" can be used to to create a new resource within the same source. Resource name to follow CAIS resource_name format as noted here go/condor-common-datamodel
         */
        resourceName?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRedisV1beta1LocationMetadata {
        /**
         * Output only. The set of available zones in the location. The map is keyed by the lowercase ID of each zone, as defined by GCE. These keys can be specified in `locationid` or `alternative_locationid` fields when creating a Redis instance.
         */
        availableZones?: {
    ...
    export interface Schema$Instance {
        ...
        /**
         * Required. Unique name of the resource in this scope including project and location using the form: `projects/{projectid\}/locations/{locationid\}/instances/{instanceid\}` Note: Redis instances are managed and addressed at regional level so locationid here refers to a GCP region; however, users may choose which specific zone (or collection of zones for cross-zone instances) an instance should be provisioned in. Refer to locationid and alternative_locationid fields for more details.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ListInstancesResponse {
        /**
         * A list of Redis instances in the project in the specified location, or across all locations. If the `locationid` in the parent field of the request is "-", all regions available to the project are queried, and the results aggregated. If in such an aggregated query a location is unavailable, a placeholder Redis entry is included in the response with the `name` field set to a value of the form `projects/{projectid\}/locations/{locationid\}/instances/`- and the `status` field set to ERROR and `status_message` field set to "location not available for ListInstances".
         */
    ...
    export interface Schema$Location {
        ...
        locationId?: string | null;
        /**
         * Output only. The set of available zones in the location. The map is keyed by the lowercase ID of each zone, as defined by Compute Engine. These keys can be specified in `locationid` or `alternative_locationid` fields when creating a Redis instance.
         */
        metadata?: {
            [key: string]: any;
        } | null;
    ...
    export interface Schema$PscAutoConnection {
        ...
        /**
         * Required. The consumer network where the IP address resides, in the form of projects/{projectid\}/global/networks/{networkid\}.
         */
        network?: string | null;
        /**
    ...
    export interface Schema$PscConfig {
        /**
         * Required. The network where the IP address of the discovery endpoint will be reserved, in the form of projects/{network_project\}/global/networks/{networkid\}.
         */
        network?: string | null;
    }
    /**
    ...
    export class Resource$Projects$Locations$Backupcollections {
         ...
         *     // Required. Redis backupCollection resource name using the form: `projects/{projectid\}/locations/{locationid\}/backupCollections/{backup_collectionid\}` where `locationid` refers to a Google Cloud region.
        ...
        /**
         * Lists all backup collections owned by a consumer project in either the specified location (region) or all locations. If `locationid` is specified as `-` (wildcard), then all regions available to the project are queried, and the results are aggregated.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Projects$Locations$Backupcollections$Backups {
         ...
         *     // Required. Redis backup resource name using the form: `projects/{projectid\}/locations/{locationid\}/backupCollections/{backup_collectionid\}/backups/{backupid\}`
         ...
         *     // Optional. The `next_page_token` value returned from a previous [ListBackupCollections] request, if any.
         *     pageToken: 'placeholder-value',
         *     // Required. The resource name of the backupCollection using the form: `projects/{projectid\}/locations/{locationid\}/backupCollections/{backup_collectionid\}`
         *     parent:
    ...
    export class Resource$Projects$Locations$Clusters {
         ...
         *     // Required. Redis cluster resource name using the form: `projects/{projectid\}/locations/{locationid\}/clusters/{clusterid\}` where `locationid` refers to a Google Cloud region.
         ...
         *     // Required. The resource name of the cluster location using the form: `projects/{projectid\}/locations/{locationid\}` where `locationid` refers to a Google Cloud region.
         *     parent: 'projects/my-project/locations/my-location',
         *     // Optional. Idempotent request UUID.
         *     requestId: 'placeholder-value',
         *
         ...
         *     // Required. Redis cluster certificate authority resource name using the form: `projects/{projectid\}/locations/{locationid\}/clusters/{clusterid\}/certificateAuthority` where `locationid` refers to a Google Cloud region.
        ...
        /**
         * Lists all Redis clusters owned by a project in either the specified location (region) or all locations. The location should have the following format: * `projects/{projectid\}/locations/{locationid\}` If `locationid` is specified as `-` (wildcard), then all regions available to the project are queried, and the results are aggregated.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *       // Required. Redis Cluster instance resource name using the form: `projects/{projectid\}/locations/{locationid\}/clusters/{clusterid\}` where `locationid` refers to a Google Cloud region.
         *       name: 'projects/my-project/locations/my-location/clusters/my-cluster',
         *
         *       // Request body metadata
         *       requestBody: {
