...
export declare namespace cloudshell_v1alpha1 {
    ...
    export interface Schema$PublicKey {
        ...
        key?: string | null;
        /**
         * Output only. Full name of this resource, in the format `users/{owner_email\}/environments/{environmentid\}/publicKeys/{keyid\}`. `{owner_email\}` is the email address of the user to whom the key belongs. `{environmentid\}` is the identifier of the environment to which the key grants access. `{keyid\}` is the unique identifier of the key. For example, `users/someone@example.com/environments/default/publicKeys/myKey`.
         */
        name?: string | null;
    }
    /**
