...
export declare namespace run_v2 {
    ...
    export interface Schema$GoogleCloudRunV2Service {
        ...
        /**
         * Identifier. The fully qualified name of this Service. In CreateServiceRequest, this field is ignored, and instead composed from CreateServiceRequest.parent and CreateServiceRequest.serviceid. Format: projects/{project\}/locations/{location\}/services/{serviceid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRunV2WorkerPool {
        ...
        launchStage?: string | null;
        /**
         * The fully qualified name of this WorkerPool. In CreateWorkerPoolRequest, this field is ignored, and instead composed from CreateWorkerPoolRequest.parent and CreateWorkerPoolRequest.workerid. Format: `projects/{project\}/locations/{location\}/workerPools/{workerid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleDevtoolsCloudbuildV1Build {
        ...
        images?: string[] | null;
        /**
         * Cloud Storage bucket where logs should be written (see [Bucket Name Requirements](https://cloud.google.com/storage/docs/bucket-naming#requirements)). Logs file names will be of the format `${logs_bucket\}/log-${buildid\}.txt`.
         */
    ...
    export class Resource$Projects$Locations {
         ...
         *     // Required. The name of the resource of which image metadata should be exported. Format: `projects/{projectid_or_number\}/locations/{location\}/services/{service\}/revisions/{revision\}` for Revision `projects/{projectid_or_number\}/locations/{location\}/jobs/{job\}/executions/{execution\}` for Execution
         ...
         *     // Required. The name of the resource of which metadata should be exported. Format: `projects/{projectid_or_number\}/locations/{location\}/services/{service\}` for Service `projects/{projectid_or_number\}/locations/{location\}/services/{service\}/revisions/{revision\}` for Revision `projects/{projectid_or_number\}/locations/{location\}/jobs/{job\}/executions/{execution\}` for Execution {projectid_or_number\} may contains domain-scoped project IDs
         *     name: 'projects/my-project/locations/my-location/.*',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The name of the project of which metadata should be exported. Format: `projects/{projectid_or_number\}/locations/{location\}` for Project in a given location.
         *     name: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Jobs$Executions {
         ...
         *     // Required. The name of the resource of which image export operation status has to be fetched. Format: `projects/{projectid_or_number\}/locations/{location\}/services/{service\}/revisions/{revision\}` for Revision `projects/{projectid_or_number\}/locations/{location\}/jobs/{job\}/executions/{execution\}` for Execution
         *     name: 'projects/my-project/locations/my-location/jobs/my-job/executions/my-execution',
    ...
    export class Resource$Projects$Locations$Services {
         ...
         *     parent: 'projects/my-project/locations/my-location',
         *     // Required. The unique identifier for the Service. It must begin with letter, and cannot end with hyphen; must contain fewer than 50 characters. The name of the service becomes {parent\}/services/{serviceid\}.
    ...
    export class Resource$Projects$Locations$Workerpools {
         ...
         *     validateOnly: 'placeholder-value',
         *     // Required. The unique identifier for the WorkerPool. It must begin with letter, and cannot end with hyphen; must contain fewer than 50 characters. The name of the worker pool becomes `{parent\}/workerPools/{worker_poolid\}`.
