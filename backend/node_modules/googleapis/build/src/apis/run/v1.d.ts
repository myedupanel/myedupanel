...
export declare namespace run_v1 {
    ...
    export class Resource$Namespaces$Configurations {
         ...
         *     // The name of the configuration to retrieve. For Cloud Run, replace {namespaceid\} with the project ID or number.
         ...
         *     // The namespace from which the configurations should be listed. For Cloud Run, replace {namespaceid\} with the project ID or number.
         *     parent: 'namespaces/my-namespace',
         *     // Not supported by Cloud Run.
    ...
    export class Resource$Namespaces$Services {
         ...
         *     // Indicates that the server should validate the request and populate default values without persisting the request. Supported values: `all`
         *     dryRun: 'placeholder-value',
         *     // Required. The resource's parent. In Cloud Run, it may be one of the following: * `{projectid_or_number\}` * `namespaces/{projectid_or_number\}` * `namespaces/{projectid_or_number\}/services` * `projects/{projectid_or_number\}/locations/{region\}` * `projects/{projectid_or_number\}/regions/{region\}`
         *     parent: 'namespaces/my-namespace',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Not supported, and ignored by Cloud Run.
         *     kind: 'placeholder-value',
         *     // Required. The fully qualified name of the service to delete. It can be any of the following forms: * `namespaces/{projectid_or_number\}/services/{service_name\}` (only when the `endpoint` is regional) * `projects/{projectid_or_number\}/locations/{region\}/services/{service_name\}` * `projects/{projectid_or_number\}/regions/{region\}/services/{service_name\}`
         ...
         *     limit: 'placeholder-value',
         *     // Required. The parent from where the resources should be listed. In Cloud Run, it may be one of the following: * `{projectid_or_number\}` * `namespaces/{projectid_or_number\}` * `namespaces/{projectid_or_number\}/services` * `projects/{projectid_or_number\}/locations/{region\}` * `projects/{projectid_or_number\}/regions/{region\}`
         *     parent: 'namespaces/my-namespace',
         *     // Not supported, and ignored by Cloud Run.
         *     resourceVersion: 'placeholder-value',
         *     // Not supported, and ignored by Cloud Run.
    ...
    export class Resource$Namespaces$Workerpools {
         ...
         *     // Indicates that the server should validate the request and populate default values without persisting the request. Supported values: `all`
         *     dryRun: 'placeholder-value',
         *     // Required. The resource's parent. In Cloud Run, it may be one of the following: * `{projectid_or_number\}` * `namespaces/{projectid_or_number\}` * `namespaces/{projectid_or_number\}/workerpools` * `projects/{projectid_or_number\}/locations/{region\}` * `projects/{projectid_or_number\}/regions/{region\}`
         *     parent: 'namespaces/my-namespace',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Indicates that the server should validate the request and populate default values without persisting the request. Supported values: `all`
         *     dryRun: 'placeholder-value',
         *     // Required. The fully qualified name of the worker pool to delete. It can be any of the following forms: * `namespaces/{projectid_or_number\}/workerpools/{worker_pool_name\}` (only when the `endpoint` is regional) * `projects/{projectid_or_number\}/locations/{region\}/workerpools/{worker_pool_name\}` * `projects/{projectid_or_number\}/regions/{region\}/workerpools/{worker_pool_name\}`
         ...
         *     // The maximum number of records that should be returned.
         *     limit: 'placeholder-value',
         *     // Required. The parent from where the resources should be listed. In Cloud Run, it may be one of the following: * `{projectid_or_number\}` * `namespaces/{projectid_or_number\}` * `namespaces/{projectid_or_number\}/workerpools` * `projects/{projectid_or_number\}/locations/{region\}` * `projects/{projectid_or_number\}/regions/{region\}`
         *     parent: 'namespaces/my-namespace',
         *   });
         *   console.log(res.data);
         *
