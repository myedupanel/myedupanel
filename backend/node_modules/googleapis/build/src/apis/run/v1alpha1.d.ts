...
export declare namespace run_v1alpha1 {
    ...
    export class Resource$Namespaces$Jobs {
         ...
         *     // Required. The namespace in which the job should be created. Replace {namespaceid\} with the project ID or number.
         ...
         *     // Required. The name of the job to delete. For Cloud Run (fully managed), replace {namespaceid\} with the project ID or number.
         ...
         *     // Required. The name of the job to retrieve. For Cloud Run (fully managed), replace {namespaceid\} with the project ID or number.
         *     name: 'namespaces/my-namespace/jobs/my-job',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The namespace from which the jobs should be listed. Replace {namespaceid\} with the project ID or number.
         *     parent: 'namespaces/my-namespace',
