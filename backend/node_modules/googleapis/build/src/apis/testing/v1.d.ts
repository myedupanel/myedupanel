...
export declare namespace testing_v1 {
    ...
    export interface Schema$DeviceSession {
        ...
        /**
         * Optional. Name of the DeviceSession, e.g. "projects/{projectid\}/deviceSessions/{sessionid\}"
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Devicesessions {
        ...
        constructor(context: APIRequestContext);
        /**
         * POST /v1/projects/{projectid\}/deviceSessions/{device_sessionid\}:cancel Changes the DeviceSession to state FINISHED and terminates all connections. Canceled sessions are not deleted and can be retrieved or listed by the user until they expire based on the 28 day deletion policy.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *     // Required. Name of the DeviceSession, e.g. "projects/{projectid\}/deviceSessions/{sessionid\}"
        ...
        /**
         * GET /v1/projects/{projectid\}/deviceSessions/{device_sessionid\} Return a DeviceSession, which documents the allocation status and whether the device is allocated. Clients making requests from this API must poll GetDeviceSession.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
