...
export declare namespace cloudchannel_v1 {
    ...
    export interface Schema$GoogleCloudChannelV1alpha1ChannelPartnerEvent {
        /**
         * Resource name for the Channel Partner Link. Channel_partner uses the format: accounts/{accountid\}/channelPartnerLinks/{channel_partnerid\}
         */
    ...
    export interface Schema$GoogleCloudChannelV1alpha1CustomerEvent {
        /**
         * Resource name of the customer. Format: accounts/{accountid\}/customers/{customerid\}
         */
    ...
    export interface Schema$GoogleCloudChannelV1alpha1Entitlement {
        ...
        /**
         * Cloud Identity ID of a channel partner who will be the direct reseller for the customer's order. This field is generally used in 2-tier ordering, where the order is placed by a top-level distributor on behalf of their channel partner or reseller. Required for distributors. Deprecated: `channel_partnerid` has been moved to the Customer.
         */
        ...
        /**
         * Output only. Resource name of an entitlement in the form: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}.
         */
        name?: string | null;
        /**
        ...
        /**
         * Required. The offer resource name for which the entitlement is to be created. Takes the form: accounts/{accountid\}/offers/{offerid\}.
         */
        offer?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1alpha1EntitlementEvent {
        /**
         * Resource name of an entitlement of the form: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         */
    ...
    export interface Schema$GoogleCloudChannelV1alpha1RenewalSettings {
        ...
        /**
         * Output only. The offer resource name that the entitlement will renew on at the end date. Takes the form: accounts/{accountid\}/offers/{offerid\}.
         */
    ...
    export interface Schema$GoogleCloudChannelV1alpha1Report {
        ...
        displayName?: string | null;
        /**
         * Required. The report's resource name. Specifies the account and report used to generate report data. The reportid identifier is a UID (for example, `613bf59q`). Name uses the format: accounts/{accountid\}/reports/{reportid\}
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudChannelV1alpha1ReportJob {
        /**
         * Required. The resource name of a report job. Name uses the format: `accounts/{accountid\}/reportJobs/{report_jobid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1BillingAccount {
        ...
        displayName?: string | null;
        /**
         * Output only. Resource name of the billing account. Format: accounts/{accountid\}/billingAccounts/{billing_accountid\}.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1ChangeOfferRequest {
        ...
        billingAccount?: string | null;
        /**
         * Required. New Offer. Format: accounts/{accountid\}/offers/{offerid\}.
         */
        offer?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1ChannelPartnerLink {
        ...
        /**
         * Output only. Resource name for the channel partner link, in the format accounts/{accountid\}/channelPartnerLinks/{id\}.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1ChannelPartnerRepricingConfig {
        /**
         * Output only. Resource name of the ChannelPartnerRepricingConfig. Format: accounts/{accountid\}/channelPartnerLinks/{channel_partnerid\}/channelPartnerRepricingConfigs/{id\}.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1CloudIdentityCustomerAccount {
        ...
        /**
         * If owned = true, the name of the customer that owns the Cloud Identity account. Customer_name uses the format: accounts/{accountid\}/customers/{customerid\}
         */
    ...
    export interface Schema$GoogleCloudChannelV1CloudIdentityInfo {
        ...
        /**
         * Output only. Whether the domain is verified. This field is not returned for a Customer's cloudidentity_info resource. Partners can use the domains.get() method of the Workspace SDK's Directory API, or listen to the PRIMARY_DOMAIN_VERIFIED Pub/Sub event in to track domain verification of their resolve Workspace customers.
         */
    ...
    export interface Schema$GoogleCloudChannelV1Customer {
        ...
        domain?: string | null;
        /**
         * Optional. The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see https://www.unicode.org/reports/tr35/#Unicode_localeidentifier.
         */
        languageCode?: string | null;
        /**
         * Output only. Resource name of the customer. Format: accounts/{accountid\}/customers/{customerid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1CustomerRepricingConfig {
        /**
         * Output only. Resource name of the CustomerRepricingConfig. Format: accounts/{accountid\}/customers/{customerid\}/customerRepricingConfigs/{id\}.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1EntitlementChange {
        ...
        createTime?: string | null;
        /**
         * Required. Resource name of an entitlement in the form: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         */
        entitlement?: string | null;
        /**
         * Required. Resource name of the Offer at the time of change. Takes the form: accounts/{accountid\}/offers/{offerid\}.
         */
        offer?: string | null;
        /**
        ...
        /**
         * Extended parameters, such as: purchase_order_number, gcp_details; internal_correlationid, long_running_operationid, orderid; etc.
         */
        parameters?: Schema$GoogleCloudChannelV1Parameter[];
        /**
         * Service provisioned for an Entitlement.
    ...
    export interface Schema$GoogleCloudChannelV1ImportCustomerRequest {
        ...
        cloudIdentityId?: string | null;
        /**
         * Optional. Specifies the customer that will receive imported Cloud Identity information. Format: accounts/{accountid\}/customers/{customerid\}
         */
        customer?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1ListTransferableOffersRequest {
        /**
         * Optional. The Billing Account to look up Offers for. Format: accounts/{accountid\}/billingAccounts/{billing_accountid\}. This field is only relevant for multi-currency accounts. It should be left empty for single currency accounts.
         */
        billingAccount?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1ListTransferableSkusRequest {
        ...
        cloudIdentityId?: string | null;
        /**
         * A reseller is required to create a customer and use the resource name of the created customer here. Customer_name uses the format: accounts/{accountid\}/customers/{customerid\}
         */
        customerName?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1Offer {
        ...
        /**
         * Resource Name of the Offer. Format: accounts/{accountid\}/offers/{offerid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudChannelV1RepricingConfigEntitlementGranularity {
        /**
         * Resource name of the entitlement. Format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         */
        entitlement?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudChannelV1RunReportJobRequest {
        ...
        dateRange?: Schema$GoogleCloudChannelV1DateRange;
        /**
         * Optional. A structured string that defines conditions on dimension columns to restrict the report output. Filters support logical operators (AND, OR, NOT) and conditional operators (=, !=, <, \>, <=, and \>=) using `columnid` as keys. For example: `(customer:"accounts/C123abc/customers/S456def" OR customer:"accounts/C123abc/customers/S789ghi") AND invoice_start_date.year \>= 2022`
         */
        filter?: string | null;
        /**
    ...
    export class Resource$Accounts {
         ...
         *     // Required. The reseller account's resource name. Parent uses the format: accounts/{accountid\}
    ...
    export class Resource$Accounts$Channelpartnerlinks {
         ...
         *     // Required. Create a channel partner link for the provided reseller account's resource name. Parent uses the format: accounts/{accountid\}
         *     parent: 'accounts/my-account',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the channel partner link to retrieve. Name uses the format: accounts/{accountid\}/channelPartnerLinks/{id\} where {id\} is the Cloud Identity ID of the partner.
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The resource name of the reseller account for listing channel partner links. Parent uses the format: accounts/{accountid\}
         *     parent: 'accounts/my-account',
         *     // Optional. The level of granularity the ChannelPartnerLink will display.
         *     view: 'placeholder-value',
         *   });
        ...
        /**
         * Updates a channel partner link. Distributors call this method to change a link's status. For example, to suspend a partner link. You must be a distributor to call this method. Possible error codes: * PERMISSION_DENIED: The reseller account making the request is different from the reseller account in the API request. * INVALID_ARGUMENT: * Required request parameters are missing or invalid. * Link state cannot change from invited to active or suspended. * Cannot send reseller_cloudidentityid, invite_url, or name in update mask. * NOT_FOUND: ChannelPartnerLink resource not found. * INTERNAL: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. Return value: The updated ChannelPartnerLink resource.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *     // Required. The resource name of the channel partner link to cancel. Name uses the format: accounts/{accountid\}/channelPartnerLinks/{id\} where {id\} is the Cloud Identity ID of the partner.
         *     name: 'accounts/my-account/channelPartnerLinks/my-channelPartnerLink',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Accounts$Channelpartnerlinks$Channelpartnerrepricingconfigs {
         ...
         *       {
         *         // Required. The resource name of the ChannelPartner that will receive the repricing config. Parent uses the format: accounts/{accountid\}/channelPartnerLinks/{channel_partnerid\}
         ...
         *       {
         *         // Required. The resource name of the ChannelPartnerRepricingConfig Format: accounts/{accountid\}/channelPartnerLinks/{channel_partnerid\}/channelPartnerRepricingConfigs/{id\}.
         *         name: 'accounts/my-account/channelPartnerLinks/my-channelPartnerLink/channelPartnerRepricingConfigs/my-channelPartnerRepricingConfig',
         *       },
         *     );
         *   console.log(res.data);
         ...
         *       {
         *         // Optional. A filter for [CloudChannelService.ListChannelPartnerRepricingConfigs] results (channel_partner_link only). You can use this filter when you support a BatchGet-like query. To use the filter, you must set `parent=accounts/{accountid\}/channelPartnerLinks/-`. Example: `channel_partner_link = accounts/accountid/channelPartnerLinks/c1` OR `channel_partner_link = accounts/accountid/channelPartnerLinks/c2`.
         ...
         *         pageToken: 'placeholder-value',
         *         // Required. The resource name of the account's ChannelPartnerLink. Parent uses the format: accounts/{accountid\}/channelPartnerLinks/{channel_partnerid\}. Supports accounts/{accountid\}/channelPartnerLinks/- to retrieve configs for all channel partners.
         *         parent: 'accounts/my-account/channelPartnerLinks/my-channelPartnerLink',
         *       },
         *     );
         *   console.log(res.data);
    ...
    export class Resource$Accounts$Channelpartnerlinks$Customers {
         ...
         *     // Required. The resource name of reseller account in which to create the customer. Parent uses the format: accounts/{accountid\}
         *     parent: 'accounts/my-account/channelPartnerLinks/my-channelPartnerLink',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the customer to retrieve. Name uses the format: accounts/{accountid\}/customers/{customerid\}
         *     name: 'accounts/my-account/channelPartnerLinks/my-channelPartnerLink/customers/my-customer',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The resource name of the reseller's account. Parent takes the format: accounts/{accountid\} or accounts/{accountid\}/channelPartnerLinks/{channel_partnerid\}
         *     parent: 'accounts/my-account/channelPartnerLinks/my-channelPartnerLink',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The resource name of the reseller account to list customers from. Parent uses the format: accounts/{accountid\}.
         *     parent: 'accounts/my-account/channelPartnerLinks/my-channelPartnerLink',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Accounts$Customers {
         ...
         *     // Optional. Resource name of the new target Billing Account. Provide this Billing Account when setting up billing for a trial subscription. Format: accounts/{accountid\}/billingAccounts/{billing_accountid\}. This field is only relevant for multi-currency accounts. It should be left empty for single currency accounts.
         *     'changeOfferPurchase.billingAccount': 'placeholder-value',
         *     // Required. Resource name of the entitlement. Format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         ...
         *     // Optional. Billing account that the result should be restricted to. Format: accounts/{accountid\}/billingAccounts/{billing_accountid\}.
         ...
         *     // Required. The resource name of the customer to list Offers for. Format: accounts/{accountid\}/customers/{customerid\}.
         ...
         *     // Required. The resource name of the customer to list SKUs for. Format: accounts/{accountid\}/customers/{customerid\}.
         *     customer: 'accounts/my-account/customers/my-customer',
         *     // Optional. The BCP-47 language code. For example, "en-US". The response will localize in the corresponding language code, if specified. The default value is "en-US".
         *     languageCode: 'placeholder-value',
         ...
         *     // Required. Resource name of the customer. Format: accounts/{accountid\}/customers/{customerid\}
         *     customer: 'accounts/my-account/customers/my-customer',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *       // Required. The resource name of the customer to list eligible billing accounts for. Format: accounts/{accountid\}/customers/{customerid\}.
         *       customer: 'accounts/my-account/customers/my-customer',
         ...
         *     // Required. The resource name of the reseller's customer account that will receive transferred entitlements. Parent uses the format: accounts/{accountid\}/customers/{customerid\}
         ...
         *       // Required. The resource name of the reseller's customer account where the entitlements transfer from. Parent uses the format: accounts/{accountid\}/customers/{customerid\}
         *       parent: 'accounts/my-account/customers/my-customer',
         *
         *       // Request body metadata
         *       requestBody: {
    ...
    export class Resource$Accounts$Customers$Customerrepricingconfigs {
         ...
         *       // Required. The resource name of the customer that will receive this repricing config. Parent uses the format: accounts/{accountid\}/customers/{customerid\}
         *       parent: 'accounts/my-account/customers/my-customer',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *       // Required. The resource name of the customer repricing config rule to delete. Format: accounts/{accountid\}/customers/{customerid\}/customerRepricingConfigs/{id\}.
         ...
         *       // Required. The resource name of the CustomerRepricingConfig. Format: accounts/{accountid\}/customers/{customerid\}/customerRepricingConfigs/{id\}.
         *       name: 'accounts/my-account/customers/my-customer/customerRepricingConfigs/my-customerRepricingConfig',
         *     });
         *   console.log(res.data);
         *
         ...
         *       // Optional. A filter for [CloudChannelService.ListCustomerRepricingConfigs] results (customer only). You can use this filter when you support a BatchGet-like query. To use the filter, you must set `parent=accounts/{accountid\}/customers/-`. Example: customer = accounts/accountid/customers/c1 OR customer = accounts/accountid/customers/c2.
         *       filter: 'placeholder-value',
         *       // Optional. The maximum number of repricing configs to return. The service may return fewer than this value. If unspecified, returns a maximum of 50 rules. The maximum value is 100; values above 100 will be coerced to 100.
         *       pageSize: 'placeholder-value',
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. The resource name of the customer. Parent uses the format: accounts/{accountid\}/customers/{customerid\}. Supports accounts/{accountid\}/customers/- to retrieve configs for all customers.
         *       parent: 'accounts/my-account/customers/my-customer',
         *     });
         *   console.log(res.data);
         *
    ...
    export class Resource$Accounts$Customers$Entitlements {
         ...
         *     // Required. The resource name of the entitlement to activate. Name uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         ...
         *     // Required. The resource name of the entitlement to cancel. Name uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         *     name: 'accounts/my-account/customers/my-customer/entitlements/my-entitlement',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the entitlement to update. Name uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         *     name: 'accounts/my-account/customers/my-customer/entitlements/my-entitlement',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *       // Required. The name of the entitlement to update. Name uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         *       name: 'accounts/my-account/customers/my-customer/entitlements/my-entitlement',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *     // Required. The resource name of the reseller's customer account in which to create the entitlement. Parent uses the format: accounts/{accountid\}/customers/{customerid\}
         *     parent: 'accounts/my-account/customers/my-customer',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the entitlement to retrieve. Name uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         *     name: 'accounts/my-account/customers/my-customer/entitlements/my-entitlement',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The resource name of the reseller's customer account to list entitlements for. Parent uses the format: accounts/{accountid\}/customers/{customerid\}
         *     parent: 'accounts/my-account/customers/my-customer',
         *   });
         *   console.log(res.data);
         *
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. The resource name of the entitlement for which to list entitlement changes. The `-` wildcard may be used to match entitlements across a customer. Formats: * accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\} * accounts/{accountid\}/customers/{customerid\}/entitlements/-
         *       parent:
         ...
         *     // Required. The resource name of the entitlement to retrieve the Offer. Entitlement uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         *     entitlement:
         *       'accounts/my-account/customers/my-customer/entitlements/my-entitlement',
         *   });
         *   console.log(res.data);
         ...
         *       // Required. The name of the entitlement to start a paid service for. Name uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         *       name: 'accounts/my-account/customers/my-customer/entitlements/my-entitlement',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *     // Required. The resource name of the entitlement to suspend. Name uses the format: accounts/{accountid\}/customers/{customerid\}/entitlements/{entitlementid\}
         *     name: 'accounts/my-account/customers/my-customer/entitlements/my-entitlement',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Accounts$Offers {
         ...
         *     // Optional. A token for a page of results other than the first page.
         *     pageToken: 'placeholder-value',
         *     // Required. The resource name of the reseller account from which to list Offers. Parent uses the format: accounts/{accountid\}.
         *     parent: 'accounts/my-account',
    ...
    export class Resource$Accounts$Reportjobs {
         ...
         *     // Required. The report job created by CloudChannelReportsService.RunReportJob. Report_job uses the format: accounts/{accountid\}/reportJobs/{report_jobid\}
    ...
    export class Resource$Accounts$Reports {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The resource name of the partner account to list available reports for. Parent uses the format: accounts/{accountid\}
         *     parent: 'accounts/my-account',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Products {
         ...
         *     // Required. The resource name of the reseller account. Format: accounts/{accountid\}.
         *     account: 'placeholder-value',
         *     // Optional. The BCP-47 language code. For example, "en-US". The response will localize in the corresponding language code, if specified. The default value is "en-US".
         *     languageCode: 'placeholder-value',
    ...
    export class Resource$Products$Skus {
         ...
         *     // Required. Resource name of the reseller. Format: accounts/{accountid\}.
         *     account: 'placeholder-value',
         *     // Optional. The BCP-47 language code. For example, "en-US". The response will localize in the corresponding language code, if specified. The default value is "en-US".
         *     languageCode: 'placeholder-value',
         *     // Optional. Requested page size. Server might return fewer results than requested. If unspecified, returns at most 100 SKUs. The maximum value is 1000; the server will coerce values above 1000.
