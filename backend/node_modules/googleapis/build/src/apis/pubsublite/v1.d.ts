...
export declare namespace pubsublite_v1 {
    ...
    export interface Schema$OperationMetadata {
        ...
        endTime?: string | null;
        /**
         * Resource path for the target of the operation. For example, targets of seeks are subscription resources, structured like: projects/{project_number\}/locations/{location\}/subscriptions/{subscriptionid\}
         */
        target?: string | null;
        /**
