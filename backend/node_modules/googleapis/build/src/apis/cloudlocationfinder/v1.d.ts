...
export declare namespace cloudlocationfinder_v1 {
    ...
    export interface Schema$CloudLocation {
        ...
        /**
         * Identifier. Name of the cloud location. Unique name of the cloud location including project and location using the form: `projects/{projectid\}/locations/{location\}/cloudLocations/{cloud_location\}`
         */
        name?: string | null;
        /**
