...
export declare namespace sheets_v4 {
    ...
    export interface Schema$AppendCellsRequest {
        ...
        sheetId?: number | null;
        /**
         * The ID of the table to append data to. The data will be only appended to the table body. This field also takes precedence over the `sheetid` field.
         */
        tableId?: string | null;
    }
    /**
    ...
    export interface Schema$BandedRange {
        ...
        /**
         * Output only. The reference of the banded range, used to identify the ID that is not supported by the banded_rangeid.
         */
    ...
    export interface Schema$DeveloperMetadataLookup {
        ...
        locationType?: string | null;
        /**
         * Limits the selected developer metadata to that which has a matching DeveloperMetadata.metadataid.
         */
        metadataId?: number | null;
        /**
    ...
    export interface Schema$FilterView {
        ...
        /**
         * The named range this filter view is backed by, if any. When writing, only one of range or named_rangeid or tableid may be set.
         */
        namedRangeId?: string | null;
        /**
         * The range this filter view covers. When writing, only one of range or named_rangeid or tableid may be set.
         */
        range?: Schema$GridRange;
        /**
         * The sort order per column. Later specifications are used when values are equal in the earlier specifications.
        ...
        sortSpecs?: Schema$SortSpec[];
        /**
         * The table this filter view is backed by, if any. When writing, only one of range or named_rangeid or tableid may be set.
         */
        tableId?: string | null;
        /**
    ...
    /**
     * A range on a sheet. All indexes are zero-based. Indexes are half open, i.e. the start index is inclusive and the end index is exclusive -- [start_index, end_index). Missing indexes indicate the range is unbounded on that side. For example, if `"Sheet1"` is sheet ID 123456, then: `Sheet1!A1:A1 == sheetid: 123456, start_row_index: 0, end_row_index: 1, start_column_index: 0, end_column_index: 1` `Sheet1!A3:B4 == sheetid: 123456, start_row_index: 2, end_row_index: 4, start_column_index: 0, end_column_index: 2` `Sheet1!A:B == sheetid: 123456, start_column_index: 0, end_column_index: 2` `Sheet1!A5:B == sheetid: 123456, start_row_index: 4, start_column_index: 0, end_column_index: 2` `Sheet1 == sheetid: 123456` The start index must always be less than or equal to the end index. If the start index equals the end index, then the range is empty. Empty ranges are typically not meaningful and are usually rendered in the UI as `#REF!`.
     */
    ...
    export interface Schema$ProtectedRange {
        ...
        /**
         * The named range this protected range is backed by, if any. When writing, only one of range or named_rangeid or tableid may be set.
         */
        namedRangeId?: string | null;
        /**
        ...
        protectedRangeId?: number | null;
        /**
         * The range that is being protected. The range may be fully unbounded, in which case this is considered a protected sheet. When writing, only one of range or named_rangeid or tableid may be set.
         */
        range?: Schema$GridRange;
        /**
        ...
        /**
         * The table this protected range is backed by, if any. When writing, only one of range or named_rangeid or tableid may be set.
         */
        tableId?: string | null;
        /**
