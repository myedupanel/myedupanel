...
export declare namespace script_v1 {
    ...
    /**
     * A request to run the function in a script. The script is identified by the specified `scriptid`. Executing a function on a script returns results based on the implementation of the script.
     */
