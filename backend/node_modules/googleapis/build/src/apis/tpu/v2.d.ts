...
export declare namespace tpu_v2 {
    ...
    export interface Schema$MultisliceParams {
        ...
        /**
         * Optional. Prefix of nodeids in case of multislice request. Should follow the `^[A-Za-z0-9_.~+%-]+$` regex format. If node_count = 3 and nodeid_prefix = "np", node ids of nodes created will be "np-0", "np-1", "np-2". If this field is not provided we use queued_resourceid as the nodeid_prefix.
         */
