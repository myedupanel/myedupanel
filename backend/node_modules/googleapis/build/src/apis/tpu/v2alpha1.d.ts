...
export declare namespace tpu_v2alpha1 {
    ...
    /**
     * Parameters to specify for multi-node QueuedResource requests. This field must be populated in case of multi-node requests instead of nodeid. It's an error to specify both nodeid and multi_node_params.
     */
    export interface Schema$MultiNodeParams {
        ...
        /**
         * Prefix of nodeids in case of multi-node request Should follow the `^[A-Za-z0-9_.~+%-]+$` regex format. If node_count = 3 and nodeid_prefix = "np", node ids of nodes created will be "np-0", "np-1", "np-2". If this field is not provided we use queued_resourceid as the nodeid_prefix.
         */
    ...
    export interface Schema$NodeSpec {
        ...
        node?: Schema$Node;
        /**
         * The unqualified resource name. Should follow the `^[A-Za-z0-9_.~+%-]+$` regex format. This is only specified when requesting a single node. In case of multi-node requests, multi_node_params must be populated instead. It's an error to specify both nodeid and multi_node_params.
         */
        nodeId?: string | null;
        /**
