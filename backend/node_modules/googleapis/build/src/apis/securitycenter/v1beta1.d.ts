...
export declare namespace securitycenter_v1beta1 {
    ...
    export interface Schema$Asset {
        ...
        /**
         * The relative resource name of this asset. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name Example: "organizations/{organizationid\}/assets/{assetid\}".
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Finding {
        ...
        /**
         * The canonical name of the finding. It's either "organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}", "folders/{folderid\}/sources/{sourceid\}/findings/{findingid\}" or "projects/{project_number\}/sources/{sourceid\}/findings/{findingid\}", depending on the closest CRM ancestor of the resource associated with the finding.
         */
        ...
        /**
         * The [relative resource name](https://cloud.google.com/apis/design/resource_names#relative_resource_name) of the finding. Example: "organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}", "folders/{folderid\}/sources/{sourceid\}/findings/{findingid\}", "projects/{projectid\}/sources/{sourceid\}/findings/{findingid\}".
         */
        name?: string | null;
        /**
        ...
        /**
         * The relative resource name of the source the finding belongs to. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name This field is immutable after creation time. For example: "organizations/{organizationid\}/sources/{sourceid\}"
         */
        parent?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudSecuritycenterV1beta1Finding {
        ...
        externalUri?: string | null;
        /**
         * The relative resource name of this finding. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name Example: "organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}"
         */
        name?: string | null;
        /**
         * Immutable. The relative resource name of the source the finding belongs to. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name This field is immutable after creation time. For example: "organizations/{organizationid\}/sources/{sourceid\}"
         */
        parent?: string | null;
        /**
         * For findings on Google Cloud resources, the full resource name of the Google Cloud resource this finding is for. See: https://cloud.google.com/apis/design/resource_names#full_resource_name When the finding is for a non-Google Cloud resource, the resourceName can be a customer or partner defined string. This field is immutable after creation time.
    ...
    export interface Schema$GoogleCloudSecuritycenterV1beta1SecurityMarks {
        ...
        /**
         * The relative resource name of the SecurityMarks. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name Examples: "organizations/{organizationid\}/assets/{assetid\}/securityMarks" "organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}/securityMarks".
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudSecuritycenterV1BigQueryExport {
        ...
        createTime?: string | null;
        /**
         * The dataset to write findings' updates to. Its format is "projects/[projectid]/datasets/[bigquery_datasetid]". BigQuery Dataset unique ID must contain only letters (a-z, A-Z), numbers (0-9), or underscores (_).
         */
        dataset?: string | null;
        /**
        ...
        /**
         * The relative resource name of this export. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name. Example format: "organizations/{organizationid\}/bigQueryExports/{exportid\}" Example format: "folders/{folderid\}/bigQueryExports/{exportid\}" Example format: "projects/{projectid\}/bigQueryExports/{exportid\}" This field is provided in responses, and is ignored when provided in create requests.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudSecuritycenterV1p1beta1SecurityMarks {
        /**
         * The canonical name of the marks. Examples: "organizations/{organizationid\}/assets/{assetid\}/securityMarks" "folders/{folderid\}/assets/{assetid\}/securityMarks" "projects/{project_number\}/assets/{assetid\}/securityMarks" "organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}/securityMarks" "folders/{folderid\}/sources/{sourceid\}/findings/{findingid\}/securityMarks" "projects/{project_number\}/sources/{sourceid\}/findings/{findingid\}/securityMarks"
         */
        canonicalName?: string | null;
        /**
         * Mutable user specified security marks belonging to the parent resource. Constraints are as follows: * Keys and values are treated as case insensitive * Keys must be between 1 - 256 characters (inclusive) * Keys must be letters, numbers, underscores, or dashes * Values have leading and trailing whitespace trimmed, remaining characters must be between 1 - 4096 characters (inclusive)
    ...
    export interface Schema$GoogleCloudSecuritycenterV1Resource {
        ...
        /**
         * A string representation of the resource path. For Google Cloud, it has the format of `organizations/{organizationid\}/folders/{folderid\}/folders/{folderid\}/projects/{projectid\}` where there can be any number of folders. For AWS, it has the format of `org/{organizationid\}/ou/{organizational_unitid\}/ou/{organizational_unitid\}/account/{accountid\}` where there can be any number of organizational units. For Azure, it has the format of `mg/{management_groupid\}/mg/{management_groupid\}/subscription/{subscriptionid\}/rg/{resource_group_name\}` where there can be any number of management groups.
         */
    ...
    export interface Schema$GoogleCloudSecuritycenterV2BigQueryExport {
        ...
        mostRecentEditor?: string | null;
        /**
         * Identifier. The relative resource name of this export. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name. The following list shows some examples: + `organizations/{organizationid\}/locations/{locationid\}/bigQueryExports/{exportid\}` + `folders/{folderid\}/locations/{locationid\}/bigQueryExports/{exportid\}` + `projects/{projectid\}/locations/{locationid\}/bigQueryExports/{exportid\}` This field is provided in responses, and is ignored when provided in create requests.
         */
        name?: string | null;
        /**
         * Output only. The service account that needs permission to create table and upload data to the BigQuery dataset.
    ...
    export interface Schema$GoogleCloudSecuritycenterV2Finding {
        ...
        /**
         * Output only. The canonical name of the finding. The following list shows some examples: + `organizations/{organizationid\}/sources/{sourceid\}/locations/{locationid\}/findings/{findingid\}` + `folders/{folderid\}/sources/{sourceid\}/locations/{locationid\}/findings/{findingid\}` + `projects/{projectid\}/sources/{sourceid\}/locations/{locationid\}/findings/{findingid\}` The prefix is the closest CRM ancestor of the resource associated with the finding.
         */
        canonicalName?: string | null;
        /**
        ...
        muteUpdateTime?: string | null;
        /**
         * Identifier. The [relative resource name](https://cloud.google.com/apis/design/resource_names#relative_resource_name) of the finding. The following list shows some examples: + `organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}` + `organizations/{organizationid\}/sources/{sourceid\}/locations/{locationid\}/findings/{findingid\}` + `folders/{folderid\}/sources/{sourceid\}/findings/{findingid\}` + `folders/{folderid\}/sources/{sourceid\}/locations/{locationid\}/findings/{findingid\}` + `projects/{projectid\}/sources/{sourceid\}/findings/{findingid\}` + `projects/{projectid\}/sources/{sourceid\}/locations/{locationid\}/findings/{findingid\}`
         */
        name?: string | null;
        /**
         * Represents the VPC networks that the resource is attached to.
        ...
        /**
         * The relative resource name of the source and location the finding belongs to. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name This field is immutable after creation time. The following list shows some examples: + `organizations/{organizationid\}/sources/{sourceid\}` + `folders/{foldersid\}/sources/{sourceid\}` + `projects/{projectsid\}/sources/{sourceid\}` + `organizations/{organizationid\}/sources/{sourceid\}/locations/{locationid\}` + `folders/{foldersid\}/sources/{sourceid\}/locations/{locationid\}` + `projects/{projectsid\}/sources/{sourceid\}/locations/{locationid\}`
         */
        parent?: string | null;
        /**
         * Output only. The human readable display name of the finding source such as "Event Threat Detection" or "Security Health Analytics".
    ...
    export interface Schema$GoogleCloudSecuritycenterV2OrgPolicy {
        /**
         * Identifier. The resource name of the org policy. Example: "organizations/{organizationid\}/policies/{constraint_name\}"
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudSecuritycenterV2SecurityMarks {
        /**
         * The canonical name of the marks. The following list shows some examples: + `organizations/{organizationid\}/assets/{assetid\}/securityMarks` + `organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}/securityMarks` + `organizations/{organizationid\}/sources/{sourceid\}/locations/{location\}/findings/{findingid\}/securityMarks` + `folders/{folderid\}/assets/{assetid\}/securityMarks` + `folders/{folderid\}/sources/{sourceid\}/findings/{findingid\}/securityMarks` + `folders/{folderid\}/sources/{sourceid\}/locations/{location\}/findings/{findingid\}/securityMarks` + `projects/{project_number\}/assets/{assetid\}/securityMarks` + `projects/{project_number\}/sources/{sourceid\}/findings/{findingid\}/securityMarks` + `projects/{project_number\}/sources/{sourceid\}/locations/{location\}/findings/{findingid\}/securityMarks`
         */
        canonicalName?: string | null;
        /**
         * Mutable user specified security marks belonging to the parent resource. Constraints are as follows: * Keys and values are treated as case insensitive * Keys must be between 1 - 256 characters (inclusive) * Keys must be letters, numbers, underscores, or dashes * Values have leading and trailing whitespace trimmed, remaining characters must be between 1 - 4096 characters (inclusive)
        ...
        /**
         * The relative resource name of the SecurityMarks. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name The following list shows some examples: + `organizations/{organizationid\}/assets/{assetid\}/securityMarks` + `organizations/{organizationid\}/sources/{sourceid\}/findings/{findingid\}/securityMarks` + `organizations/{organizationid\}/sources/{sourceid\}/locations/{location\}/findings/{findingid\}/securityMarks`
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudSecuritycenterV2SecurityPosture {
        ...
        /**
         * The name of the posture deployment, for example, `organizations/{orgid\}/posturedeployments/{posture_deploymentid\}`.
         */
    ...
    export interface Schema$OrganizationSettings {
        ...
        /**
         * The relative resource name of the settings. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name Example: "organizations/{organizationid\}/organizationSettings".
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$OrgPolicy {
        /**
         * The resource name of the org policy. Example: "organizations/{organizationid\}/policies/{constraint_name\}"
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$Source {
        ...
        displayName?: string | null;
        /**
         * The relative resource name of this source. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name Example: "organizations/{organizationid\}/sources/{sourceid\}"
         */
        name?: string | null;
    }
    /**
    ...
    export class Resource$Organizations {
         ...
         *     // Required. Name of the organization to get organization settings for. Its format is "organizations/[organizationid]/organizationSettings".
    ...
    export class Resource$Organizations$Assets {
         ...
         *     // Required. Name of the organization to groupBy. Its format is "organizations/[organizationid]".
         ...
         *     // Required. Name of the organization assets should belong to. Its format is "organizations/[organizationid]".
         *     parent: 'organizations/my-organization',
         *     // Time used as a reference point when filtering assets. The filter is limited to assets existing at the supplied time and their values are those at that specific time. Absence of this field will default to the API's version of NOW.
         ...
         *     // Required. Name of the organization to run asset discovery for. Its format is "organizations/[organizationid]".
         *     parent: 'organizations/my-organization',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Organizations$Sources {
         ...
         *     // Required. Resource name of the new source's parent. Its format should be "organizations/[organizationid]".
         *     parent: 'organizations/my-organization',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. Relative resource name of the source. Its format is "organizations/[organizationid]/source/[sourceid]".
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Resource name of the parent of sources to list. Its format should be "organizations/[organizationid]".
         *     parent: 'organizations/my-organization',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Organizations$Sources$Findings {
         ...
         *     // Required. Resource name of the new finding's parent. Its format should be "organizations/[organizationid]/sources/[sourceid]".
        ...
        /**
         * Filters an organization or source's findings and groups them by their specified properties. To group across all sources provide a `-` as the source id. Example: /v1beta1/organizations/{organizationid\}/sources/-/findings
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *     // Required. Name of the source to groupBy. Its format is "organizations/[organizationid]/sources/[sourceid]". To groupBy across all sources provide a sourceid of `-`. For example: organizations/{organizationid\}/sources/-
         *     parent: 'organizations/my-organization/sources/my-source',
         *
         *     // Request body metadata
         *     requestBody: {
        ...
        /**
         * Lists an organization or source's findings. To list across all sources provide a `-` as the source id. Example: /v1beta1/organizations/{organizationid\}/sources/-/findings
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Name of the source the findings belong to. Its format is "organizations/[organizationid]/sources/[sourceid]". To list across all sources provide a sourceid of `-`. For example: organizations/{organizationid\}/sources/-
         *     parent: 'organizations/my-organization/sources/my-source',
         *     // Time used as a reference point when filtering findings. The filter is limited to findings existing at the supplied time and their values are those at that specific time. Absence of this field will default to the API's version of NOW.
         *     readTime: 'placeholder-value',
         *   });
         ...
         *     // Required. The relative resource name of the finding. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name Example: "organizations/{organizationid\}/sources/{sourceid\}/finding/{findingid\}".
         *     name: 'organizations/my-organization/sources/my-source/findings/my-finding',
         *
         *     // Request body metadata
         *     requestBody: {
