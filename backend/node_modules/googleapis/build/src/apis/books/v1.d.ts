...
export declare namespace books_v1 {
    ...
    export class Resource$Cloudloading {
         ...
         *     drive_documentid: 'placeholder-value',
         *     // The document MIME type. It can be set only if the drive_documentid is set.
         *     mime_type: 'placeholder-value',
         *     // The document name. It can be set only if the drive_documentid is set.
