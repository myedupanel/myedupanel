...
export declare namespace osconfig_v1beta {
    ...
    export interface Schema$GuestPolicy {
        ...
        etag?: string | null;
        /**
         * Required. Unique name of the resource in this project using one of the following forms: `projects/{project_number\}/guestPolicies/{guest_policyid\}`.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Guestpolicies {
         ...
         *     // Required. The resource name of the guest policy using one of the following forms: `projects/{project_number\}/guestPolicies/{guest_policyid\}`.
