...
export declare namespace osconfig_v1alpha {
    ...
    export interface Schema$InstanceOSPoliciesCompliance {
        ...
        /**
         * Output only. The `InstanceOSPoliciesCompliance` API resource name. Format: `projects/{project_number\}/locations/{location\}/instanceOSPoliciesCompliances/{instanceid\}`
         */
        name?: string | null;
        /**
