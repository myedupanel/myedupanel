...
export declare namespace osconfig_v2 {
    ...
    export interface Schema$GoogleCloudOsconfigV2_OrchestrationScope_ResourceHierarchySelector {
        /**
         * Optional. Names of the folders in scope. Format: `folders/{folderid\}`
         */
    ...
    export interface Schema$GoogleCloudOsconfigV2__OrchestratedResource {
        ...
        id?: string | null;
        /**
         * Optional. OSPolicyAssignment resource to be created, updated or deleted. Name field is ignored and replace with a generated value. With this field set, orchestrator will perform actions on `project/{project\}/locations/{zone\}/osPolicyAssignments/{resourceid\}` resources, where `project` and `zone` pairs come from the expanded scope, and `resourceid` comes from the `resourceid` field of orchestrator resource.
         */
    ...
    export interface Schema$GoogleCloudOsconfigV2__PolicyOrchestrator {
        /**
         * Required. Action to be done by the orchestrator in `projects/{projectid\}/zones/{zoneid\}` locations defined by the `orchestration_scope`. Allowed values: - `UPSERT` - Orchestrator will create or update target resources. - `DELETE` - Orchestrator will delete target resources, if they exist
         */
        action?: string | null;
        /**
        ...
        /**
         * Immutable. Identifier. In form of * `organizations/{organizationid\}/locations/global/policyOrchestrators/{orchestratorid\}` * `folders/{folderid\}/locations/global/policyOrchestrators/{orchestratorid\}` * `projects/{projectid_or_number\}/locations/global/policyOrchestrators/{orchestratorid\}`
         */
        name?: string | null;
        /**
    ...
    export class Resource$Folders$Locations$Global$Policyorchestrators {
         ...
         *       // Required. The parent resource name in the form of: * `organizations/{organizationid\}/locations/global` * `folders/{folderid\}/locations/global` * `projects/{projectid_or_number\}/locations/global`
