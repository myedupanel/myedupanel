...
export declare namespace integrations_v1alpha {
    ...
    export interface Schema$EnterpriseCrmFrontendsEventbusProtoEventExecutionInfo {
        ...
        tenant?: string | null;
        /**
         * The trigger id of the workflow trigger config. If both triggerid and clientid is present, the workflow is executed from the start tasks provided by the matching trigger config otherwise it is executed from the default start tasks.
         */
        triggerId?: string | null;
        /**
    ...
    export interface Schema$EnterpriseCrmFrontendsEventbusProtoTaskConfig {
        ...
        lastModifiedTime?: string | null;
        /**
         * The set of tasks that are next in line to be executed as per the execution graph defined for the parent event, specified by `event_configid`. Each of these next tasks are executed only if the condition associated with them evaluates to true.
         */
    ...
    /**
     * Describes string and array limits when writing to logs. When a limit is exceeded the *shortener_type* describes how to shorten the field. nextid: 6
     */
    ...
    export interface Schema$GoogleCloudIntegrationsV1alphaErrorCatcherConfig {
        ...
        description?: string | null;
        /**
         * Required. An error catcher id is string representation for the error catcher config. Within a workflow, error_catcherid uniquely identifies an error catcher config among all error catcher configs for the workflow
         */
        errorCatcherId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest {
        ...
        requestId?: string | null;
        /**
         * Required. Matched against all {@link TriggerConfig\}s across all integrations. i.e. TriggerConfig.triggerid.equals(triggerid). The triggerid is in the format of `api_trigger/TRIGGER_NAME`.
         */
        triggerId?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudIntegrationsV1alphaIntegrationVersion {
        ...
        /**
         * Optional. An increasing sequence that is set when a new snapshot is created. The last created snapshot can be identified by [workflow_name, orgid latest(snapshot_number)]. However, last created snapshot need not be same as the HEAD. So users should always use "HEAD" tag to identify the head.
         */
        snapshotNumber?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudIntegrationsV1alphaResolveSuspensionRequest {
        /**
         * Suspension, containing the event_execution_infoid, taskid, and state to set on the corresponding suspension record.
         */
    ...
    export interface Schema$GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest {
        ...
        /**
         * Matched against all {@link TriggerConfig\}s across all integrations. i.e. TriggerConfig.triggerid.equals(triggerid)
         */
        triggerId?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudIntegrationsV1alphaTaskConfig {
        ...
        jsonValidationOption?: string | null;
        /**
         * Optional. The set of tasks that are next in line to be executed as per the execution graph defined for the parent event, specified by `event_configid`. Each of these next tasks are executed only if the condition associated with them evaluates to true.
         */
        ...
        taskExecutionStrategy?: string | null;
        /**
         * Required. The identifier of this task within its parent event config, specified by the client. This should be unique among all the tasks belong to the same event config. We use this field as the identifier to find next tasks (via field `next_tasks.taskid`).
         */
        taskId?: string | null;
        /**
    ...
    export interface Schema$GoogleInternalCloudCrmEventbusV3PostToQueueWithTriggerIdRequest {
        ...
        /**
         * Matched against all {@link TriggerConfig\}s across all workflows. i.e. TriggerConfig.triggerid.equals(triggerid) Required.
         */
        triggerId?: string | null;
        /**
         * Optional. If provided, the workflow_name is used to filter all the matched workflows having same triggerid+clientid. A combination of triggerid, clientid and workflow_name identifies a unique workflow.
         */
        workflowName?: string | null;
    }
    /**
    ...
    export class Resource$Projects$Locations$Integrations$Executions {
         ...
         *       // Optional. Standard filter field, we support filtering on following fields: workflow_name: the name of the integration. CreateTimestamp: the execution created time. event_execution_state: the state of the executions. executionid: the id of the execution. triggerid: the id of the trigger. parameter_type: the type of the parameters involved in the execution. All fields support for EQUALS, in additional: CreateTimestamp support for LESS_THAN, GREATER_THAN ParameterType support for HAS For example: "parameter_type" HAS \"string\" Also supports operators like AND, OR, NOT For example, triggerid=\"id1\" AND workflow_name=\"testWorkflow\"
         *       filter: 'placeholder-value',
    ...
    export class Resource$Projects$Locations$Integrations$Executions$Suspensions {
         ...
         *         pageToken: 'placeholder-value',
         *         // Required. projects/{gcp_projectid\}/locations/{location\}/products/{product\}/integrations/{integration_name\}/executions/{execution_name\}
         *         parent:
         ...
         *       {
         *         // Required. projects/{gcp_projectid\}/locations/{location\}/products/{product\}/integrations/{integration_name\}/executions/{execution_name\}/suspensions/{suspensionid\}
         *         name: 'projects/my-project/locations/my-location/integrations/my-integration/executions/my-execution/suspensions/my-suspension',
         *
         *         // Request body metadata
         *         requestBody: {
    ...
    export class Resource$Projects$Locations$Integrations$Versions {
        ...
        delete(callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        /**
         * Downloads an integration. Retrieves the `IntegrationVersion` for a given `integrationid` and returns the response as a string.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Projects$Locations$Products$Integrations$Executions {
         ...
         *       {
         *         // Required. The execution resource name. Format: projects/{gcp_projectid\}/locations/{location\}/products/{product\}/integrations/{integrationid\}/executions/{executionid\}
