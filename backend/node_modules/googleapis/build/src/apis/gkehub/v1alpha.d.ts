...
export declare namespace gkehub_v1alpha {
    ...
    export interface Schema$Authority {
        ...
        /**
         * Optional. A JSON Web Token (JWT) issuer URI. `issuer` must start with `https://` and be a valid URL with length <2000 characters, it must use `location` rather than `zone` for GKE clusters. If set, then Google will allow valid OIDC tokens from this issuer to authenticate within the workloadidentity_pool. OIDC discovery will be performed on this URI to validate tokens from the issuer. Clearing `issuer` disables Workload Identity. `issuer` cannot be directly modified; it must be cleared (and Workload Identity disabled) before using a new issuer (and re-enabling Workload Identity).
         */
        issuer?: string | null;
        /**
    ...
    export interface Schema$KubernetesMetadata {
        ...
        /**
         * Output only. Node providerID as reported by the first node in the list of nodes on the Kubernetes endpoint. On Kubernetes platforms that support zero-node clusters (like GKE-on-GCP), the node_count will be zero and the node_providerid will be empty.
         */
    ...
    export interface Schema$Membership {
        ...
        /**
         * Output only. The full, unique name of this Membership resource in the format `projects/x/locations/x/memberships/{membershipid\}`, set during creation. `membershipid` must be a valid RFC 1123 compliant DNS label: 1. At most 63 characters in length 2. It must consist of lower case alphanumeric characters or `-` 3. It must start and end with an alphanumeric character Which can be expressed as the regex: `[a-z0-9]([-a-z0-9]*[a-z0-9])?`, with a maximum length of 63 characters.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Memberships {
         ...
         *     // Required. Client chosen ID for the membership. `membershipid` must be a valid RFC 1123 compliant DNS label: 1. At most 63 characters in length 2. It must consist of lower case alphanumeric characters or `-` 3. It must start and end with an alphanumeric character Which can be expressed as the regex: `[a-z0-9]([-a-z0-9]*[a-z0-9])?`, with a maximum length of 63 characters.
        ...
        testIamPermissions(callback: BodyResponseCallback<Schema$TestIamPermissionsResponse>): void;
        /**
         * ValidateCreateMembership is a preflight check for CreateMembership. It checks the following: 1. Caller has the required `gkehub.memberships.create` permission. 2. The membershipid is still available.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Projects$Locations$Memberships$Rbacrolebindings {
         ...
         *       parent:
         *         'projects/my-project/locations/my-location/memberships/my-membership',
         *       // Required. Client chosen ID for the RBACRoleBinding. `rbacrolebindingid` must be a valid RFC 1123 compliant DNS label: 1. At most 63 characters in length 2. It must consist of lower case alphanumeric characters or `-` 3. It must start and end with an alphanumeric character Which can be expressed as the regex: `[a-z0-9]([-a-z0-9]*[a-z0-9])?`, with a maximum length of 63 characters.
    ...
    export class Resource$Projects$Locations$Scopes {
         ...
         *     parent: 'projects/my-project/locations/my-location',
         *     // Required. Client chosen ID for the Scope. `scopeid` must be a ????
         ...
         *     // Optional. Lists Memberships that match the filter expression, following the syntax outlined in https://google.aip.dev/160. Currently, filtering can be done only based on Memberships's `name`, `labels`, `create_time`, `update_time`, and `uniqueid`.
         *     filter: 'placeholder-value',
    ...
    export class Resource$Projects$Locations$Scopes$Namespaces {
         ...
         *     // Required. Client chosen ID for the Namespace. `namespaceid` must be a valid RFC 1123 compliant DNS label: 1. At most 63 characters in length 2. It must consist of lower case alphanumeric characters or `-` 3. It must start and end with an alphanumeric character Which can be expressed as the regex: `[a-z0-9]([-a-z0-9]*[a-z0-9])?`, with a maximum length of 63 characters.
