...
export declare namespace networksecurity_v1beta1 {
    ...
    export interface Schema$ThreatPreventionProfile {
        ...
        /**
         * Optional. Configuration for overriding threats actions by threatid match. If a threat is matched both by configuration provided in severity_overrides and threat_overrides, the threat_overrides action is applied.
         */
    ...
    export class Resource$Organizations$Locations$Firewallendpoints {
         ...
         *       // Required. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpointid from the method_signature of Create RPC.
    ...
    export class Resource$Organizations$Locations$Securityprofiles {
         ...
         *       // Optional. If client provided etag is out of date, delete will return FAILED_PRECONDITION error.
         *       etag: 'placeholder-value',
         *       // Required. A name of the SecurityProfile to delete. Must be in the format `projects|organizations/x/locations/{location\}/securityProfiles/{security_profileid\}`.
         ...
         *       // Required. A name of the SecurityProfile to get. Must be in the format `projects|organizations/x/locations/{location\}/securityProfiles/{security_profileid\}`.
         *       name: 'organizations/my-organization/locations/my-location/securityProfiles/my-securityProfile',
         *     });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Firewallendpointassociations {
         ...
         *       {
         *         // Optional. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_associationid from the method_signature of Create RPC.
