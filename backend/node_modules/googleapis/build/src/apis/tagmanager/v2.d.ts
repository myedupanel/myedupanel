...
export declare namespace tagmanager_v2 {
    ...
    export class Resource$Accounts$Containers {
         ...
         *
         *   // Do the magic
         *   const res = await tagmanager.accounts.containers.move_tagid({
         *     // Must be set to true to allow features.user_permissions to change from false to true. If this operation causes an update but this bit is false, the operation will fail.
         *     allowUserPermissionFeatureUpdate: 'placeholder-value',
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        move_tagid(params: Params$Resource$Accounts$Containers$Move_tagid, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        move_tagid(params?: Params$Resource$Accounts$Containers$Move_tagid, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Container>>;
        move_tagid(params: Params$Resource$Accounts$Containers$Move_tagid, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        move_tagid(params: Params$Resource$Accounts$Containers$Move_tagid, options: MethodOptions | BodyResponseCallback<Schema$Container>, callback: BodyResponseCallback<Schema$Container>): void;
        move_tagid(params: Params$Resource$Accounts$Containers$Move_tagid, callback: BodyResponseCallback<Schema$Container>): void;
        move_tagid(callback: BodyResponseCallback<Schema$Container>): void;
        /**
    ...
    export interface Params$Resource$Accounts$Containers$Move_tagid extends StandardParameters {
        /**
         * Must be set to true to allow features.user_permissions to change from false to true. If this operation causes an update but this bit is false, the operation will fail.
         */
        allowUserPermissionFeatureUpdate?: boolean;
