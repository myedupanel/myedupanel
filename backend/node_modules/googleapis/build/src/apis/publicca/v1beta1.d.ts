...
export declare namespace publicca_v1beta1 {
    ...
    export class Resource$Projects$Locations$Externalaccountkeys {
         ...
         *     // Required. The parent resource where this external_account_key will be created. Format: projects/[projectid]/locations/[location]. At present only the "global" location is supported.
