...
export declare namespace serviceusage_v1beta1 {
    ...
    export interface Schema$GetServiceIdentityResponse {
        /**
         * Service identity that service producer can use to access consumer resources. If exists is true, it contains email and uniqueid. If exists is false, it contains pre-constructed email and empty uniqueid.
         */
