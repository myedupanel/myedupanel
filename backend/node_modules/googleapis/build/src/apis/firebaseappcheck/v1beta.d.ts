...
export declare namespace firebaseappcheck_v1beta {
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaAppAttestConfig {
        /**
         * Required. The relative resource name of the App Attest configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/appAttestConfig ```
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaDebugToken {
        ...
        /**
         * Required. The relative resource name of the debug token, in the format: ``` projects/{project_number\}/apps/{appid\}/debugTokens/{debug_tokenid\} ```
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaDeviceCheckConfig {
        ...
        keyId?: string | null;
        /**
         * Required. The relative resource name of the DeviceCheck configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/deviceCheckConfig ```
         */
        name?: string | null;
        /**
         * Required. Input only. The contents of the private key (`.p8`) file associated with the key specified by `keyid`. For security reasons, this field will never be populated in any response.
         */
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaPlayIntegrityConfig {
        ...
        /**
         * Required. The relative resource name of the Play Integrity configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/playIntegrityConfig ```
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaRecaptchaConfig {
        ...
        /**
         * Required. The relative resource name of the reCAPTCHA v3 configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaConfig ```
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaRecaptchaEnterpriseConfig {
        /**
         * Required. The relative resource name of the reCAPTCHA Enterprise configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaEnterpriseConfig ```
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaRecaptchaV3Config {
        ...
        minValidScore?: number | null;
        /**
         * Required. The relative resource name of the reCAPTCHA v3 configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaV3Config ```
         */
        name?: string | null;
        /**
         * Required. Input only. The site secret used to identify your service for reCAPTCHA v3 verification. For security reasons, this field will never be populated in any response.
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaResourcePolicy {
        ...
        etag?: string | null;
        /**
         * Required. Identifier. The relative name of the resource policy object, in the format: ``` projects/{project_number\}/services/{serviceid\}/resourcePolicies/{resource_policyid\} ``` Note that the `serviceid` element must be a supported service ID. Currently, the following service IDs are supported: * `oauth2.googleapis.com` (Google Identity for iOS) `resource_policyid` is a system-generated UID.
         */
        name?: string | null;
        /**
         * Required. Service specific name of the resource object to which this policy applies, in the format: * **iOS OAuth clients** (Google Identity for iOS): `//oauth2.googleapis.com/projects/{project_number\}/oauthClients/{oauth_clientid\}` Note that the resource must belong to the service specified in the `name` and be from the same project as this policy, but the resource is allowed to be missing at the time of creation of this policy; in that case, we make a best-effort attempt at respecting this policy, but it may not have any effect until the resource is fully created.
         */
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaSafetyNetConfig {
        /**
         * Required. The relative resource name of the SafetyNet configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/safetyNetConfig ```
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppcheckV1betaService {
        ...
        etag?: string | null;
        /**
         * Required. The relative resource name of the service configuration object, in the format: ``` projects/{project_number\}/services/{serviceid\} ``` Note that the `serviceid` element must be a supported service ID. Currently, the following service IDs are supported: * `firebasestorage.googleapis.com` (Cloud Storage for Firebase) * `firebasedatabase.googleapis.com` (Firebase Realtime Database) * `firestore.googleapis.com` (Cloud Firestore) * `identitytoolkit.googleapis.com` (Firebase Authentication with Identity Platform) * `oauth2.googleapis.com` (Google Identity for iOS)
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Apps {
         ...
         *     // Required. The relative resource name of the app, in the format: ``` projects/{project_number\}/apps/{appid\} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.
         *     app: 'projects/my-project/apps/my-app',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Apps$Appattestconfig {
         ...
         *     // Required. The relative resource names of the AppAttestConfigs to retrieve, in the format ``` projects/{project_number\}/apps/{appid\}/appAttestConfig ``` A maximum of 100 objects can be retrieved in a batch.
         ...
         *     // Required. The relative resource name of the AppAttestConfig, in the format: ``` projects/{project_number\}/apps/{appid\}/appAttestConfig ```
    ...
    export class Resource$Projects$Apps$Debugtokens {
         ...
         *     // Required. The relative resource name of the parent app in which the specified DebugToken will be created, in the format: ``` projects/{project_number\}/apps/{appid\} ```
         ...
         *     // Required. The relative resource name of the DebugToken to delete, in the format: ``` projects/{project_number\}/apps/{appid\}/debugTokens/{debug_tokenid\} ```
         ...
         *     // Required. The relative resource name of the parent app for which to list each associated DebugToken, in the format: ``` projects/{project_number\}/apps/{appid\} ```
         *     parent: 'projects/my-project/apps/my-app',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Apps$Devicecheckconfig {
         ...
         *     // Required. The relative resource names of the DeviceCheckConfigs to retrieve, in the format ``` projects/{project_number\}/apps/{appid\}/deviceCheckConfig ``` A maximum of 100 objects can be retrieved in a batch.
         *     names: 'placeholder-value',
         ...
         *     // Required. The relative resource name of the DeviceCheckConfig, in the format: ``` projects/{project_number\}/apps/{appid\}/deviceCheckConfig ```
         ...
         *     // Required. The relative resource name of the DeviceCheck configuration object, in the format: ``` projects/{project_number\}/apps/{appid\}/deviceCheckConfig ```
         *     name: 'projects/my-project/apps/my-app/deviceCheckConfig',
         *     // Required. A comma-separated list of names of fields in the DeviceCheckConfig to update. Example: `keyid,private_key`.
         *     updateMask: 'placeholder-value',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Apps$Playintegrityconfig {
         ...
         *     {
         *       // Required. The relative resource names of the PlayIntegrityConfigs to retrieve, in the format ``` projects/{project_number\}/apps/{appid\}/playIntegrityConfig ``` A maximum of 100 objects can be retrieved in a batch.
         *       names: 'placeholder-value',
         ...
         *     // Required. The relative resource name of the PlayIntegrityConfig, in the format: ``` projects/{project_number\}/apps/{appid\}/playIntegrityConfig ```
    ...
    export class Resource$Projects$Apps$Recaptchaconfig {
         ...
         *     // Required. The relative resource names of the RecaptchaConfigs to retrieve, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaConfig ``` A maximum of 100 objects can be retrieved in a batch.
         *     names: 'placeholder-value',
         ...
         *     // Required. The relative resource name of the RecaptchaConfig, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaConfig ```
    ...
    export class Resource$Projects$Apps$Recaptchaenterpriseconfig {
         ...
         *       // Required. The relative resource names of the RecaptchaEnterpriseConfigs to retrieve, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaEnterpriseConfig ``` A maximum of 100 objects can be retrieved in a batch.
         *       names: 'placeholder-value',
         ...
         *       // Required. The relative resource name of the RecaptchaEnterpriseConfig, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaEnterpriseConfig ```
    ...
    export class Resource$Projects$Apps$Recaptchav3config {
         ...
         *     // Required. The relative resource names of the RecaptchaV3Configs to retrieve, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaV3Config ``` A maximum of 100 objects can be retrieved in a batch.
         *     names: 'placeholder-value',
         ...
         *     // Required. The relative resource name of the RecaptchaV3Config, in the format: ``` projects/{project_number\}/apps/{appid\}/recaptchaV3Config ```
    ...
    export class Resource$Projects$Apps$Safetynetconfig {
         ...
         *     // Required. The relative resource names of the SafetyNetConfigs to retrieve, in the format ``` projects/{project_number\}/apps/{appid\}/safetyNetConfig ``` A maximum of 100 objects can be retrieved in a batch.
         *     names: 'placeholder-value',
         ...
         *     // Required. The relative resource name of the SafetyNetConfig, in the format: ``` projects/{project_number\}/apps/{appid\}/safetyNetConfig ```
    ...
    export class Resource$Projects$Services$Resourcepolicies {
         ...
         *       // Required. The parent service name, in the format ``` projects/{project_number\}/services/{serviceid\} ``` The parent collection in the `name` field of any resource being updated must match this field, or the entire batch fails.
         ...
         *     // Required. The relative resource name of the ResourcePolicy to delete, in the format: ``` projects/{project_number\}/services/{serviceid\}/resourcePolicies/{resource_policyid\} ```
