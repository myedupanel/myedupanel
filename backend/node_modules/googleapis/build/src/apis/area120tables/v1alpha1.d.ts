...
export declare namespace area120tables_v1alpha1 {
    ...
    export interface Schema$ColumnDescription {
        /**
         * Data type of the column Supported types are autoid, boolean, boolean_list, creator, create_timestamp, date, dropdown, location, integer, integer_list, number, number_list, person, person_list, tags, check_list, text, text_list, update_timestamp, updater, relationship, file_attachment_list. These types directly map to the column types supported on Tables website.
         */
