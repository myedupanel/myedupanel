...
export declare namespace dataproc_v1beta2 {
    ...
    export interface Schema$AcceleratorConfig {
        ...
        /**
         * Full URL, partial URI, or short name of the accelerator type resource to expose to this instance. See Compute Engine AcceleratorTypes (https://cloud.google.com/compute/docs/reference/beta/acceleratorTypes)Examples * https://www.googleapis.com/compute/beta/projects/[projectid]/zones/us-east1-a/acceleratorTypes/nvidia-tesla-k80 * projects/[projectid]/zones/us-east1-a/acceleratorTypes/nvidia-tesla-k80 * nvidia-tesla-k80Auto Zone Exception: If you are using the Dataproc Auto Zone Placement (https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the accelerator type resource, for example, nvidia-tesla-k80.
         */
    ...
    export interface Schema$GceClusterConfig {
        ...
        /**
         * Optional. The Compute Engine network to be used for machine communications. Cannot be specified with subnetwork_uri. If neither network_uri nor subnetwork_uri is specified, the "default" network of the project is used, if it exists. Cannot be a "Custom Subnet Network" (see Using Subnetworks (https://cloud.google.com/compute/docs/subnetworks) for more information).A full URL, partial URI, or short name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[projectid]/regions/global/default projects/[projectid]/regions/global/default default
         */
        ...
        /**
         * Optional. The Compute Engine subnetwork to be used for machine communications. Cannot be specified with network_uri.A full URL, partial URI, or short name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[projectid]/regions/us-east1/subnetworks/sub0 projects/[projectid]/regions/us-east1/subnetworks/sub0 sub0
         */
        ...
        tags?: string[] | null;
        /**
         * Optional. The zone where the Compute Engine cluster will be located. On a create request, it is required in the "global" region. If omitted in a non-global Dataproc region, the service will pick a zone in the corresponding Compute Engine region. On a get request, zone will always be present.A full URL, partial URI, or short name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[projectid]/zones/[zone] projects/[projectid]/zones/[zone] us-central1-f
         */
        zoneUri?: string | null;
    }
    /**
    ...
    export interface Schema$InstanceGroupConfig {
        ...
        /**
         * Optional. The Compute Engine image resource used for cluster instances.The URI can represent an image or image family.Image examples: https://www.googleapis.com/compute/beta/projects/[projectid]/global/images/[image-id] projects/[projectid]/global/images/[image-id] image-idImage family examples. Dataproc will use the most recent image from the family: https://www.googleapis.com/compute/beta/projects/[projectid]/global/images/family/[custom-image-family-name] projects/[projectid]/global/images/family/[custom-image-family-name]If the URI is unspecified, it will be inferred from SoftwareConfig.image_version or the system default.
         */
    ...
    export interface Schema$InstantiateWorkflowTemplateRequest {
        /**
         * Deprecated. Please use requestid field instead.
         */
        instanceId?: string | null;
        /**
    ...
    export interface Schema$Job {
        ...
        /**
         * Output only. A UUID that uniquely identifies a job within the project over time. This is in contrast to a user-settable reference.jobid that may be reused over time.
         */
        jobUuid?: string | null;
        /**
    ...
    export interface Schema$NodeGroupAffinity {
        /**
         * Required. The URI of a sole-tenant node group resource (https://cloud.google.com/compute/docs/reference/rest/v1/nodeGroups) that the cluster will be created on.A full URL, partial URI, or node group name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[projectid]/zones/us-central1-a/nodeGroups/node-group-1 projects/[projectid]/zones/us-central1-a/nodeGroups/node-group-1 node-group-1
         */
