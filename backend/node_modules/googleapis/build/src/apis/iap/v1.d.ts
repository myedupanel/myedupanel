...
export declare namespace iap_v1 {
    ...
    export class Resource$Projects$Brands$Identityawareproxyclients {
         ...
         *     // Required. Name of the Identity Aware Proxy client to be deleted. In the following format: projects/{project_number/id\}/brands/{brand\}/identityAwareProxyClients/{clientid\}.
         ...
         *     // Required. Name of the Identity Aware Proxy client to be fetched. In the following format: projects/{project_number/id\}/brands/{brand\}/identityAwareProxyClients/{clientid\}.
         *     name: 'projects/my-project/brands/my-brand/identityAwareProxyClients/my-identityAwareProxyClient',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. Name of the Identity Aware Proxy client to that will have its secret reset. In the following format: projects/{project_number/id\}/brands/{brand\}/identityAwareProxyClients/{clientid\}.
         *     name: 'projects/my-project/brands/my-brand/identityAwareProxyClients/my-identityAwareProxyClient',
         *
         *     // Request body metadata
         *     requestBody: {
