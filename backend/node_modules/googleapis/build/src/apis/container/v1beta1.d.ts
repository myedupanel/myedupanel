...
export declare namespace container_v1beta1 {
    ...
    export interface Schema$ClusterUpdate {
        ...
        /**
         * Autoscaler configuration for the node pool specified in desired_node_poolid. If there is only one pool in the cluster and desired_node_poolid is not provided then the change applies to that single node pool.
         */
    ...
    export interface Schema$PolicyBinding {
        /**
         * The relative resource name of the binauthz platform policy to evaluate. GKE platform policies have the following format: `projects/{project_number\}/platforms/gke/policies/{policyid\}`.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$ResourceManagerTags {
        /**
         * Tags must be in one of the following formats ([KEY]=[VALUE]) 1. `tagKeys/{tag_keyid\}=tagValues/{tag_valueid\}` 2. `{orgid\}/{tag_key_name\}={tag_value_name\}` 3. `{projectid\}/{tag_key_name\}={tag_value_name\}`
         */
        tags?: {
            [key: string]: string;
        } | null;
