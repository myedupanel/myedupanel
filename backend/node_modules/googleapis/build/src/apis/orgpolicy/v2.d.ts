...
export declare namespace orgpolicy_v2 {
    ...
    export interface Schema$GoogleCloudOrgpolicyV2Constraint {
        ...
        /**
         * Immutable. The resource name of the constraint. Must be in one of the following forms: * `projects/{project_number\}/constraints/{constraint_name\}` * `folders/{folderid\}/constraints/{constraint_name\}` * `organizations/{organizationid\}/constraints/{constraint_name\}` For example, "/projects/123/constraints/compute.disableSerialPortAccess".
         */
        name?: string | null;
        /**
    ...
    export class Resource$Folders$Constraints {
         ...
         *     // Required. The Google Cloud resource that parents the constraint. Must be in one of the following forms: * `projects/{project_number\}` * `projects/{projectid\}` * `folders/{folderid\}` * `organizations/{organizationid\}`
    ...
    export class Resource$Folders$Policies {
         ...
         *     // Required. The Google Cloud resource that will parent the new policy. Must be in one of the following forms: * `projects/{project_number\}` * `projects/{projectid\}` * `folders/{folderid\}` * `organizations/{organizationid\}`
         *     parent: 'folders/my-folder',
         *
         ...
         *     // Page token used to retrieve the next page. This is currently unsupported and will be ignored. The server may at any point start using this field.
         *     pageToken: 'placeholder-value',
         *     // Required. The target Google Cloud resource that parents the set of constraints and policies that will be returned from this call. Must be in one of the following forms: * `projects/{project_number\}` * `projects/{projectid\}` * `folders/{folderid\}` * `organizations/{organizationid\}`
         *     parent: 'folders/my-folder',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Organizations$Customconstraints {
         ...
         *     // Required. Must be in the following form: * `organizations/{organizationid\}`
         *     parent: 'organizations/my-organization',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Page token used to retrieve the next page. This is currently unsupported and will be ignored. The server may at any point start using this field.
         *     pageToken: 'placeholder-value',
         *     // Required. The target Google Cloud resource that parents the set of custom constraints that will be returned from this call. Must be in one of the following forms: * `organizations/{organizationid\}`
         *     parent: 'organizations/my-organization',
         *   });
         *   console.log(res.data);
         *
