...
export declare namespace admob_v1beta {
    ...
    export interface Schema$Adapter {
        ...
        /**
         * Output only. ID of this adapter. It is used to set [adapterid](#AdUnitMapping.adapterid).
         */
        ...
        formats?: string[] | null;
        /**
         * Output only. Resource name of the adapter. Format is: accounts/{publisherid\}/adSources/{ad_sourceid\}/adapters/{adapterid\}.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$AdSource {
        ...
        /**
         * Resource name of this ad source. Format is: accounts/{publisherid\}/adSources/{ad_sourceid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$AdUnit {
        ...
        /**
         * Resource name for this ad unit. Format is accounts/{publisherid\}/adUnits/{ad_unitid_fragment\} Example: accounts/pub-9876543210987654/adUnits/0123456789
         */
        name?: string | null;
        /**
    ...
    export interface Schema$AdUnitMapping {
        ...
        displayName?: string | null;
        /**
         * Resource name of this ad unit mapping. Format is: accounts/{publisherid\}/adUnits/{ad_unitid_fragment\}/adUnitMappings/{ad_unit_mappingid\} Example: accounts/pub-1234567890123456/adUnits/0123456789/adUnitMappings/987654321
         */
        name?: string | null;
        /**
    ...
    export interface Schema$App {
        ...
        /**
         * Resource name for this app. Format is accounts/{publisherid\}/apps/{appid_fragment\} Example: accounts/pub-9876543210987654/apps/0123456789
         */
        name?: string | null;
        /**
    ...
    export interface Schema$CreateAdUnitMappingRequest {
        ...
        /**
         * Required. The parent which owns the ad unit mapping. Format: accounts/{publisherid\}/adUnits/{ad_unitid\}
         */
        parent?: string | null;
    }
    /**
    ...
    export interface Schema$MediationAbExperiment {
        ...
        /**
         * Resource name for this experiment. The format is accounts/{publisherid\}/ mediationGroups/{mediation_groupid\}/mediationAbExperiment/ {mediation_group_experimentid\}. For example: accounts/pub-9876543210987654/mediationGroups/0123456789/ mediationAbExperiment/12345
         */
        name?: string | null;
        /**
    ...
    export interface Schema$MediationGroup {
        ...
        /**
         * Resource name for this mediation group. Format is: accounts/{publisherid\}/mediationGroups/{mediation_groupid\} Example: accounts/pub-9876543210987654/mediationGroups/0123456789
         */
        name?: string | null;
        /**
    ...
    export class Resource$Accounts$Adsources$Adapters {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent which owns this collection of adapters. Format: accounts/{publisherid\}/adSources/{ad_sourceid\}
    ...
    export class Resource$Accounts$Adunits$Adunitmappings {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent which owns this collection of ad unit mappings. Format: accounts/{publisherid\}/adUnits/{ad_unitid\}
         *     parent: 'accounts/my-account/adUnits/my-adUnit',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Accounts$Mediationgroups {
         ...
         *     // List of mediation group fields to be updated. Updates to repeated fields such as items in a list will fully replace the existing value(s) with the new value(s). Updates to individual values in a map can be done by indexing by the key. The following field masks are supported for mediation group updates: - "mediation_group_lines[\"{mediation_group_lineid\}\"]" clang-format off - "mediation_group_lines[\"{mediation_group_lineid\}\"].ad_unit_mappings[\"{ad_unitid\}\"]" clang-format on - "mediation_group_lines[\"{mediation_group_lineid\}\"].cpm_micros" - "mediation_group_lines[\"{mediation_group_lineid\}\"].cpm_mode" - "mediation_group_lines[\"{mediation_group_lineid\}\"].state" - "mediation_group_lines[\"{mediation_group_lineid\}\"].display_name" - "targeting.ad_unitids" To update a mediation group with a new mediation group line, use a distinct negative number for the "mediation_group_lineid". For Example: update_mask { paths: "mediation_group_lines[\"123456789012345\"].cpm_micros" \}
    ...
    export class Resource$Accounts$Mediationgroups$Mediationabexperiments {
         ...
         *       // Required. The parent which owns the mediation group. Format: accounts/{publisherid\}/mediationGroups/{mediation_groupid\}
