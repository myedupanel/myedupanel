...
export declare namespace networkconnectivity_v1 {
    ...
    export interface Schema$Group {
        ...
        /**
         * Immutable. The name of the group. Group names must be unique. They use the following form: `projects/{project_number\}/locations/global/hubs/{hub\}/groups/{groupid\}`
         */
        name?: string | null;
        /**
         * Output only. The name of the route table that corresponds to this group. They use the following form: `projects/{project_number\}/locations/global/hubs/{hubid\}/routeTables/{route_tableid\}`
         */
    ...
    export interface Schema$Hub {
        ...
        /**
         * Immutable. The name of the hub. Hub names must be unique. They use the following form: `projects/{project_number\}/locations/global/hubs/{hubid\}`
         */
        name?: string | null;
        /**
        ...
        /**
         * Output only. The route tables that belong to this hub. They use the following form: `projects/{project_number\}/locations/global/hubs/{hubid\}/routeTables/{route_tableid\}` This field is read-only. Network Connectivity Center automatically populates it based on the route tables nested under the hub.
         */
    ...
    export interface Schema$PolicyBasedRoute {
        ...
        /**
         * Immutable. A unique name of the resource in the form of `projects/{project_number\}/locations/global/PolicyBasedRoutes/{policy_based_routeid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Route {
        ...
        location?: string | null;
        /**
         * Immutable. The name of the route. Route names must be unique. Route names use the following form: `projects/{project_number\}/locations/global/hubs/{hub\}/routeTables/{route_tableid\}/routes/{routeid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$RouteTable {
        ...
        /**
         * Immutable. The name of the route table. Route table names must be unique. They use the following form: `projects/{project_number\}/locations/global/hubs/{hub\}/routeTables/{route_tableid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Spoke {
        ...
        /**
         * Immutable. The name of the spoke. Spoke names must be unique. They use the following form: `projects/{project_number\}/locations/{region\}/spokes/{spokeid\}`
         */
        name?: string | null;
        /**
