...
export declare namespace policysimulator_v1 {
    ...
    export interface Schema$GoogleCloudOrgpolicyV2CustomConstraint {
        ...
        /**
         * Immutable. Name of the constraint. This is unique within the organization. Format of the name should be * `organizations/{organizationid\}/customConstraints/{custom_constraintid\}` Example: `organizations/123/customConstraints/custom.createOnlyE2TypeVms` The max length is 70 characters and the minimum length is 1. Note that the prefix `organizations/{organizationid\}/customConstraints/` is not counted.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudOrgpolicyV2PolicySpecPolicyRule {
        ...
        /**
         * A condition which determines whether this rule is used in the evaluation of the policy. When set, the `expression` field in the `Expr' must include from 1 to 10 subexpressions, joined by the "||" or "&&" operators. Each subexpression must be of the form "resource.matchTag('/tag_key_short_name, 'tag_value_short_name')". or "resource.matchTagId('tagKeys/keyid', 'tagValues/valueid')". where key_name and value_name are the resource names for Label Keys and Values. These names are available from the Tag Manager Service. An example expression is: "resource.matchTag('123456789/environment, 'prod')". or "resource.matchTagId('tagKeys/123', 'tagValues/456')".
         */
    ...
    export interface Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview {
        ...
        /**
         * Output only. The names of the constraints against which all `OrgPolicyViolations` were evaluated. If `OrgPolicyOverlay` only contains `PolicyOverlay` then it contains the name of the configured custom constraint, applicable to the specified policies. Otherwise it contains the name of the constraint specified in `CustomConstraintOverlay`. Format: `organizations/{organizationid\}/customConstraints/{custom_constraintid\}` Example: `organizations/123/customConstraints/custom.createOnlyE2TypeVms`
         */
