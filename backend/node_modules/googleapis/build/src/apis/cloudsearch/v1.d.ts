...
export declare namespace cloudsearch_v1 {
    ...
    export interface Schema$DataSource {
        ...
        /**
         * The name of the datasource resource. Format: datasources/{sourceid\}. The name is ignored when creating a datasource.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$EnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata {
        /**
         * The drive document cosmo id. Client could use the id to build a URL to open a document. Please use Document.documentid.
         */
        documentId?: string | null;
        /**
    ...
    export interface Schema$EnterpriseTopazSidekickCommonPerson {
        ...
        /**
         * This field is deprecated. The obfuscatedid should be used instead.
         */
        gaiaId?: string | null;
        /**
         * The first name.
    ...
    export interface Schema$ItemMetadata {
        ...
        /**
         * The BCP-47 language code for the item, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier. The maximum length is 32 characters.
         */
    ...
    export interface Schema$PersonCore {
        ...
        /**
         * External ID of type "loginid" for the profile. For google.com this is the username/LDAP.
         */
    ...
    export interface Schema$RequestOptions {
        ...
        debugOptions?: Schema$DebugOptions;
        /**
         * The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier. For translations. Set this field using the language set in browser or for the page. In the event that the user's language preference is known, set this field to the known user language. When specified, the documents in search results are biased towards the specified language. The Suggest API uses this field as a hint to make better third-party autocomplete predictions.
         */
    ...
    export class Resource$Debug$Datasources$Items$Unmappedids {
         ...
         *     // The name of the item, in the following format: datasources/{sourceid\}/items/{ID\}
    ...
    export class Resource$Indexing$Datasources {
         ...
         *     // If you are asked by Google to help with debugging, set this field. Otherwise, ignore this field.
         *     'debugOptions.enableDebugging': 'placeholder-value',
         *     // The name of the data source to delete Schema. Format: datasources/{sourceid\}
         *     name: 'datasources/my-datasource',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // If you are asked by Google to help with debugging, set this field. Otherwise, ignore this field.
         *     'debugOptions.enableDebugging': 'placeholder-value',
         *     // The name of the data source to get Schema. Format: datasources/{sourceid\}
         *     name: 'datasources/my-datasource',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Indexing$Datasources$Items {
         ...
         *     // The name of the item to push into the indexing queue. Format: datasources/{sourceid\}/items/{ID\} This is a required field. The maximum length is 1536 characters.
         *     name: 'datasources/my-datasource/items/my-item',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // The name of the Data Source to unreserve all items. Format: datasources/{sourceid\}
         *     name: 'datasources/my-datasource',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Settings$Datasources {
         ...
         *     // If you are asked by Google to help with debugging, set this field. Otherwise, ignore this field.
         *     'debugOptions.enableDebugging': 'placeholder-value',
         *     // The name of the datasource. Format: datasources/{sourceid\}.
         *     name: 'datasources/my-datasource',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Settings$Searchapplications {
         ...
         *     // If you are asked by Google to help with debugging, set this field. Otherwise, ignore this field.
         *     'debugOptions.enableDebugging': 'placeholder-value',
         *     // The name of the search application to be deleted. Format: applications/{applicationid\}.
         ...
         *     // The name of the search application to be reset. Format: applications/{applicationid\}.
         *     name: 'searchapplications/my-searchapplication',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Stats$Query$Searchapplications {
         ...
         *     // Year of date. Must be from 1 to 9999.
         *     'fromDate.year': 'placeholder-value',
         *     // The resource id of the search application query stats, in the following format: searchapplications/{applicationid\}
         *     name: 'searchapplications/my-searchapplication',
         *     // Day of month. Must be from 1 to 31 and valid for the year and month.
         *     'toDate.day': 'placeholder-value',
         *     // Month of date. Must be from 1 to 12.
    ...
    export class Resource$Stats$Session$Searchapplications {
         ...
         *     // Year of date. Must be from 1 to 9999.
         *     'fromDate.year': 'placeholder-value',
         *     // The resource id of the search application session stats, in the following format: searchapplications/{applicationid\}
         *     name: 'searchapplications/my-searchapplication',
         *     // Day of month. Must be from 1 to 31 and valid for the year and month.
         *     'toDate.day': 'placeholder-value',
         *     // Month of date. Must be from 1 to 12.
