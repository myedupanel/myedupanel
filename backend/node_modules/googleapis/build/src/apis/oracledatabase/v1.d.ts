...
export declare namespace oracledatabase_v1 {
    ...
    export class Resource$Projects$Locations$Dbsystemshapes {
         ...
         *     // Optional. An expression for filtering the results of the request. Only the gcp_oracle_zoneid field is supported in this format: `gcp_oracle_zoneid="{gcp_oracle_zoneid\}"`.
         *     filter: 'placeholder-value',
    ...
    export class Resource$Projects$Locations$Giversions$Minorversions {
         ...
         *       // Optional. An expression for filtering the results of the request. Only shapeFamily and gcp_oracle_zoneid are supported in this format: `shape_family="{shapeFamily\}" AND gcp_oracle_zoneid="{gcp_oracle_zoneid\}"`.
         *       filter: 'placeholder-value',
