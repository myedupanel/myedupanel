...
export declare namespace chromepolicy_v1 {
    ...
    export interface Schema$GoogleChromePolicyVersionsV1DefineCertificateRequest {
        ...
        /**
         * Required. The target resource on which this certificate is applied. The following resources are supported: * Organizational Unit ("orgunits/{orgunitid\}")
         */
    ...
    export interface Schema$GoogleChromePolicyVersionsV1DefineNetworkRequest {
        ...
        settings?: Schema$GoogleChromePolicyVersionsV1NetworkSetting[];
        /**
         * Required. The target resource on which this new network will be defined. The following resources are supported: * Organizational Unit ("orgunits/{orgunitid\}")
         */
        targetResource?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleChromePolicyVersionsV1DefineNetworkResponse {
        ...
        settings?: Schema$GoogleChromePolicyVersionsV1NetworkSetting[];
        /**
         * The target resource on which this new network will be defined. The following resources are supported: * Organizational Unit ("orgunits/{orgunitid\}")
         */
        targetResource?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleChromePolicyVersionsV1PolicyTargetKey {
        ...
        /**
         * The target resource on which this policy is applied. The following resources are supported: * Organizational Unit ("orgunits/{orgunitid\}") * Group ("groups/{groupid\}")
         */
        targetResource?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleChromePolicyVersionsV1RemoveCertificateRequest {
        ...
        networkId?: string | null;
        /**
         * Required. The target resource on which this certificate will be removed. The following resources are supported: * Organizational Unit ("orgunits/{orgunitid\}")
         */
        targetResource?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleChromePolicyVersionsV1RemoveNetworkRequest {
        ...
        networkId?: string | null;
        /**
         * Required. The target resource on which this network will be removed. The following resources are supported: * Organizational Unit ("orgunits/{orgunitid\}")
         */
        targetResource?: string | null;
    }
    /**
