...
export declare namespace bigquery_v2 {
    ...
    export interface Schema$ArimaModelInfo {
        ...
        seasonalPeriods?: string[] | null;
        /**
         * The time_seriesid value for this time series. It will be one of the unique values from the time_seriesid_column specified during ARIMA model training. Only present when time_seriesid_column training option was used.
         */
        timeSeriesId?: string | null;
        /**
         * The tuple of time_seriesids identifying this time series. It will be one of the unique tuples of values present in the time_seriesid_columns specified during ARIMA model training. Only present when time_seriesid_columns training option was used and the order of values here are same as the order of time_seriesid_columns.
         */
    ...
    export interface Schema$DataPolicyOption {
        /**
         * Data policy resource name in the form of projects/projectid/locations/locationid/dataPolicies/data_policyid.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$ExternalCatalogTableOptions {
        /**
         * Optional. A connection ID that specifies the credentials to be used to read external storage, such as Azure Blob, Cloud Storage, or Amazon S3. This connection is needed to read the open source table from BigQuery. The connectionid format must be either `..` or `projects//locations//connections/`.
         */
        connectionId?: string | null;
        /**
    ...
    export interface Schema$ExternalDatasetReference {
        /**
         * Required. The connection id that is used to access the external_source. Format: projects/{projectid\}/locations/{locationid\}/connections/{connectionid\}
         */
    ...
    export interface Schema$GoogleSheetsOptions {
        /**
         * Optional. Range of a sheet to query from. Only used when non-empty. Typical format: sheet_name!top_left_cellid:bottom_right_cellid For example: sheet1!A1:B20
         */
        range?: string | null;
        /**
    ...
    export interface Schema$JobConfigurationLoad {
        ...
        /**
         * Optional. Connection properties which can modify the load job behavior. Currently, only the 'sessionid' connection property is supported, and is used to resolve _SESSION appearing as the dataset id.
         */
        ...
        /**
         * Optional. If this property is true, the job creates a new session using a randomly generated sessionid. To continue using a created session with subsequent queries, pass the existing session identifier as a `ConnectionProperty` value. The session identifier is returned as part of the `SessionInfo` message within the query statistics. The new session's location will be set to `Job.JobReference.location` if it is present, otherwise it's set to the default location based on existing routing logic.
         */
    ...
    export interface Schema$JobConfigurationQuery {
        ...
        createSession?: boolean | null;
        /**
         * Optional. Specifies the default dataset to use for unqualified table names in the query. This setting does not alter behavior of unqualified dataset names. Setting the system variable `@@datasetid` achieves the same behavior. See https://cloud.google.com/bigquery/docs/reference/system-variables for more information on system variables.
         */
    ...
    export interface Schema$ListRoutinesResponse {
        ...
        nextPageToken?: string | null;
        /**
         * Routines in the requested dataset. Unless read_mask is set in the request, only the following fields are populated: etag, projectid, datasetid, routineid, routine_type, creation_time, last_modified_time, language, and remote_function_options.
         */
    ...
    export interface Schema$TrainingOptions {
        ...
        /**
         * The name of a Vertex model garden publisher model. Format is `publishers/{publisher\}/models/{model\}@{optional_versionid\}`.
         */
    ...
    export class Resource$Routines {
         ...
         *     projectId: '[^/]+',
         *     // If set, then only the Routine fields in the field mask, as well as projectid, datasetid and routineid, are returned in the response. If unset, then the following Routine fields are returned: etag, projectid, datasetid, routineid, routine_type, creation_time, last_modified_time, and language.
         *     readMask: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
