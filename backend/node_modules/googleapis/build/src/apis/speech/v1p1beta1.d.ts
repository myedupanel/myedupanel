...
export declare namespace speech_v1p1beta1 {
    ...
    export interface Schema$CustomClass {
        ...
        /**
         * If this custom class is a resource, the custom_classid is the resource id of the CustomClass. Case sensitive.
         */
        customClassId?: string | null;
        /**
    ...
    export interface Schema$SpeechAdaptation {
        ...
        /**
         * A collection of custom classes. To specify the classes inline, leave the class' `name` blank and fill in the rest of its fields, giving it a unique `custom_classid`. Refer to the inline defined class in phrase hints by its `custom_classid`.
         */
        customClasses?: Schema$CustomClass[];
        /**
