...
export declare namespace accessapproval_v1beta1 {
    ...
    export interface Schema$AccessApprovalSettings {
        ...
        /**
         * The resource name of the settings. Format is one of: &lt;ol&gt;   &lt;li&gt;&quot;projects/{projectid}/accessApprovalSettings&quot;&lt;/li&gt;   &lt;li&gt;&quot;folders/{folderid}/accessApprovalSettings&quot;&lt;/li&gt;   &lt;li&gt;&quot;organizations/{organizationid}/accessApprovalSettings&quot;&lt;/li&gt; &lt;ol&gt;
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ApprovalRequest {
        ...
        /**
         * The resource name of the request. Format is &quot;{projects|folders|organizations}/{id}/approvalRequests/{approval_requestid}&quot;.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Folders {
         ...
         *     // <ol>
         *     //   <li>"projects/{projectid}/accessApprovalSettings"</li>
         *     //   <li>"folders/{folderid}/accessApprovalSettings"</li>
         *     //   <li>"organizations/{organizationid}/accessApprovalSettings"</li>
         *     // <ol>
         *     name: 'folders/my-folder/accessApprovalSettings',
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name The resource name of the settings. Format is one of: <ol>   <li>"projects/{projectid}/accessApprovalSettings"</li>   <li>"folders/{folderid}/accessApprovalSettings"</li>   <li>"organizations/{organizationid}/accessApprovalSettings"</li> <ol>
    ...
    export class Resource$Folders$Approvalrequests {
         ...
         *     // The parent resource. This may be "projects/{projectid}",
         ...
         * @param {string} params.parent The parent resource. This may be "projects/{projectid}", "folders/{folderid}", or "organizations/{organizationid}".
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    export interface Params$Resource$Folders$Approvalrequests$List extends StandardParameters {
        ...
        pageToken?: string;
        /**
         * The parent resource. This may be "projects/{projectid}", "folders/{folderid}", or "organizations/{organizationid}".
         */
        parent?: string;
    }
