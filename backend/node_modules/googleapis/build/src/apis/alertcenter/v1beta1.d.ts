...
export declare namespace alertcenter_v1beta1 {
    ...
    export interface Schema$AbuseDetected {
        ...
        /**
         * Variation of AbuseDetected alerts. The variation_type determines the texts displayed the alert details. This differs from sub_alertid because each sub alert can have multiple variation_types, representing different stages of the alert.
         */
    ...
    export interface Schema$BatchDeleteAlertsRequest {
        ...
        alertId?: string[] | null;
        /**
         * Optional. The unique identifier of the Google Workspace account of the customer the alerts are associated with. The `customerid` must have the initial "C" stripped (for example, `046psxkn`). Inferred from the caller identity if not provided. [Find your customer ID](https://support.google.com/cloudidentity/answer/10070793).
         */
        customerId?: string | null;
    }
    /**
    ...
    export interface Schema$BatchDeleteAlertsResponse {
        /**
         * The status details for each failed `alertid`.
         */
        failedAlertStatus?: {
    ...
    export interface Schema$ReportingRule {
        ...
        name?: string | null;
        /**
         * Alert Rule query Sample Query query { condition { filter { expected_applicationid: 777491262838 expected_event_name: "indexable_content_change" filter_op: IN \} \} conjunction_operator: OR \}
         */
        query?: string | null;
    }
    /**
    ...
    export class Resource$V1beta1 {
         ...
         *     // Optional. The unique identifier of the Google Workspace account of the customer the alert settings are associated with. The `customerid` must/ have the initial "C" stripped (for example, `046psxkn`). Inferred from the caller identity if not provided. [Find your customer ID](https://support.google.com/cloudidentity/answer/10070793).
         *     customerId: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
