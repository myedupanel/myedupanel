...
export declare namespace healthcare_v1 {
    ...
    export interface Schema$ConsentStore {
        ...
        /**
         * Identifier. Resource name of the consent store, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}`. Cannot be changed after creation.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$DeidentifiedStoreDestination {
        ...
        /**
         * Optional. The full resource name of a Cloud Healthcare FHIR store, for example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        store?: string | null;
    }
    /**
    ...
    export interface Schema$Message {
        ...
        messageType?: string | null;
        /**
         * Output only. Resource name of the Message, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/hl7V2Stores/{hl7_v2_storeid\}/messages/{messageid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$RollbackHl7V2MessagesResponse {
        /**
         * The name of the HL7v2 store to rollback, in the format of "projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\} /hl7v2Stores/{hl7v2_storeid\}".
         */
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Listrevisions extends StandardParameters {
        /**
         * Optional. Restricts the revisions returned to those matching a filter. The following syntax is available: * A string field value can be written as text inside quotation marks, for example `"query text"`. The only valid relational operation for text fields is equality (`=`), where text is searched within the field, rather than having the field be equal to the text. For example, `"Comment = great"` returns messages with `great` in the comment field. * A number field value can be written as an integer, a decimal, or an exponential. The valid relational operators for number fields are the equality operator (`=`), along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * A date field value must be written in `yyyy-mm-dd` form. Fields with date and time use the RFC3339 time format. Leading zeros are required for one-digit months and days. The valid relational operators for date fields are the equality operator (`=`) , along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * Multiple field query expressions can be combined in one query by adding `AND` or `OR` operators between the expressions. If a boolean operator appears within a quoted string, it is not treated as special, it's just another part of the character string to be matched. You can prepend the `NOT` operator to an expression to negate it. Fields available for filtering are: - userid. For example, `filter='userid="user123"'`. - consent_artifact - state - revision_create_time - metadata. For example, `filter=Metadata(\"testkey\")=\"value\"` or `filter=HasMetadata(\"testkey\")`.
         */
        filter?: string;
        /**
