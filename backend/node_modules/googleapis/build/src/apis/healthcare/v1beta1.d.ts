...
export declare namespace healthcare_v1beta1 {
    ...
    export interface Schema$ActivateConsentRequest {
        /**
         * Required. The resource name of the Consent artifact that contains documentation of the user's consent, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consentArtifacts/{consent_artifactid\}`. If the draft Consent had a Consent artifact, this Consent artifact overwrites it.
         */
    ...
    export interface Schema$AdminConsents {
        /**
         * The versioned names of the admin Consent resource(s), in the format `projects/{projectid\}/locations/{location\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Consent/{resourceid\}/_history/{versionid\}`. For FHIR stores with `disable_resource_versioning=true`, the format is `projects/{projectid\}/locations/{location\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Consent/{resourceid\}`.
         */
        names?: string[] | null;
    }
    /**
    ...
    export interface Schema$Annotation {
        ...
        /**
         * Identifier. Resource name of the Annotation, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/annotationStores/{annotation_storeid\}/annotations/{annotationid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$AnnotationConfig {
        /**
         * The name of the annotation store, in the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/annotationStores/{annotation_storeid\}`). * The destination annotation store must be in the same project as the source data. De-identifying data across multiple projects is not supported. * The destination annotation store must exist when using DeidentifyDicomStore or DeidentifyFhirStore. DeidentifyDataset automatically creates the destination annotation store.
         */
    ...
    export interface Schema$AnnotationStore {
        ...
        /**
         * Identifier. Resource name of the Annotation store, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/annotationStores/{annotation_storeid\}`.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$AttributeDefinition {
        ...
        /**
         * Identifier. Resource name of the Attribute definition, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/attributeDefinitions/{attribute_definitionid\}`. Cannot be changed after creation.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$Binding {
        ...
        /**
         * Specifies the principals requesting access for a Google Cloud resource. `members` can have the following values: * `allUsers`: A special identifier that represents anyone who is on the internet; with or without a Google account. * `allAuthenticatedUsers`: A special identifier that represents anyone who is authenticated with a Google account or a service account. Does not include identities that come from external identity providers (IdPs) through identity federation. * `user:{emailid\}`: An email address that represents a specific Google account. For example, `alice@example.com` . * `serviceAccount:{emailid\}`: An email address that represents a Google service account. For example, `my-other-app@appspot.gserviceaccount.com`. * `serviceAccount:{projectid\}.svc.id.goog[{namespace\}/{kubernetes-sa\}]`: An identifier for a [Kubernetes service account](https://cloud.google.com/kubernetes-engine/docs/how-to/kubernetes-service-accounts). For example, `my-project.svc.id.goog[my-namespace/my-kubernetes-sa]`. * `group:{emailid\}`: An email address that represents a Google group. For example, `admins@example.com`. * `domain:{domain\}`: The G Suite domain (primary) that represents all the users of that domain. For example, `google.com` or `example.com`. * `principal://iam.googleapis.com/locations/global/workforcePools/{poolid\}/subject/{subject_attribute_value\}`: A single identity in a workforce identity pool. * `principalSet://iam.googleapis.com/locations/global/workforcePools/{poolid\}/group/{groupid\}`: All workforce identities in a group. * `principalSet://iam.googleapis.com/locations/global/workforcePools/{poolid\}/attribute.{attribute_name\}/{attribute_value\}`: All workforce identities with a specific attribute value. * `principalSet://iam.googleapis.com/locations/global/workforcePools/{poolid\}/x`: All identities in a workforce identity pool. * `principal://iam.googleapis.com/projects/{project_number\}/locations/global/workloadIdentityPools/{poolid\}/subject/{subject_attribute_value\}`: A single identity in a workload identity pool. * `principalSet://iam.googleapis.com/projects/{project_number\}/locations/global/workloadIdentityPools/{poolid\}/group/{groupid\}`: A workload identity pool group. * `principalSet://iam.googleapis.com/projects/{project_number\}/locations/global/workloadIdentityPools/{poolid\}/attribute.{attribute_name\}/{attribute_value\}`: All identities in a workload identity pool with a certain attribute. * `principalSet://iam.googleapis.com/projects/{project_number\}/locations/global/workloadIdentityPools/{poolid\}/x`: All identities in a workload identity pool. * `deleted:user:{emailid\}?uid={uniqueid\}`: An email address (plus unique identifier) representing a user that has been recently deleted. For example, `alice@example.com?uid=123456789012345678901`. If the user is recovered, this value reverts to `user:{emailid\}` and the recovered user retains the role in the binding. * `deleted:serviceAccount:{emailid\}?uid={uniqueid\}`: An email address (plus unique identifier) representing a service account that has been recently deleted. For example, `my-other-app@appspot.gserviceaccount.com?uid=123456789012345678901`. If the service account is undeleted, this value reverts to `serviceAccount:{emailid\}` and the undeleted service account retains the role in the binding. * `deleted:group:{emailid\}?uid={uniqueid\}`: An email address (plus unique identifier) representing a Google group that has been recently deleted. For example, `admins@example.com?uid=123456789012345678901`. If the group is recovered, this value reverts to `group:{emailid\}` and the recovered group retains the role in the binding. * `deleted:principal://iam.googleapis.com/locations/global/workforcePools/{poolid\}/subject/{subject_attribute_value\}`: Deleted single identity in a workforce identity pool. For example, `deleted:principal://iam.googleapis.com/locations/global/workforcePools/my-pool-id/subject/my-subject-attribute-value`.
         */
        members?: string[] | null;
        /**
    ...
    export interface Schema$CheckDataAccessRequest {
        /**
         * Optional. Specific Consents to evaluate the access request against. These Consents must have the same `userid` as the evaluated User data mapping, must exist in the current `consent_store`, and have a `state` of either `ACTIVE` or `DRAFT`. A maximum of 100 Consents can be provided here. If no selection is specified, the access request is evaluated against all `ACTIVE` unexpired Consents with the same `userid` as the evaluated User data mapping.
         */
    ...
    export interface Schema$Consent {
        /**
         * Required. The resource name of the Consent artifact that contains proof of the end user's consent, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consentArtifacts/{consent_artifactid\}`.
         */
        consentArtifact?: string | null;
        /**
         * Timestamp in UTC of when this Consent is considered expired.
        ...
        /**
         * Identifier. Resource name of the Consent, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}`. Cannot be changed after creation.
         */
        name?: string | null;
        /**
        ...
        /**
         * Output only. The revision ID of the Consent. The format is an 8-character hexadecimal string. Refer to a specific revision of a Consent by appending `@{revisionid\}` to the Consent's resource name.
         */
    ...
    export interface Schema$ConsentArtifact {
        ...
        /**
         * Identifier. Resource name of the Consent artifact, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consentArtifacts/{consent_artifactid\}`. Cannot be changed after creation.
         */
        name?: string | null;
        /**
         * Required. User's UUID provided by the client.
    ...
    export interface Schema$ConsentConfig {
        ...
        /**
         * Output only. The versioned names of the enforced admin Consent resource(s), in the format `projects/{projectid\}/locations/{location\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Consent/{resourceid\}/_history/{versionid\}`. For FHIR stores with `disable_resource_versioning=true`, the format is `projects/{projectid\}/locations/{location\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Consent/{resourceid\}`. This field can only be updated using ApplyAdminConsents.
         */
    ...
    export interface Schema$ConsentList {
        /**
         * The resource names of the Consents to evaluate against, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}`.
         */
    ...
    export interface Schema$ConsentStore {
        ...
        /**
         * Resource name of the consent store, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}`. Cannot be changed after creation.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$DeidentifiedStoreDestination {
        ...
        /**
         * The full resource name of a Cloud Healthcare FHIR store, for example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        store?: string | null;
    }
    /**
    ...
    export interface Schema$DeidentifyDatasetRequest {
        ...
        /**
         * Cloud Storage location to read the JSON cloud.healthcare.deidentify.DeidentifyConfig from, overriding the default config. Must be of the form `gs://{bucketid\}/path/to/object`. The Cloud Storage location must grant the Cloud IAM role `roles/storage.objectViewer` to the project's Cloud Healthcare Service Agent service account. Only one of `config` and `gcs_config_uri` can be specified.
         */
    ...
    export interface Schema$DeidentifyDicomStoreRequest {
        ...
        config?: Schema$DeidentifyConfig;
        /**
         * Required. The name of the DICOM store to create and write the redacted data to. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}`. * The destination dataset must exist. * The source dataset and destination dataset must both reside in the same location. De-identifying data across multiple locations is not supported. * The destination DICOM store must not exist. * The caller must have the necessary permissions to create the destination DICOM store.
         */
    ...
    export interface Schema$DeidentifyFhirStoreRequest {
        ...
        config?: Schema$DeidentifyConfig;
        /**
         * Required. The name of the FHIR store to create and write the redacted data to. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`. * The destination dataset must exist. * The source dataset and destination dataset must both reside in the same location. De-identifying data across multiple locations is not supported. * The destination FHIR store must exist. * The caller must have the healthcare.fhirResources.update permission to write to the destination FHIR store.
         */
        destinationStore?: string | null;
        /**
         * Cloud Storage location to read the JSON cloud.healthcare.deidentify.DeidentifyConfig from, overriding the default config. Must be of the form `gs://{bucketid\}/path/to/object`. The Cloud Storage location must grant the Cloud IAM role `roles/storage.objectViewer` to the project's Cloud Healthcare Service Agent service account. Only one of `config` and `gcs_config_uri` can be specified.
    ...
    export interface Schema$DicomStore {
        ...
        /**
         * Identifier. Resource name of the DICOM store, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$DicomStoreMetrics {
        ...
        /**
         * Resource name of the DICOM store, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$EvaluateAnnotationStoreRequest {
        ...
        /**
         * Required. The Annotation store to use as ground truth, in the format of `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/annotationStores/{annotation_storeid\}`.
         */
    ...
    export interface Schema$ExplainDataAccessConsentInfo {
        /**
         * The compartment base resources that matched a cascading policy. Each resource has the following format: `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/{resource_type\}/{resourceid\}`
         */
        cascadeOrigins?: string[] | null;
        /**
         * The resource name of this consent resource, in the format: `projects/{projectid\}/locations/{location\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Consent/{resourceid\}`.
         */
        ...
        /**
         * The patient owning the consent (only applicable for patient consents), in the format: `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Patient/{patientid\}`
         */
    ...
    export interface Schema$FhirStore {
        ...
        /**
         * Output only. Identifier. Resource name of the FHIR store, of the form `projects/{projectid\}/locations/{location\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$FhirStoreMetrics {
        ...
        /**
         * The resource name of the FHIR store to get metrics for, in the format `projects/{projectid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$Hl7V2Store {
        ...
        /**
         * Identifier. Resource name of the HL7v2 store, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/hl7V2Stores/{hl7v2_storeid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Hl7V2StoreMetrics {
        ...
        /**
         * The resource name of the HL7v2 store to get metrics for, in the format `projects/{projectid\}/datasets/{datasetid\}/hl7V2Stores/{hl7v2_storeid\}`.
         */
        name?: string | null;
    }
    /**
     * Message that represents an arbitrary HTTP body. It should only be used for payload formats that can't be represented as JSON, such as raw binary or an HTML page. This message can be used both in streaming and non-streaming API methods in the request as well as the response. It can be used as a top-level request field, which is convenient if one wants to extract parameters from either the URL or HTTP template into the request fields and also want access to the raw HTTP body. Example: message GetResourceRequest { // A unique request id. string requestid = 1; // The raw HTTP body is bound to this field. google.api.HttpBody http_body = 2; \} service ResourceService { rpc GetResource(GetResourceRequest) returns (google.api.HttpBody); rpc UpdateResource(google.api.HttpBody) returns (google.protobuf.Empty); \} Example with streaming methods: service CaldavService { rpc GetCalendar(stream google.api.HttpBody) returns (stream google.api.HttpBody); rpc UpdateCalendar(stream google.api.HttpBody) returns (stream google.api.HttpBody); \} Use of this type only changes how the request and response bodies are handled, all other features will continue to work unchanged.
     */
    ...
    export interface Schema$Message {
        ...
        messageType?: string | null;
        /**
         * Output only. Resource name of the Message, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/hl7V2Stores/{hl7_v2_storeid\}/messages/{messageid\}`. Assigned by the server.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$QueryAccessibleDataResponse {
        /**
         * List of files, each of which contains a list of dataid(s) that are consented for a specified use in the request.
         */
        gcsUris?: string[] | null;
    }
    /**
    ...
    export interface Schema$RejectConsentRequest {
        /**
         * Optional. The resource name of the Consent artifact that contains documentation of the user's rejection of the draft Consent, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consentArtifacts/{consent_artifactid\}`. If the draft Consent had a Consent artifact, this Consent artifact overwrites it.
         */
        consentArtifact?: string | null;
    }
    /**
    ...
    export interface Schema$RevokeConsentRequest {
        /**
         * Optional. The resource name of the Consent artifact that contains proof of the user's revocation of the Consent, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consentArtifacts/{consent_artifactid\}`.
         */
        consentArtifact?: string | null;
    }
    /**
    ...
    export interface Schema$RollbackFhirResourcesResponse {
        /**
         * The name of the FHIR store to rollback, in the format of "projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\} /fhirStores/{fhir_storeid\}".
         */
        fhirStore?: string | null;
    }
    /**
    ...
    export interface Schema$RollbackHl7V2MessagesResponse {
        /**
         * The name of the HL7v2 store to rollback, in the format of "projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\} /hl7v2Stores/{fhir_storeid\}".
         */
    ...
    export interface Schema$SeriesMetrics {
        ...
        instanceCount?: string | null;
        /**
         * The series resource path. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}/dicomWeb/studies/{study_uid\}/series/{series_uid\}`.
         */
        series?: string | null;
        /**
    ...
    export interface Schema$StudyMetrics {
        ...
        structuredStorageSizeBytes?: string | null;
        /**
         * The study resource path. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}/dicomWeb/studies/{study_uid\}`.
         */
        study?: string | null;
    }
    /**
    ...
    export interface Schema$UserDataMapping {
        ...
        dataId?: string | null;
        /**
         * Resource name of the User data mapping, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/userDataMappings/{user_data_mappingid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Delete extends StandardParameters {
        /**
         * Required. The name of the dataset to delete. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}`.
         */
        name?: string;
    }
    export interface Params$Resource$Projects$Locations$Datasets$Get extends StandardParameters {
        /**
         * Required. The name of the dataset to read. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}`.
         */
        name?: string;
    }
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Annotationstores$Evaluate extends StandardParameters {
        /**
         * Required. The Annotation store to compare against `golden_store`, in the format of `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/annotationStores/{annotation_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Annotationstores$Export extends StandardParameters {
        /**
         * Required. The name of the Annotation store to export annotations to, in the format of `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/annotationStores/{annotation_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Annotationstores$Import extends StandardParameters {
        /**
         * Required. The name of the Annotation store to which the server imports annotations, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/annotationStores/{annotation_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export class Resource$Projects$Locations$Datasets$Consentstores {
        ...
        /**
         * Queries all dataids that are consented for a specified use in the given consent store and writes them to a specified destination. The returned Operation includes a progress counter for the number of User data mappings processed. If the request is successful, a detailed response is returned of type QueryAccessibleDataResponse, contained in the response field when the operation finishes. The metadata field type is OperationMetadata. Errors are logged to Cloud Logging (see [Viewing error logs in Cloud Logging](https://cloud.google.com/healthcare/docs/how-tos/logging)). For example, the following sample log entry shows a `failed to evaluate consent policy` error that occurred during a QueryAccessibleData call to consent store `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}`. ```json jsonPayload: { @type: "type.googleapis.com/google.cloud.healthcare.logging.QueryAccessibleDataLogEntry" error: { code: 9 message: "failed to evaluate consent policy" \} resourceName: "projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}" \} logName: "projects/{projectid\}/logs/healthcare.googleapis.com%2Fquery_accessible_data" operation: { id: "projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/operations/{operationid\}" producer: "healthcare.googleapis.com/QueryAccessibleData" \} receiveTimestamp: "TIMESTAMP" resource: { labels: { consent_storeid: "{consent_storeid\}" datasetid: "{datasetid\}" location: "{locationid\}" projectid: "{projectid\}" \} type: "healthcare_consent_store" \} severity: "ERROR" timestamp: "TIMESTAMP" ```
         *
         * @param params - Parameters for request
         * @param options - Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param callback - Optional callback that handles the response.
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Checkdataaccess extends StandardParameters {
        /**
         * Required. Name of the consent store where the requested dataid is stored, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}`.
         */
        consentStore?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consentartifacts$List extends StandardParameters {
        /**
         * Optional. Restricts the artifacts returned to those matching a filter. The following syntax is available: * A string field value can be written as text inside quotation marks, for example `"query text"`. The only valid relational operation for text fields is equality (`=`), where text is searched within the field, rather than having the field be equal to the text. For example, `"Comment = great"` returns messages with `great` in the comment field. * A number field value can be written as an integer, a decimal, or an exponential. The valid relational operators for number fields are the equality operator (`=`), along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * A date field value must be written in `yyyy-mm-dd` form. Fields with date and time use the RFC3339 time format. Leading zeros are required for one-digit months and days. The valid relational operators for date fields are the equality operator (`=`) , along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * Multiple field query expressions can be combined in one query by adding `AND` or `OR` operators between the expressions. If a boolean operator appears within a quoted string, it is not treated as special, it's just another part of the character string to be matched. You can prepend the `NOT` operator to an expression to negate it. The fields available for filtering are: - userid. For example, `filter=userid=\"user123\"`. - consent_content_version - metadata. For example, `filter=Metadata(\"testkey\")=\"value\"` or `filter=HasMetadata(\"testkey\")`.
         */
        filter?: string;
        /**
    ...
    export class Resource$Projects$Locations$Datasets$Consentstores$Consents {
        ...
        /**
         * Gets the specified revision of a Consent, or the latest revision if `revisionid` is not specified in the resource name.
         *
         * @param params - Parameters for request
         * @param options - Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param callback - Optional callback that handles the response.
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Activate extends StandardParameters {
        /**
         * Required. The resource name of the Consent to activate, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}`. An INVALID_ARGUMENT error occurs if `revisionid` is specified in the name.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Delete extends StandardParameters {
        /**
         * Required. The resource name of the Consent to delete, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}`. An INVALID_ARGUMENT error occurs if `revisionid` is specified in the name.
         */
        name?: string;
    }
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Deleterevision extends StandardParameters {
        /**
         * Required. The resource name of the Consent revision to delete, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}@{revisionid\}`. An INVALID_ARGUMENT error occurs if `revisionid` is not specified in the name.
         */
        name?: string;
    }
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Get extends StandardParameters {
        /**
         * Required. The resource name of the Consent to retrieve, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}`. In order to retrieve a previous revision of the Consent, also provide the revision ID: `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}@{revisionid\}`
         */
        name?: string;
    }
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$List extends StandardParameters {
        /**
         * Optional. Restricts the consents returned to those matching a filter. The following syntax is available: * A string field value can be written as text inside quotation marks, for example `"query text"`. The only valid relational operation for text fields is equality (`=`), where text is searched within the field, rather than having the field be equal to the text. For example, `"Comment = great"` returns messages with `great` in the comment field. * A number field value can be written as an integer, a decimal, or an exponential. The valid relational operators for number fields are the equality operator (`=`), along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * A date field value must be written in `yyyy-mm-dd` form. Fields with date and time use the RFC3339 time format. Leading zeros are required for one-digit months and days. The valid relational operators for date fields are the equality operator (`=`) , along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * Multiple field query expressions can be combined in one query by adding `AND` or `OR` operators between the expressions. If a boolean operator appears within a quoted string, it is not treated as special, it's just another part of the character string to be matched. You can prepend the `NOT` operator to an expression to negate it. The fields available for filtering are: - userid. For example, `filter='userid="user123"'`. - consent_artifact - state - revision_create_time - metadata. For example, `filter=Metadata(\"testkey\")=\"value\"` or `filter=HasMetadata(\"testkey\")`.
         */
        filter?: string;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Listrevisions extends StandardParameters {
        /**
         * Optional. Restricts the revisions returned to those matching a filter. The following syntax is available: * A string field value can be written as text inside quotation marks, for example `"query text"`. The only valid relational operation for text fields is equality (`=`), where text is searched within the field, rather than having the field be equal to the text. For example, `"Comment = great"` returns messages with `great` in the comment field. * A number field value can be written as an integer, a decimal, or an exponential. The valid relational operators for number fields are the equality operator (`=`), along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * A date field value must be written in `yyyy-mm-dd` form. Fields with date and time use the RFC3339 time format. Leading zeros are required for one-digit months and days. The valid relational operators for date fields are the equality operator (`=`) , along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * Multiple field query expressions can be combined in one query by adding `AND` or `OR` operators between the expressions. If a boolean operator appears within a quoted string, it is not treated as special, it's just another part of the character string to be matched. You can prepend the `NOT` operator to an expression to negate it. Fields/functions available for filtering are: - userid. For example, `filter='userid="user123"'`. - consent_artifact - state - revision_create_time - metadata. For example, `filter=Metadata(\"testkey\")=\"value\"` or `filter=HasMetadata(\"testkey\")`.
         */
        filter?: string;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Patch extends StandardParameters {
        ...
        name?: string;
        /**
         * Required. The update mask to apply to the resource. For the `FieldMask` definition, see https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask. Only the `userid`, `policies`, `consent_artifact`, and `metadata` fields can be updated.
         */
        updateMask?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Reject extends StandardParameters {
        /**
         * Required. The resource name of the Consent to reject, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}`. An INVALID_ARGUMENT error occurs if `revisionid` is specified in the name.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Consents$Revoke extends StandardParameters {
        /**
         * Required. The resource name of the Consent to revoke, of the form `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/consentStores/{consent_storeid\}/consents/{consentid\}`. An INVALID_ARGUMENT error occurs if `revisionid` is specified in the name.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Userdatamappings$List extends StandardParameters {
        /**
         * Optional. Restricts the user data mappings returned to those matching a filter. The following syntax is available: * A string field value can be written as text inside quotation marks, for example `"query text"`. The only valid relational operation for text fields is equality (`=`), where text is searched within the field, rather than having the field be equal to the text. For example, `"Comment = great"` returns messages with `great` in the comment field. * A number field value can be written as an integer, a decimal, or an exponential. The valid relational operators for number fields are the equality operator (`=`), along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * A date field value must be written in `yyyy-mm-dd` form. Fields with date and time use the RFC3339 time format. Leading zeros are required for one-digit months and days. The valid relational operators for date fields are the equality operator (`=`) , along with the less than/greater than operators (`<`, `<=`, `\>`, `\>=`). Note that there is no inequality (`!=`) operator. You can prepend the `NOT` operator to an expression to negate it. * Multiple field query expressions can be combined in one query by adding `AND` or `OR` operators between the expressions. If a boolean operator appears within a quoted string, it is not treated as special, it's just another part of the character string to be matched. You can prepend the `NOT` operator to an expression to negate it. The fields available for filtering are: - dataid - userid. For example, `filter=userid=\"user123\"`. - archived - archive_time
         */
        filter?: string;
        /**
         * Optional. Limit on the number of User data mappings to return in a single response. If not specified, 100 is used. May not be larger than 1000.
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Consentstores$Userdatamappings$Patch extends StandardParameters {
        ...
        name?: string;
        /**
         * Required. The update mask that applies to the resource. For the `FieldMask` definition, see https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask. Only the `dataid`, `userid` and `resource_attributes` fields can be updated.
         */
        updateMask?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Dicomstores$Deidentify extends StandardParameters {
        /**
         * Required. Source DICOM store resource name. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}`.
         */
        sourceStore?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Dicomstores$Export extends StandardParameters {
        /**
         * Required. The DICOM store resource name from which to export the data. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Dicomstores$Import extends StandardParameters {
        /**
         * Required. The name of the DICOM store resource into which the data is imported. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Dicomstores$Searchforinstances extends StandardParameters {
        ...
        dicomWebPath?: string;
        /**
         * Required. The name of the DICOM store that is being accessed. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}`.
         */
        parent?: string;
    }
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Getstudymetrics extends StandardParameters {
        /**
         * Required. The study resource path. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}/dicomWeb/studies/{study_uid\}`.
         */
        study?: string;
    }
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Dicomstores$Dicomweb$Studies$Series$Getseriesmetrics extends StandardParameters {
        /**
         * Required. The series resource path. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/dicomStores/{dicom_storeid\}/dicomWeb/studies/{study_uid\}/series/{series_uid\}`.
         */
        series?: string;
    }
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Applyadminconsents extends StandardParameters {
        /**
         * Required. The name of the FHIR store to enforce, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Bulkexportgroup extends StandardParameters {
        /**
         * Required. Name of the `Group` resource that is exported, in format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Group/{groupid\}`.
         */
        name?: string;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Configuresearch extends StandardParameters {
        /**
         * Required. The name of the FHIR store to configure, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Deidentify extends StandardParameters {
        /**
         * Required. Source FHIR store resource name. For example, `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        sourceStore?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Export extends StandardParameters {
        /**
         * Required. The name of the FHIR store to export resource from, in the format of `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Exporthistory extends StandardParameters {
        /**
         * Required. The name of the FHIR store to export resource from, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Import extends StandardParameters {
        /**
         * Required. The name of the FHIR store to import FHIR resources to, in the format of `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Rollback extends StandardParameters {
        /**
         * Required. The name of the FHIR store to rollback, in the format of "projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\} /fhirStores/{fhir_storeid\}".
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Bulkexport extends StandardParameters {
        /**
         * Required. The name of the FHIR store to export resources from, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}`.
         */
        name?: string;
        /**
         * Optional. Output format of the export. This field is optional and only `application/fhir+ndjson` is supported.
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Consentenforcementstatus extends StandardParameters {
        /**
         * Required. The name of the consent resource to find enforcement status, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Consent/{consentid\}`
         */
        name?: string;
    }
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Patientconsentenforcementstatus extends StandardParameters {
        /**
         * Required. The name of the patient to find enforcement statuses, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/fhir/Patient/{patientid\}`
         */
        name?: string;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Operations$Deletefhiroperation extends StandardParameters {
        /**
         * Required. Name of the operation to be deleted, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/operations/{operationid\}`.
         */
        name?: string;
    }
    export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Operations$Getfhiroperationstatus extends StandardParameters {
        /**
         * Required. Name of the operation to query, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/fhirStores/{fhir_storeid\}/operations/{operationid\}`.
         */
        name?: string;
    }
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Hl7v2stores$Export extends StandardParameters {
        /**
         * Required. The name of the source HL7v2 store, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/hl7v2Stores/{hl7v2_storeid\}`
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Hl7v2stores$Gethl7v2storemetrics extends StandardParameters {
        /**
         * Required. The resource name of the HL7v2 store to get metrics for, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/hl7V2Stores/{hl7v2_storeid\}`.
         */
        name?: string;
    }
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Hl7v2stores$Import extends StandardParameters {
        /**
         * Required. The name of the target HL7v2 store, in the format `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/hl7v2Stores/{hl7v2_storeid\}`
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Hl7v2stores$Rollback extends StandardParameters {
        /**
         * Required. The name of the HL7v2 store to rollback, in the format of "projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\} /hl7V2Stores/{hl7v2_storeid\}".
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Projects$Locations$Datasets$Hl7v2stores$Messages$Batchget extends StandardParameters {
        /**
         * The resource id of the HL7v2 messages to retrieve in the format: `{messageid\}`, where the full resource name is `{parent\}/messages/{messageid\}` A maximum of 100 messages can be retrieved in a batch. All 'ids' have to be under parent.
         */
        ids?: string[];
        /**
         * Required. Name of the HL7v2 store to retrieve messages from, in the format: `projects/{projectid\}/locations/{locationid\}/datasets/{datasetid\}/hl7v2Stores/{hl7v2_storeid\}`.
         */
        parent?: string;
        /**
