...
export declare namespace alloydb_v1alpha {
    ...
    export interface Schema$BackupDrBackupSource {
        /**
         * Required. The name of the backup resource with the format: * projects/{project\}/locations/{location\}/backupVaults/{backupvaultid\}/dataSources/{datasourceid\}/backups/{backupid\}
         */
        backup?: string | null;
    }
    /**
    ...
    export interface Schema$BackupDrPitrSource {
        /**
         * Required. The name of the backup resource with the format: * projects/{project\}/locations/{location\}/backupVaults/{backupvaultid\}/dataSources/{datasourceid\}
         */
        dataSource?: string | null;
        /**
    ...
    export interface Schema$Cluster {
        ...
        name?: string | null;
        /**
         * Required. The resource link for the VPC network in which cluster resources are created and from which they are accessible via Private IP. The network must belong to the same project as the cluster. It is specified in the form: `projects/{project\}/global/networks/{networkid\}`. This is required to create a cluster. Deprecated, use network_config.network instead.
         */
        network?: string | null;
    ...
    export interface Schema$InstanceNetworkConfig {
        ...
        /**
         * Output only. The resource link for the VPC network in which instance resources are created and from which they are accessible via Private IP. This will be the same value as the parent cluster's network. It is specified in the form: // `projects/{project_number\}/global/networks/{networkid\}`.
         */
        network?: string | null;
    }
    /**
    ...
    export interface Schema$NetworkConfig {
        ...
        /**
         * Optional. The resource link for the VPC network in which cluster resources are created and from which they are accessible via Private IP. The network must belong to the same project as the cluster. It is specified in the form: `projects/{project_number\}/global/networks/{networkid\}`. This is required to create a cluster.
         */
        network?: string | null;
    }
    /**
    ...
    /**
     * A backup's position in a quantity-based retention queue, of backups with the same source cluster and type, with length, retention, specified by the backup's retention policy. Once the position is greater than the retention, the backup is eligible to be garbage collected. Example: 5 backups from the same source cluster and type with a quantity-based retention of 3 and denoted by backupid (position, retention). Safe: backup_5 (1, 3), backup_4, (2, 3), backup_3 (3, 3). Awaiting garbage collection: backup_2 (4, 3), backup_1 (5, 3)
     */
