...
export declare namespace adsenseplatform_v1alpha {
    ...
    export interface Schema$ListAccountsResponse {
        /**
         * The Accounts returned in the list response. Represented by a partial view of the Account resource, populating `name` and `creation_requestid`.
         */
    ...
    export interface Schema$LookupAccountResponse {
        /**
         * The name of the Account Format: platforms/{platform\}/accounts/{accountid\}
         */
        name?: string | null;
    }
    /**
    ...
    export class Resource$Platforms$Accounts {
         ...
         *     // Required. Account to close. Format: platforms/{platform\}/accounts/{accountid\}
         ...
         *     // Required. Account to get information about. Format: platforms/{platform\}/accounts/{accountid\}
         *     name: 'platforms/my-platform/accounts/my-account',
         *   });
         *   console.log(res.data);
         *
        ...
        /**
         * Looks up information about a sub-account for a specified creation_requestid. If no account exists for the given creation_requestid, returns 404.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *     // Optional. The creation_requestid provided when calling createAccount.
    ...
    export class Resource$Platforms$Accounts$Sites {
         ...
         *     // Required. Account to create site. Format: platforms/{platform\}/accounts/{accountid\}
         *     parent: 'platforms/my-platform/accounts/my-account',
         *
         *     // Request body metadata
         *     requestBody: {
