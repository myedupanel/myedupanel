...
export declare namespace cloudbuild_v1alpha1 {
    ...
    export interface Schema$WorkerConfig {
        ...
        machineType?: string | null;
        /**
         * The network definition used to create the worker. If this section is left empty, the workers will be created in WorkerPool.projectid on the default network.
         */
