...
export declare namespace cloudbuild_v1alpha2 {
    ...
    export interface Schema$NetworkConfig {
        /**
         * Required. Immutable. The network definition that the workers are peered to. If this section is left empty, the workers will be peered to WorkerPool.projectid on the default network. Must be in the format `projects/{project\}/global/networks/{network\}`, where {project\} is a project number, such as `12345`, and {network\} is the name of a VPC network in the project.
         */
    ...
    export interface Schema$WorkerPool {
        ...
        /**
         * Output only. The resource name of the `WorkerPool`. Format of the name is `projects/{projectid\}/workerPools/{worker_poolid\}`, where the value of {worker_poolid\} is provided in the CreateWorkerPool request.
         */
        name?: string | null;
        /**
