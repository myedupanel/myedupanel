...
export declare namespace cloudbuild_v2 {
    ...
    export interface Schema$PipelineRun {
        ...
        /**
         * Output only. The `Record` of this `PipelineRun`. Format: `projects/{project\}/locations/{location\}/results/{resultid\}/records/{recordid\}`
         */
        record?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Connections {
         ...
         *     // If set to true, and the connection is not found a new connection will be created. In this situation `update_mask` is ignored. The creation will succeed only if the input connection has all the necessary information (e.g a github_config with both user_oauth_token and installationid properties).
