...
export declare namespace identitytoolkit_v3 {
    ...
    export interface Schema$IdentitytoolkitRelyingpartyCreateAuthUriRequest {
        ...
        /**
         * The query parameter that client can customize by themselves in auth url. The following parameters are reserved for server so that they cannot be customized by clients: clientid, response_type, scope, redirect_uri, state, oauth_token.
         */
        customParameter?: {
            [key: string]: string;
        } | null;
        ...
        providerId?: string | null;
        /**
         * The sessionid passed by client.
         */
        sessionId?: string | null;
        /**
    ...
    export interface Schema$IdentitytoolkitRelyingpartyUploadAccountRequest {
        /**
         * Whether allow overwrite existing account when user localid exists.
         */
