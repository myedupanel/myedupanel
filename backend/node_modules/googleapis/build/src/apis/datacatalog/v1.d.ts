...
export declare namespace datacatalog_v1 {
    ...
    export interface Schema$GoogleCloudDatacatalogV1SearchCatalogRequest {
        ...
        query?: string | null;
        /**
         * Required. The scope of this search request. The `scope` is invalid if `include_orgids`, `include_projectids` are empty AND `include_gcp_public_datasets` is set to `false`. In this case, the request returns an error.
         */
