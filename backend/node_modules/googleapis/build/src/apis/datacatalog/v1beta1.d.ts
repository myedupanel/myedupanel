...
export declare namespace datacatalog_v1beta1 {
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1BigQueryDateShardedSpec {
        /**
         * Output only. The Data Catalog resource name of the dataset entry the current table belongs to, for example, `projects/{projectid\}/locations/{location\}/entrygroups/{entry_groupid\}/entries/{entryid\}`.
         */
        dataset?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1Entry {
        ...
        /**
         * Output only. Identifier. The Data Catalog resource name of the entry in URL format. Example: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\}/entries/{entryid\} Note that this Entry and its child resources may not actually be stored in the location in this name.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1EntryGroup {
        ...
        displayName?: string | null;
        /**
         * Identifier. The resource name of the entry group in URL format. Example: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\} Note that this EntryGroup and its child resources may not actually be stored in the location in this name.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1PolicyTag {
        ...
        displayName?: string | null;
        /**
         * Identifier. Resource name of this policy tag, whose format is: "projects/{project_number\}/locations/{locationid\}/taxonomies/{taxonomyid\}/policyTags/{id\}".
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1SearchCatalogRequest {
        ...
        query?: string | null;
        /**
         * Required. The scope of this search request. A `scope` that has empty `include_orgids`, `include_projectids` AND false `include_gcp_public_datasets` is considered invalid. Data Catalog will return an error in such a case.
         */
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1SearchCatalogResult {
        ...
        /**
         * The relative resource name of the resource in URL format. Examples: * `projects/{projectid\}/locations/{locationid\}/entryGroups/{entry_groupid\}/entries/{entryid\}` * `projects/{projectid\}/tagTemplates/{tag_templateid\}`
         */
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1TableSpec {
        /**
         * Output only. If the table is a dated shard, i.e., with name pattern `[prefix]YYYYMMDD`, `grouped_entry` is the Data Catalog resource name of the date sharded grouped entry, for example, `projects/{projectid\}/locations/{location\}/entrygroups/{entry_groupid\}/entries/{entryid\}`. Otherwise, `grouped_entry` is empty.
         */
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1Tag {
        ...
        /**
         * Identifier. The resource name of the tag in URL format. Example: * projects/{projectid\}/locations/{location\}/entrygroups/{entry_groupid\}/entries/{entryid\}/tags/{tagid\} where `tagid` is a system-generated identifier. Note that this Tag may not actually be stored in the location in this name.
         */
        name?: string | null;
        /**
         * Required. The resource name of the tag template that this tag uses. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\} This field cannot be modified after creation.
         */
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1TagTemplate {
        ...
        /**
         * Identifier. The resource name of the tag template in URL format. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\} Note that this TagTemplate and its child resources may not actually be stored in the location in this name.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1TagTemplateField {
        ...
        /**
         * Output only. Identifier. The resource name of the tag template field in URL format. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_template\}/fields/{field\} Note that this TagTemplateField may not actually be stored in the location in this name.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatacatalogV1beta1Taxonomy {
        ...
        displayName?: string | null;
        /**
         * Identifier. Resource name of this taxonomy, whose format is: "projects/{project_number\}/locations/{locationid\}/taxonomies/{id\}".
         */
        name?: string | null;
        /**
    ...
    export class Resource$Entries {
         ...
         *     // The SQL name of the entry. SQL names are case-sensitive. Examples: * `pubsub.projectid.topicid` * ``pubsub.projectid.`topic.id.with.dots` `` * `bigquery.table.projectid.datasetid.tableid` * `bigquery.dataset.projectid.datasetid` * `datacatalog.entry.projectid.locationid.entry_groupid.entryid` `*id`s should satisfy the GoogleSQL rules for identifiers. https://cloud.google.com/bigquery/docs/reference/standard-sql/lexical.
    ...
    export class Resource$Projects$Locations$Entrygroups {
         ...
         *     // Required. The name of the project this entry group is in. Example: * projects/{projectid\}/locations/{location\} Note that this EntryGroup and its child resources may not actually be stored in the location in this name.
         ...
         *     // Required. The name of the entry group. For example, `projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\}`.
         ...
         *     // Required. The name of the location that contains the entry groups, which can be provided in URL format. Example: * projects/{projectid\}/locations/{location\}
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Entrygroups$Entries {
         ...
         *     // Required. The name of the entry group this entry is in. Example: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\} Note that this Entry and its child resources may not actually be stored in the location in this name.
         *     parent:
         *       'projects/my-project/locations/my-location/entryGroups/my-entryGroup',
         *
         *     // Request body metadata
         ...
         *     // Required. The name of the entry. Example: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\}/entries/{entryid\}
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The name of the entry group that contains the entries, which can be provided in URL format. Example: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\}
         *     parent:
         *       'projects/my-project/locations/my-location/entryGroups/my-entryGroup',
    ...
    export class Resource$Projects$Locations$Entrygroups$Entries$Tags {
         ...
         *       // Required. The name of the resource to attach this tag to. Tags can be attached to Entries. Example: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\}/entries/{entryid\} Note that this Tag and its child resources may not actually be stored in the location in this name.
         *       parent:
         *         'projects/my-project/locations/my-location/entryGroups/my-entryGroup/entries/my-entrie',
         *
         *       // Request body metadata
         ...
         *       // Required. The name of the tag to delete. Example: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\}/entries/{entryid\}/tags/{tagid\}
         ...
         *       // Token that specifies which page is requested. If empty, the first page is returned.
         *       pageToken: 'placeholder-value',
         *       // Required. The name of the Data Catalog resource to list the tags of. The resource could be an Entry or an EntryGroup. Examples: * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\} * projects/{projectid\}/locations/{location\}/entryGroups/{entry_groupid\}/entries/{entryid\}
         *       parent:
         *         'projects/my-project/locations/my-location/entryGroups/my-entryGroup/entries/my-entrie',
         *     });
         *   console.log(res.data);
    ...
    export class Resource$Projects$Locations$Tagtemplates {
         ...
         *     // Required. The name of the project and the template location [region](https://cloud.google.com/data-catalog/docs/concepts/regions. Example: * projects/{projectid\}/locations/us-central1
         *     parent: 'projects/my-project/locations/my-location',
         ...
         *     force: 'placeholder-value',
         *     // Required. The name of the tag template to delete. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\}
         ...
         *     // Required. The name of the tag template. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\}
         *     name: 'projects/my-project/locations/my-location/tagTemplates/my-tagTemplate',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Tagtemplates$Fields {
         ...
         *     // Required. The name of the project and the template location [region](https://cloud.google.com/data-catalog/docs/concepts/regions). Example: * projects/{projectid\}/locations/us-central1/tagTemplates/{tag_templateid\}
         *     parent:
         *       'projects/my-project/locations/my-location/tagTemplates/my-tagTemplate',
         ...
         *     force: 'placeholder-value',
         *     // Required. The name of the tag template field to delete. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\}/fields/{tag_template_fieldid\}
         ...
         *     // Required. The name of the tag template field. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\}/fields/{tag_template_fieldid\}
         *     name: 'projects/my-project/locations/my-location/tagTemplates/my-tagTemplate/fields/my-field',
         ...
         *     // Required. The name of the tag template. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\}/fields/{tag_template_fieldid\}
         *     name: 'projects/my-project/locations/my-location/tagTemplates/my-tagTemplate/fields/my-field',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Locations$Tagtemplates$Fields$Enumvalues {
         ...
         *       // Required. The name of the enum field value. Example: * projects/{projectid\}/locations/{location\}/tagTemplates/{tag_templateid\}/fields/{tag_template_fieldid\}/enumValues/{enum_value_display_name\}
