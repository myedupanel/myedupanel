...
export declare namespace firestore_v1beta1 {
    ...
    export interface Schema$GoogleFirestoreAdminV1beta1IndexOperationMetadata {
        ...
        endTime?: string | null;
        /**
         * The index resource that this operation is acting on. For example: `projects/{projectid\}/databases/{databaseid\}/indexes/{indexid\}`
         */
        index?: string | null;
        /**
    ...
    export class Resource$Projects$Databases$Indexes {
         ...
         *     // The index name. For example: `projects/{projectid\}/databases/{databaseid\}/indexes/{indexid\}`
         ...
         *     // The name of the index. For example: `projects/{projectid\}/databases/{databaseid\}/indexes/{indexid\}`
         *     name: 'projects/my-project/databases/my-database/indexes/my-indexe',
         *   });
         *   console.log(res.data);
         *
