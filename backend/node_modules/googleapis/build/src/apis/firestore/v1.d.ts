...
export declare namespace firestore_v1 {
    ...
    export interface Schema$ExistenceFilter {
        ...
        /**
         * A bloom filter that, despite its name, contains the UTF-8 byte encodings of the resource names of ALL the documents that match targetid, in the form `projects/{projectid\}/databases/{databaseid\}/documents/{document_path\}`. This bloom filter may be omitted at the server's discretion, such as if it is deemed that the client will not make use of it or if it is too computationally expensive to calculate or transmit. Clients must gracefully handle this field being absent by falling back to the logic used before this field existed; that is, re-add the target without a resume token to figure out which documents in the client's cache are out of sync.
         */
    ...
    /**
     * The request for FirestoreAdmin.BulkDeleteDocuments. When both collectionids and namespaceids are set, only documents satisfying both conditions will be deleted. Requests with namespaceids and collectionids both empty will be rejected. Please use FirestoreAdmin.DeleteDatabase instead.
     */
    ...
    export interface Schema$GoogleFirestoreAdminV1CloneDatabaseRequest {
        ...
        pitrSnapshot?: Schema$GoogleFirestoreAdminV1PitrSnapshot;
        /**
         * Optional. Immutable. Tags to be bound to the cloned database. The tags should be provided in the format of `tagKeys/{tag_keyid\} -\> tagValues/{tag_valueid\}`.
         */
        tags?: {
            [key: string]: string;
        } | null;
    ...
    export interface Schema$GoogleFirestoreAdminV1CmekConfig {
        ...
        /**
         * Required. Only keys in the same location as this database are allowed to be used for encryption. For Firestore's nam5 multi-region, this corresponds to Cloud KMS multi-region us. For Firestore's eur3 multi-region, this corresponds to Cloud KMS multi-region europe. See https://cloud.google.com/kms/docs/locations. The expected format is `projects/{projectid\}/locations/{kms_location\}/keyRings/{key_ring\}/cryptoKeys/{crypto_key\}`.
         */
    ...
    export interface Schema$GoogleFirestoreAdminV1Field {
        ...
        /**
         * Required. A field name of the form: `projects/{projectid\}/databases/{databaseid\}/collectionGroups/{collectionid\}/fields/{field_path\}` A field path can be a simple field name, e.g. `address` or a path to fields within `map_value` , e.g. `address.city`, or a special field path. The only valid special field is `*`, which represents any field. Field paths can be quoted using `` ` `` (backtick). The only character that must be escaped within a quoted field path is the backtick character itself, escaped using a backslash. Special characters in field paths that must be quoted include: `*`, `.`, `` ` `` (backtick), `[`, `]`, as well as any ascii symbolic characters. Examples: `` `address.city` `` represents a field named `address.city`, not the map key `city` in the field `address`. `` `*` `` represents a field named `*`, not any field. A special `Field` contains the default indexing settings for all fields. This field's resource name is: `projects/{projectid\}/databases/{databaseid\}/collectionGroups/__default__/fields/x` Indexes defined on this `Field` will be applied to all fields which do not have their own `Field` index configuration.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirestoreAdminV1FieldOperationMetadata {
        ...
        endTime?: string | null;
        /**
         * The field resource that this operation is acting on. For example: `projects/{projectid\}/databases/{databaseid\}/collectionGroups/{collectionid\}/fields/{field_path\}`
         */
        field?: string | null;
        /**
    ...
    export interface Schema$GoogleFirestoreAdminV1Index {
        ...
        /**
         * Output only. A server defined name for this index. The form of this name for composite indexes will be: `projects/{projectid\}/databases/{databaseid\}/collectionGroups/{collectionid\}/indexes/{composite_indexid\}` For single field indexes, this field will be empty.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirestoreAdminV1IndexOperationMetadata {
        ...
        endTime?: string | null;
        /**
         * The index resource that this operation is acting on. For example: `projects/{projectid\}/databases/{databaseid\}/collectionGroups/{collectionid\}/indexes/{indexid\}`
         */
        index?: string | null;
        /**
         * The progress, in bytes, of this operation.
    ...
    export interface Schema$GoogleFirestoreAdminV1RestoreDatabaseRequest {
        /**
         * Required. Backup to restore from. Must be from the same project as the parent. The restored database will be created in the same location as the source backup. Format is: `projects/{projectid\}/locations/{location\}/backups/{backup\}`
         */
        backup?: string | null;
        /**
         * Required. The ID to use for the database, which will become the final component of the database's resource name. This database ID must not be associated with an existing database. This value should be 4-63 characters. Valid characters are /a-z-/ with first character a letter and the last a letter or a number. Must not be UUID-like /[0-9a-f]{8\}(-[0-9a-f]{4\}){3\}-[0-9a-f]{12\}/. "(default)" database ID is also valid if the database is Standard edition.
        ...
        encryptionConfig?: Schema$GoogleFirestoreAdminV1EncryptionConfig;
        /**
         * Optional. Immutable. Tags to be bound to the restored database. The tags should be provided in the format of `tagKeys/{tag_keyid\} -\> tagValues/{tag_valueid\}`.
         */
        tags?: {
            [key: string]: string;
        } | null;
    ...
    export interface Schema$Target {
        ...
        /**
         * The target ID that identifies the target on the stream. Must be a positive number and non-zero. If `targetid` is 0 (or unspecified), the server will assign an ID for this target and return that in a `TargetChange::ADD` event. Once a target with `targetid=0` is added, all subsequent targets must also have `targetid=0`. If an `AddTarget` request with `targetid != 0` is sent to the server after a target with `targetid=0` is added, the server will immediately send a response with a `TargetChange::Remove` event. Note that if the client sends multiple `AddTarget` requests without an ID, the order of IDs returned in `TargetChange.targetids` are undefined. Therefore, clients should provide a target ID instead of relying on the server to assign one. If `targetid` is non-zero, there must not be an existing active target on this stream with the same ID.
         */
        targetId?: number | null;
    }
    /**
    ...
    export interface Schema$TargetChange {
        ...
        cause?: Schema$Status;
        /**
         * The consistent `read_time` for the given `targetids` (omitted when the targetids are not at a consistent snapshot). The stream is guaranteed to send a `read_time` with `targetids` empty whenever the entire stream reaches a new consistent snapshot. ADD, CURRENT, and RESET messages are guaranteed to (eventually) result in a new consistent snapshot (while NO_CHANGE and REMOVE messages are not). For a given stream, `read_time` is guaranteed to be monotonically increasing.
         */
        readTime?: string | null;
        /**
         * A token that can be used to resume the stream for the given `targetids`, or all targets if `targetids` is empty. Not set on every target change.
         */
        resumeToken?: string | null;
        /**
    ...
    export interface Schema$WriteRequest {
        ...
        /**
         * A stream token that was previously sent by the server. The client should set this field to the token from the most recent WriteResponse it has received. This acknowledges that the client has received responses up to this token. After sending this token, earlier tokens may not be used anymore. The server may close the stream if there are too many unacknowledged responses. Leave this field unset when creating a new stream. To resume a stream at a specific point, set this field and the `streamid` field. Leave this field unset when creating a new stream.
         */
    ...
    export class Resource$Projects$Databases$Collectiongroups$Fields {
         ...
         *     // Required. A name of the form `projects/{projectid\}/databases/{databaseid\}/collectionGroups/{collectionid\}/fields/{fieldid\}`
        ...
        /**
         * Updates a field configuration. Currently, field updates apply only to single field index configuration. However, calls to FirestoreAdmin.UpdateField should provide a field mask to avoid changing any configuration that the caller isn't aware of. The field mask should be specified as: `{ paths: "index_config" \}`. This call returns a google.longrunning.Operation which may be used to track the status of the field update. The metadata for the operation will be the type FieldOperationMetadata. To configure the default field settings for the database, use the special `Field` with resource name: `projects/{projectid\}/databases/{databaseid\}/collectionGroups/__default__/fields/x`.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Projects$Databases$Collectiongroups$Indexes {
         ...
         *       // Required. A name of the form `projects/{projectid\}/databases/{databaseid\}/collectionGroups/{collectionid\}/indexes/{indexid\}`
    ...
    export class Resource$Projects$Databases$Documents {
         ...
         *     // Required. The parent resource. For example: `projects/{projectid\}/databases/{databaseid\}/documents` or `projects/{projectid\}/databases/{databaseid\}/documents/chatrooms/{chatroomid\}`
         ...
         *     // Required. The database name. In the format: `projects/{projectid\}/databases/{databaseid\}`. This is only required in the first message.
         *     database: 'projects/my-project/databases/my-database',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Databases$Usercreds {
         ...
         *     // Required. A name of the form `projects/{projectid\}/databases/{databaseid\}/userCreds/{user_credsid\}`
