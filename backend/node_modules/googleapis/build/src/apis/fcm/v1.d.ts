...
export declare namespace fcm_v1 {
    ...
    export interface Schema$Message {
        ...
        /**
         * Output Only. The identifier of the message sent, in the format of `projects/x/messages/{messageid\}`.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Messages {
         ...
         *     // Required. It contains the Firebase project id (i.e. the unique identifier for your Firebase project), in the format of `projects/{projectid\}`. The numeric project number with no padding is also supported in the format of `projects/{project_number\}`.
