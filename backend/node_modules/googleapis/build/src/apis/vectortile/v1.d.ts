...
export declare namespace vectortile_v1 {
    ...
    export class Resource$Featuretiles {
         ...
         *     // Required. The BCP-47 language code corresponding to the language in which the name was requested, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier.
