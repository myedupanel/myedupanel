...
export declare namespace retail_v2alpha {
    ...
    export interface Schema$GoogleCloudRetailV2alphaBranch {
        ...
        /**
         * Immutable. Full resource name of the branch, such as `projects/x/locations/global/catalogs/default_catalog/branches/branchid`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaCompleteQueryResponse {
        ...
        /**
         * Deprecated. Matched recent searches of this user. The maximum number of recent searches is 10. This field is a restricted feature. If you want to enable it, contact Retail Search support. This feature is only available when CompleteQueryRequest.visitorid field is set and UserEvent is imported. The recent searches satisfy the follow rules: * They are ordered from latest to oldest. * They are matched with CompleteQueryRequest.query case insensitively. * They are transformed to lower case. * They are UTF-8 safe. Recent searches are deduplicated. More recent searches will be reserved when duplication happens.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaConversationalSearchRequest {
        ...
        /**
         * Optional. This field specifies the conversation id, which maintains the state of the conversation between client side and server side. Use the value from the previous ConversationalSearchResponse.conversationid. For the initial request, this should be empty.
         */
        ...
        /**
         * Required. A unique identifier for tracking visitors. For example, this could be implemented with an HTTP cookie, which should be able to uniquely identify a visitor on a single device. This unique identifier should not change if the visitor logs in or out of the website. This should be the same identifier as UserEvent.visitorid. The field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaConversationalSearchResponse {
        ...
        /**
         * Conversation UUID. This field will be stored in client side storage to maintain the conversation session with server and will be used for next search request's ConversationalSearchRequest.conversationid to restore conversation state in server.
         */
        conversationId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaCreateModelMetadata {
        /**
         * The resource name of the model that this create applies to. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/models/{modelid\}`
         */
        model?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaExperimentInfo {
        /**
         * The fully qualified resource name of the experiment that provides the serving config under test, should an active experiment exist. For example: `projects/x/locations/global/catalogs/default_catalog/experiments/experimentid`
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaExperimentInfoServingConfigExperiment {
        /**
         * The fully qualified resource name of the serving config `Experiment.VariantArm.serving_configid` responsible for generating the search response. For example: `projects/x/locations/x/catalogs/x/servingConfigs/x`.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaMerchantCenterAccountLink {
        ...
        /**
         * The FeedLabel used to perform filtering. Note: this replaces [regionid](https://developers.google.com/shopping-content/reference/rest/v2.1/products#Product.FIELDS.feed_label). Example value: `US`. Example value: `FeedLabel1`.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter {
        ...
        /**
         * Merchant Center primary feed ID. Deprecated: use data_sourceid instead.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaMerchantCenterLink {
        /**
         * The branch ID (e.g. 0/1/2) within this catalog that products from merchant_center_accountid are streamed to. When updating this field, an empty value will use the currently configured default branch. However, changing the default branch later on won't change the linked branch here. A single branch ID can only have one linked Merchant Center account ID.
         */
        branchId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaModel {
        ...
        /**
         * Required. The fully qualified resource name of the model. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/models/{modelid\}` catalogid has char limit of 50. recommendation_modelid has char limit of 40.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaPredictRequest {
        ...
        /**
         * Required. Context about the user, what they are looking at and what action they took to trigger the predict request. Note that this user event detail won't be ingested to userEvent logs. Thus, a separate userEvent write request is required for event logging. Don't set UserEvent.visitorid or UserInfo.userid to the same fixed ID for different users. If you are trying to receive non-personalized recommendations (not recommended; this can negatively impact model performance), instead set UserEvent.visitorid to a random unique ID and leave UserInfo.userid unset.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaPriceInfo {
        ...
        cost?: number | null;
        /**
         * The 3-letter currency code defined in [ISO 4217](https://www.iso.org/iso-4217-currency-codes.html). If this field is an unrecognizable currency code, an INVALID_ARGUMENT error is returned. The Product.Type.VARIANT Products with the same Product.primary_productid must share the same currency_code. Otherwise, a FAILED_PRECONDITION error is returned.
         */
    ...
    /**
     * The price range of all variant Product having the same Product.primary_productid.
     */
    export interface Schema$GoogleCloudRetailV2alphaPriceInfoPriceRange {
        /**
         * The inclusive Product.pricing_info.original_price internal of all variant Product having the same Product.primary_productid.
         */
        originalPrice?: Schema$GoogleCloudRetailV2alphaInterval;
        /**
         * The inclusive Product.pricing_info.price interval of all variant Product having the same Product.primary_productid.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaProduct {
        ...
        /**
         * Immutable. Full resource name of the product, such as `projects/x/locations/global/catalogs/default_catalog/branches/default_branch/products/productid`.
         */
        name?: string | null;
        /**
        ...
        priceInfo?: Schema$GoogleCloudRetailV2alphaPriceInfo;
        /**
         * Variant group identifier. Must be an id, with the same parent branch with this product. Otherwise, an error is thrown. For Type.PRIMARY Products, this field can only be empty or set to the same value as id. For VARIANT Products, this field cannot be empty. A maximum of 2,000 products are allowed to share the same Type.PRIMARY Product. Otherwise, an INVALID_ARGUMENT error is returned. Corresponding properties: Google Merchant Center property [item_groupid](https://support.google.com/merchants/answer/6324507). Schema.org property [Product.inProductGroupWithID](https://schema.org/inProductGroupWithID).
         */
        primaryProductId?: string | null;
        /**
         * The promotions applied to the product. A maximum of 10 values are allowed per Product. Only Promotion.promotionid will be used, other fields will be ignored if set.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaProductLevelConfig {
        /**
         * The type of Products allowed to be ingested into the catalog. Acceptable values are: * `primary` (default): You can ingest Products of all types. When ingesting a Product, its type will default to Product.Type.PRIMARY if unset. * `variant` (incompatible with Retail Search): You can only ingest Product.Type.VARIANT Products. This means Product.primary_productid cannot be empty. If this field is set to an invalid value other than these, an INVALID_ARGUMENT error is returned. If this field is `variant` and merchant_center_productid_field is `itemGroupId`, an INVALID_ARGUMENT error is returned. See [Product levels](https://cloud.google.com/retail/docs/catalog#product-levels) for more details.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaProject {
        ...
        enrolledSolutions?: string[] | null;
        /**
         * Output only. Full resource name of the retail project, such as `projects/{projectid_or_number\}/retailProject`.
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaSearchRequest {
        /**
         * Boost specification to boost certain products. For more information, see [Boost results](https://cloud.google.com/retail/docs/boosting). Notice that if both ServingConfig.boost_controlids and SearchRequest.boost_spec are set, the boost conditions from both places are evaluated. If a search request matches multiple boost conditions, the final boost score is equal to the sum of the boost scores from all matched boost conditions.
         */
        boostSpec?: Schema$GoogleCloudRetailV2alphaSearchRequestBoostSpec;
        /**
        ...
        /**
         * Optional. An id corresponding to a place, such as a store id or region id. When specified, we use the price from the local inventory with the matching product's LocalInventory.placeid for revenue optimization.
         */
        placeId?: string | null;
        /**
        ...
        userInfo?: Schema$GoogleCloudRetailV2alphaUserInfo;
        /**
         * The keys to fetch and rollup the matching variant Products attributes, FulfillmentInfo or LocalInventorys attributes. The attributes from all the matching variant Products or LocalInventorys are merged and de-duplicated. Notice that rollup attributes will lead to extra query latency. Maximum number of keys is 30. For FulfillmentInfo, a fulfillment type and a fulfillment ID must be provided in the format of "fulfillmentType.fulfillmentId". E.g., in "pickupInStore.store123", "pickupInStore" is fulfillment type and "store123" is the store ID. Supported keys are: * colorFamilies * price * originalPrice * discount * variantId * inventory(placeid,price) * inventory(placeid,original_price) * inventory(placeid,attributes.key), where key is any key in the Product.local_inventories.attributes map. * attributes.key, where key is any key in the Product.attributes map. * pickupInStore.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "pickup-in-store". * shipToStore.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "ship-to-store". * sameDayDelivery.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "same-day-delivery". * nextDayDelivery.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "next-day-delivery". * customFulfillment1.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "custom-type-1". * customFulfillment2.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "custom-type-2". * customFulfillment3.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "custom-type-3". * customFulfillment4.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "custom-type-4". * customFulfillment5.id, where id is any FulfillmentInfo.placeids for FulfillmentInfo.type "custom-type-5". If this field is set to an invalid value other than these, an INVALID_ARGUMENT error is returned.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaSearchRequestConversationalSearchSpec {
        /**
         * This field specifies the conversation id, which maintains the state of the conversation between client side and server side. Use the value from the previous ConversationalSearchResult.conversationid. For the initial request, this should be empty.
         */
        conversationId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
        ...
        /**
         * Required. Supported textual and numerical facet keys in Product object, over which the facet values are computed. Facet key is case-sensitive. Allowed facet keys when FacetKey.query is not specified: * textual_field = * "brands" * "categories" * "genders" * "ageGroups" * "availability" * "colorFamilies" * "colors" * "sizes" * "materials" * "patterns" * "conditions" * "attributes.key" * "pickupInStore" * "shipToStore" * "sameDayDelivery" * "nextDayDelivery" * "customFulfillment1" * "customFulfillment2" * "customFulfillment3" * "customFulfillment4" * "customFulfillment5" * "inventory(placeid,attributes.key)" * numerical_field = * "price" * "discount" * "rating" * "ratingCount" * "attributes.key" * "inventory(placeid,price)" * "inventory(placeid,original_price)" * "inventory(placeid,attributes.key)"
         */
        key?: string | null;
        /**
         * The order in which SearchResponse.Facet.values are returned. Allowed values are: * "count desc", which means order by SearchResponse.Facet.values.count descending. * "value desc", which means order by SearchResponse.Facet.values.value descending. Only applies to textual facets. If not set, textual values are sorted in [natural order](https://en.wikipedia.org/wiki/Natural_sort_order); numerical intervals are sorted in the order given by FacetSpec.FacetKey.intervals; FulfillmentInfo.placeids are sorted in the order given by FacetSpec.FacetKey.restricted_values.
         */
        orderBy?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult {
        ...
        /**
         * Conversation UUID. This field will be stored in client side storage to maintain the conversation session with server and will be used for next search request's SearchRequest.ConversationalSearchSpec.conversationid to restore conversation state in server.
         */
        conversationId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaServingConfig {
        /**
         * Condition boost specifications. If a product matches multiple conditions in the specifications, boost scores from these specifications are all applied and combined in a non-linear way. Maximum number of specifications is 100. Notice that if both ServingConfig.boost_controlids and SearchRequest.boost_spec are set, the boost conditions from both places are evaluated. If a search request matches multiple boost conditions, the final boost score is equal to the sum of the boost scores from all matched boost conditions. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
         */
    ...
    export interface Schema$GoogleCloudRetailV2alphaTuneModelMetadata {
        /**
         * The resource name of the model that this tune applies to. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/models/{modelid\}`
         */
        model?: string | null;
    }
    /**
    ...
    export class Resource$Projects {
         ...
         *     // Required. Full resource name of parent. Format: `projects/{project_number_orid\}`
         ...
         *     // Required. Full resource name of the project. Format: `projects/{project_number_orid\}/retailProject`
    ...
    export class Resource$Projects$Locations$Catalogs {
         ...
         *     // Required. Full CompletionConfig resource name. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/completionConfig`
    ...
    export class Resource$Projects$Locations$Catalogs$Attributesconfig {
         ...
         *       {
         *         // Required. The attributes config resource shared by all catalog attributes being deleted. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/attributesConfig`
         *         attributesConfig:
         *           'projects/my-project/locations/my-location/catalogs/my-catalog/attributesConfig',
         *
         *         // Request body metadata
    ...
    export class Resource$Projects$Locations$Catalogs$Branches {
         ...
         *     // Required. The name of the branch to retrieve. Format: `projects/x/locations/global/catalogs/default_catalog/branches/some_branchid`. "default_branch" can be used as a special branchid, it returns the default branch that has been set for the catalog.
    ...
    export class Resource$Projects$Locations$Catalogs$Branches$Products {
         ...
         *       {
         *         // Required. Full resource name of Product, such as `projects/x/locations/global/catalogs/default_catalog/branches/default_branch/products/some_productid`. If the caller does not have permission to access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error is returned.
         *         product:
         ...
         *       // Required. Full resource name of Product, such as `projects/x/locations/global/catalogs/default_catalog/branches/default_branch/products/some_productid`. If the caller does not have permission to delete the Product, regardless of whether or not it exists, a PERMISSION_DENIED error is returned. If the Product to delete does not exist, a NOT_FOUND error is returned. The Product to delete can neither be a Product.Type.COLLECTION Product member nor a Product.Type.PRIMARY Product with more than one variants. Otherwise, an INVALID_ARGUMENT error is returned. All inventory information for the named Product will be deleted.
         ...
         *     // Required. Full resource name of Product, such as `projects/x/locations/global/catalogs/default_catalog/branches/default_branch/products/some_productid`. If the caller does not have permission to access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error is returned. If the requested Product does not exist, a NOT_FOUND error is returned.
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/branches/my-branche/products/.*',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // A filter to apply on the list results. Supported features: * List all the products under the parent branch if filter is unset. * List Product.Type.VARIANT Products sharing the same Product.Type.PRIMARY Product. For example: `primary_productid = "some_productid"` * List Products bundled in a Product.Type.COLLECTION Product. For example: `collection_productid = "some_productid"` * List Products with a partibular type. For example: `type = "PRIMARY"` `type = "VARIANT"` `type = "COLLECTION"` If the field is unrecognizable, an INVALID_ARGUMENT error is returned. If the specified Product.Type.PRIMARY Product or Product.Type.COLLECTION Product does not exist, a NOT_FOUND error is returned.
        ...
        /**
         * We recommend that you use the ProductService.RemoveLocalInventories method instead of the ProductService.RemoveFulfillmentPlaces method. ProductService.RemoveLocalInventories achieves the same results but provides more fine-grained control over ingesting local inventory data. Incrementally removes place IDs from a Product.fulfillment_info.placeids. This process is asynchronous and does not require the Product to exist before updating fulfillment information. If the request is valid, the update will be enqueued and processed downstream. As a consequence, when a response is returned, the removed place IDs are not immediately manifested in the Product queried by ProductService.GetProduct or ProductService.ListProducts. The returned Operations will be obsolete after 1 day, and GetOperation API will return NOT_FOUND afterwards. If conflicting updates are issued, the Operations associated with the stale updates will not be marked as done until being obsolete.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Projects$Locations$Catalogs$Controls {
         ...
         *     // Required. Full resource name of parent catalog. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}`
         *     parent: 'projects/my-project/locations/my-location/catalogs/my-catalog',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the Control to delete. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/controls/{controlid\}`
         ...
         *     // Required. The resource name of the Control to get. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/controls/{controlid\}`
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/controls/my-control',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The catalog resource name. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}`
         *     parent: 'projects/my-project/locations/my-location/catalogs/my-catalog',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks {
         ...
         *       // Required. Full resource name. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/merchantCenterAccountLinks/{merchant_center_account_linkid\}`
    ...
    export class Resource$Projects$Locations$Catalogs$Models {
         ...
         *     // Required. The parent resource under which to create the model. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}`
         *     parent: 'projects/my-project/locations/my-location/catalogs/my-catalog',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the Model to delete. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/models/{modelid\}`
         ...
         *     // Required. The resource name of the Model to get. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalog\}/models/{modelid\}`
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/models/my-model',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent for which to list models. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}`
         *     parent: 'projects/my-project/locations/my-location/catalogs/my-catalog',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The name of the model to pause. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/models/{modelid\}`
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/models/my-model',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The name of the model to resume. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/models/{modelid\}`
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/models/my-model',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the model to tune. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/models/{modelid\}`
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/models/my-model',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Locations$Catalogs$Servingconfigs {
         ...
         *       // Required. The source ServingConfig resource name . Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/servingConfigs/{serving_configid\}`
         *       servingConfig:
         ...
         *     // Required. Full resource name of parent. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}`
         *     parent: 'projects/my-project/locations/my-location/catalogs/my-catalog',
         ...
         *     // Required. The resource name of the ServingConfig to delete. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/servingConfigs/{serving_configid\}`
         ...
         *     // Required. The resource name of the ServingConfig to get. Format: `projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/servingConfigs/{serving_configid\}`
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/servingConfigs/my-servingConfig',
         *   });
         *   console.log(res.data);
         *
