...
export declare namespace recommendationengine_v1beta1 {
    ...
    export interface Schema$GoogleCloudRecommendationengineV1alphaTuningMetadata {
        /**
         * The resource name of the recommendation model that this tune applies to. Format: projects/{project_number\}/locations/{locationid\}/catalogs/{catalogid\}/eventStores/{event_storeid\}/recommendationModels/{recommendation_modelid\}
         */
    ...
    export interface Schema$GoogleCloudRecommendationengineV1beta1PredictRequest {
        ...
        /**
         * Required. Context about the user, what they are looking at and what action they took to trigger the predict request. Note that this user event detail won't be ingested to userEvent logs. Thus, a separate userEvent write request is required for event logging. Don't set UserInfo.visitorid or UserInfo.userid to the same fixed ID for different users. If you are trying to receive non-personalized recommendations (not recommended; this can negatively impact model performance), instead set UserInfo.visitorid to a random unique ID and leave UserInfo.userid unset.
         */
    ...
    export class Resource$Projects$Locations$Catalogs$Catalogitems {
         ...
         *       // Required. Full resource name of catalog item, such as `projects/x/locations/global/catalogs/default_catalog/catalogItems/some_catalog_itemid`.
