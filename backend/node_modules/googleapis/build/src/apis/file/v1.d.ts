...
export declare namespace file_v1 {
    ...
    export interface Schema$Backup {
        ...
        /**
         * Output only. The resource name of the backup, in the format `projects/{project_number\}/locations/{locationid\}/backups/{backupid\}`.
         */
        name?: string | null;
        /**
        ...
        /**
         * The resource name of the source Filestore instance, in the format `projects/{project_number\}/locations/{locationid\}/instances/{instanceid\}`, used to create this backup.
         */
    ...
    export interface Schema$FileShareConfig {
        ...
        /**
         * The resource name of the backup, in the format `projects/{project_number\}/locations/{locationid\}/backups/{backupid\}`, that this file share has been restored from.
         */
        sourceBackup?: string | null;
        /**
         * The resource name of the BackupDR backup, in the format `projects/{projectid\}/locations/{locationid\}/backupVaults/{backupvaultid\}/dataSources/{datasourceid\}/backups/{backupid\}`, TODO (b/443690479) - Remove visibility restrictions once the feature is ready
         */
    ...
    export interface Schema$RestoreInstanceRequest {
        ...
        /**
         * The resource name of the backup, in the format `projects/{project_number\}/locations/{locationid\}/backups/{backupid\}`.
         */
        sourceBackup?: string | null;
    }
    /**
    ...
    export class Resource$Projects$Locations$Backups {
         ...
         *     // Required. The backup resource name, in the format `projects/{project_number\}/locations/{location\}/backups/{backupid\}`
    ...
    export class Resource$Projects$Locations$Instances {
         ...
         *     // Required. The resource name of the instance, in the format `projects/{project_number\}/locations/{locationid\}/instances/{instanceid\}`.
         *     name: 'projects/my-project/locations/my-location/instances/my-instance',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Locations$Instances$Snapshots {
         ...
         *     // The next_page_token value to use if there are additional results to retrieve for this list request.
         *     pageToken: 'placeholder-value',
         *     // Required. The instance for which to retrieve snapshot information, in the format `projects/{projectid\}/locations/{location\}/instances/{instanceid\}`.
         *     parent: 'projects/my-project/locations/my-location/instances/my-instance',
