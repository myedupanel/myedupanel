...
export declare namespace localservices_v1 {
    ...
    export interface Schema$GoogleAdsHomeservicesLocalservicesV1DetailedLeadReport {
        ...
        /**
         * Deprecated in favor of google_ads_leadid. Unique identifier of a Detailed Lead Report.
         */
        leadId?: string | null;
        /**
    ...
    export class Resource$Accountreports {
         ...
         *     // A query string for searching for account reports. Caller must provide a customer id of their MCC account with an associated Gaia Mint that allows read permission on their linked accounts. Search expressions are case insensitive. Example query: | Query | Description | |-------------------------|-----------------------------------------------| | manager_customerid:123 | Get Account Report for Manager with id 123. | Required.
    ...
    export class Resource$Detailedleadreports {
         ...
         *     pageToken: 'placeholder-value',
         *     // A query string for searching for account reports. Caller must provide a customer id of their MCC account with an associated Gaia Mint that allows read permission on their linked accounts. Search expressions are case insensitive. Example query: | Query | Description | |-------------------------|-----------------------------------------------| | manager_customerid:123 | Get Detailed Lead Report for Manager with id | | | 123. | Required.
         *     query: 'placeholder-value',
         *     // Day of a month. Must be from 1 to 31 and valid for the year and month, or 0 to specify a year by itself or a year and month where the day isn't significant.
         *     'startDate.day': 'placeholder-value',
         *     // Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day.
