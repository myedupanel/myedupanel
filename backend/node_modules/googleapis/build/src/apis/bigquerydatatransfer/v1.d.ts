...
export declare namespace bigquerydatatransfer_v1 {
    ...
    /**
     * Represents a data transfer configuration. A transfer configuration contains all metadata needed to perform a data transfer. For example, `destination_datasetid` specifies where data should be stored. When a new transfer configuration is created, the specified `destination_datasetid` is created when needed and shared with the appropriate data source service account.
     */
    export interface Schema$TransferConfig {
        ...
        /**
         * Pub/Sub topic where notifications will be sent after transfer runs associated with this transfer config finish. The format for specifying a pubsub topic is: `projects/{projectid\}/topics/{topicid\}`
         */
    ...
    export interface Schema$TransferRun {
        ...
        /**
         * Identifier. The resource name of the transfer run. Transfer run names have the form `projects/{projectid\}/locations/{location\}/transferConfigs/{configid\}/runs/{runid\}`. The name is ignored when creating a transfer run.
         */
        name?: string | null;
        /**
         * Output only. Pub/Sub topic where a notification will be sent after this transfer run finishes. The format for specifying a pubsub topic is: `projects/{projectid\}/topics/{topicid\}`
         */
        notificationPubsubTopic?: string | null;
        /**
    ...
    export class Resource$Projects$Datasources {
         ...
         *     // Required. The name of the data source. If you are using the regionless method, the location must be `US` and the name should be in the following form: * `projects/{projectid\}/dataSources/{data_sourceid\}` If you are using the regionalized method, the name should be in the following form: * `projects/{projectid\}/locations/{locationid\}/dataSources/{data_sourceid\}`
