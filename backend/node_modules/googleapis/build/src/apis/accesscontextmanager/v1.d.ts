...
export declare namespace accesscontextmanager_v1 {
    ...
    export class Resource$Accesspolicies {
         ...
         *     // Required. Resource name for the access policy to delete. Format `accessPolicies/{policyid\}`
         ...
         *     // Required. Resource name for the access policy to get. Format `accessPolicies/{policyid\}`
         *     name: 'accessPolicies/my-accessPolicie',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. Resource name for the container to list AccessPolicy instances from. Format: `organizations/{orgid\}`
    ...
    export class Resource$Accesspolicies$Accesslevels {
         ...
         *     // Required. Resource name for the access policy which owns this Access Level. Format: `accessPolicies/{policyid\}`
         ...
         *     // Required. Resource name for the Access Level. Format: `accessPolicies/{policyid\}/accessLevels/{access_levelid\}`
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Resource name for the access policy to list Access Levels from. Format: `accessPolicies/{policyid\}`
         *     parent: 'accessPolicies/my-accessPolicie',
         *   });
         *   console.log(res.data);
         *
         ...
         *     {
         *       // Required. Resource name for the access policy which owns these Access Levels. Format: `accessPolicies/{policyid\}`
         *       parent: 'accessPolicies/my-accessPolicie',
         *
         *       // Request body metadata
         *       requestBody: {
    ...
    export class Resource$Accesspolicies$Authorizedorgsdescs {
         ...
         *       // Required. Resource name for the access policy which owns this Authorized Orgs Desc. Format: `accessPolicies/{policyid\}`
         *       parent: 'accessPolicies/my-accessPolicie',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *       // Required. Resource name for the Authorized Orgs Desc. Format: `accessPolicies/{policyid\}/authorizedOrgsDesc/{authorized_orgs_descid\}`
         ...
         *     {
         *       // Required. Resource name for the Authorized Orgs Desc. Format: `accessPolicies/{policyid\}/authorizedOrgsDescs/{authorized_orgs_descsid\}`
         *       name: 'accessPolicies/my-accessPolicie/authorizedOrgsDescs/my-authorizedOrgsDesc',
         *     },
         *   );
         *   console.log(res.data);
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. Resource name for the access policy to list Authorized Orgs Desc from. Format: `accessPolicies/{policyid\}`
         *       parent: 'accessPolicies/my-accessPolicie',
         *     });
         *   console.log(res.data);
         *
    ...
    export class Resource$Accesspolicies$Serviceperimeters {
         ...
         *       // Required. Resource name for the parent Access Policy which owns all Service Perimeters in scope for the commit operation. Format: `accessPolicies/{policyid\}`
         *       parent: 'accessPolicies/my-accessPolicie',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *       // Required. Resource name for the access policy which owns this Service Perimeter. Format: `accessPolicies/{policyid\}`
         *       parent: 'accessPolicies/my-accessPolicie',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *       // Required. Resource name for the Service Perimeter. Format: `accessPolicies/{policyid\}/servicePerimeters/{service_perimeterid\}`
         ...
         *     // Required. Resource name for the Service Perimeter. Format: `accessPolicies/{policyid\}/servicePerimeters/{service_perimetersid\}`
         *     name: 'accessPolicies/my-accessPolicie/servicePerimeters/my-servicePerimeter',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Resource name for the access policy to list Service Perimeters from. Format: `accessPolicies/{policyid\}`
         *     parent: 'accessPolicies/my-accessPolicie',
         *   });
         *   console.log(res.data);
         *
         ...
         *       // Required. Resource name for the access policy which owns these Service Perimeters. Format: `accessPolicies/{policyid\}`
         *       parent: 'accessPolicies/my-accessPolicie',
         *
         *       // Request body metadata
         *       requestBody: {
