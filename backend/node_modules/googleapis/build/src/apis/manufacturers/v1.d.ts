...
export declare namespace manufacturers_v1 {
    ...
    export interface Schema$Product {
        ...
        issues?: Schema$Issue[];
        /**
         * Name in the format `{target_country\}:{content_language\}:{productid\}`. `target_country` - The target country of the product as a CLDR territory code (for example, US). `content_language` - The content language of the product as a two-letter ISO 639-1 language code (for example, en). `productid` - The ID of the product. For more information, see https://support.google.com/manufacturers/answer/6124116#id.
         */
        name?: string | null;
        /**
         * Parent ID in the format `accounts/{accountid\}`. `accountid` - The ID of the Manufacturer Center account.
         */
        parent?: string | null;
        /**
