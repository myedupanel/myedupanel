...
export declare namespace remotebuildexecution_v1 {
    ...
    export interface Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest {
        ...
        /**
         * ID of the created instance. A valid `instanceid` must: be 6-50 characters long, contain only lowercase letters, digits, hyphens and underscores, start with a lowercase letter, and end with a lowercase letter or a digit.
         */
    ...
    export interface Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance {
        ...
        /**
         * Output only. Instance resource name formatted as: `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`. Name should not be populated when creating an instance since it is provided in the `instanceid` field.
         */
        name?: string | null;
        /**
