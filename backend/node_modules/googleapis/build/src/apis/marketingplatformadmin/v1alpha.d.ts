...
export declare namespace marketingplatformadmin_v1alpha {
    ...
    export interface Schema$AnalyticsAccountLink {
        /**
         * Required. Immutable. The resource name of the AnalyticsAdmin API account. The account ID will be used as the ID of this AnalyticsAccountLink resource, which will become the final component of the resource name. Format: analyticsadmin.googleapis.com/accounts/{accountid\}
         */
        ...
        /**
         * Identifier. Resource name of this AnalyticsAccountLink. Note the resource ID is the same as the ID of the Analtyics account. Format: organizations/{orgid\}/analyticsAccountLinks/{analytics_account_linkid\} Example: "organizations/xyz/analyticsAccountLinks/1234"
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$Organization {
        ...
        displayName?: string | null;
        /**
         * Identifier. The resource name of the GMP organization. Format: organizations/{orgid\}
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$SetPropertyServiceLevelRequest {
        /**
         * Required. The Analytics property to change the ServiceLevel setting. This field is the name of the Google Analytics Admin API property resource. Format: analyticsadmin.googleapis.com/properties/{propertyid\}
         */
    ...
    export class Resource$Organizations {
         ...
         *     // Required. The name of the Organization to retrieve. Format: organizations/{orgid\}
    ...
    export class Resource$Organizations$Analyticsaccountlinks {
         ...
         *       // Required. The parent resource where this Analytics account link will be created. Format: organizations/{orgid\}
         ...
         *       // Required. The name of the Analytics account link to delete. Format: organizations/{orgid\}/analyticsAccountLinks/{analytics_account_linkid\}
         ...
         *       // Required. The parent organization, which owns this collection of Analytics account links. Format: organizations/{orgid\}
         *       parent: 'organizations/my-organization',
         *     });
         *   console.log(res.data);
         *
         ...
         *       {
         *         // Required. The parent AnalyticsAccountLink scope where this property is in. Format: organizations/{orgid\}/analyticsAccountLinks/{analytics_account_linkid\}
