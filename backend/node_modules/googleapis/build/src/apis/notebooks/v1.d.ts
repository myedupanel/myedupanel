...
export declare namespace notebooks_v1 {
    ...
    export interface Schema$ContainerImage {
        /**
         * Required. The path to the container image repository. For example: `gcr.io/{projectid\}/{image_name\}`
         */
    ...
    export interface Schema$Instance {
        ...
        /**
         * Input only. The KMS key used to encrypt the disks, only applicable if disk_encryption is CMEK. Format: `projects/{projectid\}/locations/{location\}/keyRings/{key_ringid\}/cryptoKeys/{keyid\}` Learn more about [using your own encryption keys](/kms/docs/quickstart).
         */
        kmsKey?: string | null;
        /**
        ...
        name?: string | null;
        /**
         * The name of the VPC that this instance is in. Format: `projects/{projectid\}/global/networks/{networkid\}`
         */
        network?: string | null;
        /**
        ...
        state?: string | null;
        /**
         * The name of the subnet that this instance is in. Format: `projects/{projectid\}/regions/{region\}/subnetworks/{subnetworkid\}`
         */
        subnet?: string | null;
        /**
    ...
    export interface Schema$ListExecutionsResponse {
        ...
        nextPageToken?: string | null;
        /**
         * Executions IDs that could not be reached. For example: ['projects/{projectid\}/location/{location\}/executions/imagenet_test1', 'projects/{projectid\}/location/{location\}/executions/classifier_train1']
         */
        unreachable?: string[] | null;
    }
    /**
    ...
    export interface Schema$ListSchedulesResponse {
        ...
        /**
         * Schedules that could not be reached. For example: ['projects/{projectid\}/location/{location\}/schedules/monthly_digest', 'projects/{projectid\}/location/{location\}/schedules/weekly_sentiment']
         */
        unreachable?: string[] | null;
    }
    /**
    ...
    export interface Schema$MigrateRuntimeRequest {
        /**
         * Optional. Name of the VPC that the new Instance is in. This is required if the Runtime uses google-managed network. If the Runtime uses customer-owned network, it will reuse the same VPC, and this field must be empty. Format: `projects/{projectid\}/global/networks/{networkid\}`
         */
        network?: string | null;
        /**
         * Optional. Specifies the behavior of post startup script during migration.
        ...
        serviceAccount?: string | null;
        /**
         * Optional. Name of the subnet that the new Instance is in. This is required if the Runtime uses google-managed network. If the Runtime uses customer-owned network, it will reuse the same subnet, and this field must be empty. Format: `projects/{projectid\}/regions/{region\}/subnetworks/{subnetworkid\}`
         */
        subnet?: string | null;
    }
    /**
    ...
    export interface Schema$VirtualMachineConfig {
        ...
        /**
         * Optional. The Compute Engine network to be used for machine communications. Cannot be specified with subnetwork. If neither `network` nor `subnet` is specified, the "default" network of the project is used, if it exists. A full URL or partial URI. Examples: * `https://www.googleapis.com/compute/v1/projects/[projectid]/global/networks/default` * `projects/[projectid]/global/networks/default` Runtimes are managed resources inside Google Infrastructure. Runtimes support the following network configurations: * Google Managed Network (Network & subnet are empty) * Consumer Project VPC (network & subnet are required). Requires configuring Private Service Access. * Shared VPC (network & subnet are required). Requires configuring Private Service Access.
         */
        network?: string | null;
        /**
         * Optional. The type of vNIC to be used on this interface. This may be gVNIC or VirtioNet.
        ...
        /**
         * Optional. The Compute Engine subnetwork to be used for machine communications. Cannot be specified with network. A full URL or partial URI are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/[projectid]/regions/us-east1/subnetworks/sub0` * `projects/[projectid]/regions/us-east1/subnetworks/sub0`
         */
        subnet?: string | null;
        /**
         * Optional. The Compute Engine network tags to add to runtime (see [Add network tags](https://cloud.google.com/vpc/docs/add-remove-network-tags)).
    ...
    export class Resource$Projects$Locations$Executions {
         ...
         *     // Required. Format: `projects/{projectid\}/locations/{location\}/executions/{executionid\}`
         ...
         *     // Filter applied to resulting executions. Currently only supports filtering executions by a specified `scheduleid`. Format: `scheduleid=`
         *     filter: 'placeholder-value',
         *     // Sort by field.
    ...
    export class Resource$Projects$Locations$Runtimes {
         ...
         *     // Required. Format: `projects/{projectid\}/locations/{location\}/runtimes/{runtimesid\}`
         *     name: 'projects/my-project/locations/my-location/runtimes/my-runtime',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Locations$Schedules {
         ...
         *     // Required. Format: `parent=projects/{projectid\}/locations/{location\}/schedules/{scheduleid\}`
         *     name: 'projects/my-project/locations/my-location/schedules/my-schedule',
         *
         *     // Request body metadata
         *     requestBody: {
