...
export declare namespace notebooks_v2 {
    ...
    export interface Schema$BootDisk {
        ...
        /**
         * Optional. Input only. The KMS key used to encrypt the disks, only applicable if disk_encryption is CMEK. Format: `projects/{projectid\}/locations/{location\}/keyRings/{key_ringid\}/cryptoKeys/{keyid\}` Learn more about using your own encryption keys.
         */
        kmsKey?: string | null;
    }
    /**
    ...
    export interface Schema$NetworkInterface {
        ...
        /**
         * Optional. The name of the VPC that this VM instance is in. Format: `projects/{projectid\}/global/networks/{networkid\}`
         */
        network?: string | null;
        /**
        ...
        nicType?: string | null;
        /**
         * Optional. The name of the subnet that this VM instance is in. Format: `projects/{projectid\}/regions/{region\}/subnetworks/{subnetworkid\}`
         */
        subnet?: string | null;
    }
    /**
    ...
    export class Resource$Projects$Locations$Instances {
         ...
         *     // Required. Format: `projects/{project\}/locations/{location\}/instances/{instanceid\}`
         *     name: 'projects/my-project/locations/my-location/instances/my-instance',
         *
         *     // Request body metadata
         *     requestBody: {
