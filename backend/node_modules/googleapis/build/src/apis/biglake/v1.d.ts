...
export declare namespace biglake_v1 {
    ...
    export interface Schema$Catalog {
        ...
        /**
         * Output only. The resource name. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Database {
        ...
        /**
         * Output only. The resource name. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}
         */
        name?: string | null;
        /**
         * The database type.
    ...
    export interface Schema$RenameTableRequest {
        /**
         * Required. The new `name` for the specified table, must be in the same database. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}/tables/{tableid\}
         */
        newName?: string | null;
    }
    /**
    ...
    export interface Schema$Table {
        ...
        /**
         * Output only. The resource name. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}/tables/{tableid\}
         */
        name?: string | null;
        /**
         * The table type.
    ...
    export class Resource$Projects$Locations$Catalogs {
         ...
         *     // Required. The parent resource where this catalog will be created. Format: projects/{projectid_or_number\}/locations/{locationid\}
         ...
         *     // Required. The name of the catalog to delete. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}
         ...
         *     // Required. The name of the catalog to retrieve. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The parent, which owns this collection of catalogs. Format: projects/{projectid_or_number\}/locations/{locationid\}
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Catalogs$Databases {
         ...
         *     // Required. The parent resource where this database will be created. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}
         ...
         *     // Required. The name of the database to delete. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}
         ...
         *     // Required. The name of the database to retrieve. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/databases/my-database',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent, which owns this collection of databases. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}
         *     parent: 'projects/my-project/locations/my-location/catalogs/my-catalog',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Catalogs$Databases$Tables {
         ...
         *     {
         *       // Required. The parent resource where this table will be created. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}
         *       parent:
         ...
         *     {
         *       // Required. The name of the table to delete. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}/tables/{tableid\}
         ...
         *     // Required. The name of the table to retrieve. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}/tables/{tableid\}
         *     name: 'projects/my-project/locations/my-location/catalogs/my-catalog/databases/my-database/tables/my-table',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent, which owns this collection of tables. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}
         *     parent:
         *       'projects/my-project/locations/my-location/catalogs/my-catalog/databases/my-database',
         ...
         *     {
         *       // Required. The table's `name` field is used to identify the table to rename. Format: projects/{projectid_or_number\}/locations/{locationid\}/catalogs/{catalogid\}/databases/{databaseid\}/tables/{tableid\}
         *       name: 'projects/my-project/locations/my-location/catalogs/my-catalog/databases/my-database/tables/my-table',
         *
         *       // Request body metadata
         *       requestBody: {
