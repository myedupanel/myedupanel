...
export declare namespace eventarc_v1 {
    ...
    export class Resource$Projects$Locations$Providers {
         ...
         *     filter: 'placeholder-value',
         *     // The sorting order of the resources returned. Value should be a comma-separated list of fields. The default sorting oder is ascending. To specify descending order for a field, append a `desc` suffix; for example: `name desc, id`.
         *     orderBy: 'placeholder-value',
