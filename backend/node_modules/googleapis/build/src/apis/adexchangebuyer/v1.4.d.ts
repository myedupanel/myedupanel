...
export declare namespace adexchangebuyer_v1_4 {
    ...
    export interface Schema$Product {
        ...
        /**
         * Marketplace publisher profile Id. This Id differs from the regular publisher_profileid in that 1. This is a new id, the old Id will be deprecated in 2017. 2. This id uniquely identifies a publisher profile by itself.
         */
        ...
        productId?: string | null;
        /**
         * Id of the publisher profile for a given seller. A (seller.accountid, publisher_profileid) pair uniquely identifies a publisher profile. Buyers can call the PublisherProfiles::List endpoint to get a list of publisher profiles for a given seller.
         */
    ...
    export interface Schema$PublisherProfileApiProto {
        ...
        /**
         * The pair of (seller.accountid, profileid) uniquely identifies a publisher profile for a given publisher.
         */
    ...
    export class Resource$Marketplacedeals {
         ...
         *     // The proposalId to get deals for. To search across all proposals specify orderid = '-' as part of the URL.
         *     proposalId: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Marketplacenotes {
         ...
         *     pqlQuery: 'placeholder-value',
         *     // The proposalId to get notes for. To search across all proposals specify orderid = '-' as part of the URL.
         *     proposalId: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
