...
export declare namespace storagebatchoperations_v1 {
    ...
    export interface Schema$CancelJobRequest {
        /**
         * Optional. An optional request ID to identify requests. Specify a unique request ID in case you need to retry your request. Requests with same `requestid` will be ignored for at least 60 minutes since the first request. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
         */
    ...
    export interface Schema$Job {
        ...
        /**
         * Identifier. The resource name of the Job. jobid is unique within the project, that is either set by the customer or defined by the service. Format: projects/{project\}/locations/global/jobs/{jobid\} . For example: "projects/123456/locations/global/jobs/job01".
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Jobs {
         ...
         *     // Required. The optional `jobid` for this Job . If not specified, an id is generated. `jobid` should be no more than 128 characters and must include only characters available in DNS names, as defined by RFC-1123.
         ...
         *     // Required. `name` of the job to retrieve. Format: projects/{projectid\}/locations/global/jobs/{jobid\} .
         *     name: 'projects/my-project/locations/my-location/jobs/my-job',
         *   });
         *   console.log(res.data);
         *
