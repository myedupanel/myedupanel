...
export declare namespace cloudcommerceprocurement_v1 {
    ...
    export interface Schema$Account {
        ...
        /**
         * Output only. The resource name of the account. Account names have the form `accounts/{accountid\}`.
         */
        name?: string | null;
        /**
        ...
        /**
         * Output only. The reseller parent billing account of the account's corresponding billing account, applicable only when the corresponding billing account is a subaccount of a reseller. Included in responses only for view: ACCOUNT_VIEW_FULL. Format: billingAccounts/{billing_accountid\}
         */
    ...
    export interface Schema$ApproveEntitlementRequest {
        /**
         * Optional. The resource name of the entitlement that was migrated, with the format `providers/{providerid\}/entitlements/{entitlementid\}`. Should only be sent when resources have been migrated from entitlement_migrated to the new entitlement. Optional.
         */
    ...
    export interface Schema$Entitlement {
        ...
        /**
         * Output only. The resource name of the entitlement. Entitlement names have the form `providers/{providerid\}/entitlements/{entitlementid\}`.
         */
        name?: string | null;
        /**
