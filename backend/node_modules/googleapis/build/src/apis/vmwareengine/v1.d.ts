...
export declare namespace vmwareengine_v1 {
    ...
    export interface Schema$ManagementDnsZoneBinding {
        ...
        updateTime?: string | null;
        /**
         * Network to bind is a VMware Engine network. Specify the name in the following form for VMware engine network: `projects/{project\}/locations/global/vmwareEngineNetworks/{vmware_engine_networkid\}`. `{project\}` can either be a project number or a project ID.
         */
        vmwareEngineNetwork?: string | null;
        /**
         * Network to bind is a standard consumer VPC. Specify the name in the following form for consumer VPC network: `projects/{project\}/global/networks/{networkid\}`. `{project\}` can either be a project number or a project ID.
         */
    ...
    export interface Schema$NetworkConfig {
        ...
        /**
         * Optional. The relative resource name of the VMware Engine network attached to the private cloud. Specify the name in the following form: `projects/{project\}/locations/{location\}/vmwareEngineNetworks/{vmware_engine_networkid\}` where `{project\}` can either be a project number or a project ID.
         */
        vmwareEngineNetwork?: string | null;
        /**
         * Output only. The canonical name of the VMware Engine network in the form: `projects/{project_number\}/locations/{location\}/vmwareEngineNetworks/{vmware_engine_networkid\}`
         */
    ...
    export interface Schema$NetworkPeering {
        ...
        peerMtu?: number | null;
        /**
         * Required. The relative resource name of the network to peer with a standard VMware Engine network. The provided network can be a consumer VPC network or another standard VMware Engine network. If the `peer_network_type` is VMWARE_ENGINE_NETWORK, specify the name in the form: `projects/{project\}/locations/global/vmwareEngineNetworks/{vmware_engine_networkid\}`. Otherwise specify the name in the form: `projects/{project\}/global/networks/{networkid\}`, where `{project\}` can either be a project number or a project ID.
         */
        ...
        updateTime?: string | null;
        /**
         * Required. The relative resource name of the VMware Engine network. Specify the name in the following form: `projects/{project\}/locations/{location\}/vmwareEngineNetworks/{vmware_engine_networkid\}` where `{project\}` can either be a project number or a project ID.
         */
        vmwareEngineNetwork?: string | null;
    }
    /**
    ...
    export interface Schema$NetworkPolicy {
        ...
        updateTime?: string | null;
        /**
         * Optional. The relative resource name of the VMware Engine network. Specify the name in the following form: `projects/{project\}/locations/{location\}/vmwareEngineNetworks/{vmware_engine_networkid\}` where `{project\}` can either be a project number or a project ID.
         */
        vmwareEngineNetwork?: string | null;
        /**
         * Output only. The canonical name of the VMware Engine network in the form: `projects/{project_number\}/locations/{location\}/vmwareEngineNetworks/{vmware_engine_networkid\}`
    ...
    export interface Schema$PrivateConnection {
        ...
        /**
         * Required. Service network to create private connection. Specify the name in the following form: `projects/{project\}/global/networks/{networkid\}` For type = PRIVATE_SERVICE_ACCESS, this field represents servicenetworking VPC, e.g. projects/project-tp/global/networks/servicenetworking. For type = NETAPP_CLOUD_VOLUME, this field represents NetApp service VPC, e.g. projects/project-tp/global/networks/netapp-tenant-vpc. For type = DELL_POWERSCALE, this field represent Dell service VPC, e.g. projects/project-tp/global/networks/dell-tenant-vpc. For type= THIRD_PARTY_SERVICE, this field could represent a consumer VPC or any other producer VPC to which the VMware Engine Network needs to be connected, e.g. projects/project/global/networks/vpc.
         */
        ...
        updateTime?: string | null;
        /**
         * Required. The relative resource name of Legacy VMware Engine network. Specify the name in the following form: `projects/{project\}/locations/{location\}/vmwareEngineNetworks/{vmware_engine_networkid\}` where `{project\}`, `{location\}` will be same as specified in private connection resource name and `{vmware_engine_networkid\}` will be in the form of `{location\}`-default e.g. projects/project/locations/us-central1/vmwareEngineNetworks/us-central1-default.
         */
        vmwareEngineNetwork?: string | null;
        /**
         * Output only. The canonical name of the VMware Engine network in the form: `projects/{project_number\}/locations/{location\}/vmwareEngineNetworks/{vmware_engine_networkid\}`
