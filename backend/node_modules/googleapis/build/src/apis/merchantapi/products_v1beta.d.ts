...
export declare namespace merchantapi_products_v1beta {
    ...
    export interface Schema$Product {
        ...
        /**
         * The name of the product. Format: `accounts/{account\}/products/{product\}` where the last section `product` consists of: `content_language~feed_label~offerid` example for product name is `accounts/123/products/en~US~sku123`. A legacy local product name would be `accounts/123/products/local~en~US~sku123`. Note: For calls to the v1beta version, the `product` section consists of: `channel~content_language~feed_label~offerid`, for example: `accounts/123/products/online~en~US~sku123`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ProductInput {
        ...
        feedLabel?: string | null;
        /**
         * Identifier. The name of the product input. Format: `accounts/{account\}/productInputs/{productinput\}` where the last section `productinput` consists of: `content_language~feed_label~offerid` example for product input name is `accounts/123/productInputs/en~US~sku123`. A legacy local product input name would be `accounts/123/productInputs/local~en~US~sku123`. Note: For calls to the v1beta version, the `productInput` section consists of: `channel~content_language~feed_label~offerid`, for example: `accounts/123/productInputs/online~en~US~sku123`.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Accounts$Productinputs {
         ...
         *     // Required. The name of the product input resource to delete. Format: `accounts/{account\}/productInputs/{product\}` where the last section `product` consists of: `content_language~feed_label~offerid` example for product name is `accounts/123/productInputs/en~US~sku123`.
    ...
    export class Resource$Accounts$Products {
         ...
         *     // Required. The name of the product to retrieve. Format: `accounts/{account\}/products/{product\}` where the last section `product` consists of: `content_language~feed_label~offerid` example for product name is `accounts/123/products/en~US~sku123`. A legacy local product name would be `accounts/123/products/local~en~US~sku123`. Note: For calls to the v1beta version, the `product` section consists of: `channel~content_language~feed_label~offerid`, for example: `accounts/123/products/online~en~US~sku123`.
