...
export declare namespace memcache_v1beta2 {
    ...
    export interface Schema$Instance {
        ...
        memcacheVersion?: string | null;
        /**
         * Required. Unique name of the resource in this scope including project and location using the form: `projects/{projectid\}/locations/{locationid\}/instances/{instanceid\}` Note: Memcached instances are managed and addressed at the regional level so `locationid` here refers to a Google Cloud region; however, users may choose which zones Memcached nodes should be provisioned in within an instance. Refer to zones field for more details.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ListInstancesResponse {
        ...
        /**
         * A list of Memcached instances in the project in the specified location, or across all locations. If the `locationid` in the parent field of the request is "-", all regions available to the project are queried, and the results aggregated.
         */
    ...
    export class Resource$Projects$Locations$Instances {
         ...
         *     // Required. Memcached instance resource name in the format: `projects/{projectid\}/locations/{locationid\}/instances/{instanceid\}` where `locationid` refers to a GCP region
         *     name: 'projects/my-project/locations/my-location/instances/my-instance',
         *   });
         *   console.log(res.data);
         *
         ...
         *     {
         *       // Required. Memcache instance resource name using the form: `projects/{projectid\}/locations/{locationid\}/instances/{instanceid\}` where `locationid` refers to a GCP region.
         *       instance:
