...
export declare namespace realtimebidding_v1alpha {
    ...
    export interface Schema$BiddingFunction {
        ...
        /**
         * The name of the bidding function that must follow the pattern: `bidders/{bidder_accountid\}/biddingFunctions/{bidding_function_name\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Params$Resource$Bidders$Biddingfunctions$Activate extends StandardParameters {
        /**
         * Required. The name of the bidding function to activate. Format: `bidders/{bidder_accountid\}/biddingFunction/{bidding_function_name\}`
         */
        name?: string;
        /**
    ...
    export interface Params$Resource$Bidders$Biddingfunctions$Archive extends StandardParameters {
        /**
         * Required. The name of the bidding function to archive. Format: `bidders/{bidder_accountid\}/biddingFunction/{bidding_function_name\}`
         */
        name?: string;
        /**
         * Request body metadata
    ...
    export interface Params$Resource$Bidders$Biddingfunctions$List extends StandardParameters {
        ...
        pageToken?: string;
        /**
         * Required. Name of the bidder whose bidding functions will be listed. Format: `bidders/{bidder_accountid\}`
         */
        parent?: string;
    }
    export {};
