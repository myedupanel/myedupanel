...
export declare namespace addressvalidation_v1 {
    ...
    export interface Schema$GoogleMapsAddressvalidationV1ProvideValidationFeedbackRequest {
        ...
        /**
         * Required. The ID of the response that this feedback is for. This should be the responseid from the first response in a series of address validation attempts.
         */
