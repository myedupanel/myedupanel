...
export declare namespace contentwarehouse_v1 {
    ...
    export interface Schema$GoogleCloudContentwarehouseV1AddToFolderAction {
        /**
         * Names of the folder under which new document is to be added. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\}.
         */
        folders?: string[] | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudContentwarehouseV1CreateDocumentLinkRequest {
        /**
         * Required. Document links associated with the source documents (source_documentid).
         */
    ...
    export interface Schema$GoogleCloudContentwarehouseV1Document {
        ...
        /**
         * The Document schema name. Format: projects/{project_number\}/locations/{location\}/documentSchemas/{document_schemaid\}.
         */
        ...
        /**
         * The resource name of the document. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\}. The name is ignored when creating a document.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudContentwarehouseV1DocumentLink {
        ...
        /**
         * Name of this document-link. It is required that the parent derived form the name to be consistent with the source document reference. Otherwise an exception will be thrown. Format: projects/{project_number\}/locations/{location\}/documents/{source_documentid\}/documentLinks/{document_linkid\}.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudContentwarehouseV1DocumentQuery {
        ...
        /**
         * Search the documents in the list. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\}.
         */
        ...
        /**
         * Search all the documents under this specified folder. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\}.
         */
    ...
    export interface Schema$GoogleCloudContentwarehouseV1DocumentSchema {
        ...
        documentIsFolder?: boolean | null;
        /**
         * The resource name of the document schema. Format: projects/{project_number\}/locations/{location\}/documentSchemas/{document_schemaid\}. The name is ignored when creating a document schema.
         */
        name?: string | null;
        /**
         * Document details.
    ...
    export interface Schema$GoogleCloudContentwarehouseV1ExportToCdwPipeline {
        ...
        /**
         * The list of all the resource names of the documents to be processed. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\}.
         */
    ...
    export interface Schema$GoogleCloudContentwarehouseV1GcsIngestPipeline {
        ...
        /**
         * The Document Warehouse schema resource name. All documents processed by this pipeline will use this schema. Format: projects/{project_number\}/locations/{location\}/documentSchemas/{document_schemaid\}.
         */
    ...
    export interface Schema$GoogleCloudContentwarehouseV1HistogramQueryPropertyNameFilter {
        /**
         * This filter specifies the exact document schema(s) Document.document_schema_name to run histogram query against. It is optional. It will perform histogram for property names for all the document schemas if it is not set. At most 10 document schema names are allowed. Format: projects/{project_number\}/locations/{location\}/documentSchemas/{document_schemaid\}.
         */
    ...
    export interface Schema$GoogleCloudContentwarehouseV1IngestPipelineConfig {
        ...
        /**
         * Optional. The name of the folder to which all ingested documents will be linked during ingestion process. Format is `projects/{project\}/locations/{location\}/documents/{folderid\}`
         */
        folder?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudContentwarehouseV1ProcessorInfo {
        ...
        /**
         * The Document schema resource name. All documents processed by this processor will use this schema. Format: projects/{project_number\}/locations/{location\}/documentSchemas/{document_schemaid\}.
         */
        schemaName?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudContentwarehouseV1PropertyFilter {
        ...
        /**
         * The Document schema name Document.document_schema_name. Format: projects/{project_number\}/locations/{location\}/documentSchemas/{document_schemaid\}.
         */
        documentSchemaName?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudContentwarehouseV1RemoveFromFolderAction {
        ...
        condition?: string | null;
        /**
         * Name of the folder under which new document is to be added. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\}.
         */
        folder?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudContentwarehouseV1RuleSet {
        ...
        description?: string | null;
        /**
         * The resource name of the rule set. Managed internally. Format: projects/{project_number\}/locations/{location\}/ruleSet/{rule_setid\}. The name is ignored when creating a rule set.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDocumentaiV1DocumentPageDetectedLanguage {
        ...
        confidence?: number | null;
        /**
         * The [BCP-47 language code](https://www.unicode.org/reports/tr35/#Unicode_localeidentifier), such as `en-US` or `sr-Latn`.
         */
    ...
    export class Resource$Projects {
         ...
         *     // Required. REQUIRED: The resource for which the policy is being requested. Format for document: projects/{project_number\}/locations/{location\}/documents/{documentid\}. Format for collection: projects/{project_number\}/locations/{location\}/collections/{collectionid\}. Format for project: projects/{project_number\}.
    ...
    export class Resource$Projects$Locations$Documents {
         ...
         *     // Required. The name of the document to delete. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\} or projects/{project_number\}/locations/{location\}/documents/referenceId/{referenceid\}.
         ...
         *     // Required. The name of the document to retrieve. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\} or projects/{project_number\}/locations/{location\}/documents/referenceId/{referenceid\}.
         *     name: 'projects/my-project/locations/my-location/documents/my-document',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     {
         *       // Required. The name of the document, for which all source links are returned. Format: projects/{project_number\}/locations/{location\}/documents/{source_documentid\}.
         ...
         *     {
         *       // Required. The name of the document, for which all target links are returned. Format: projects/{project_number\}/locations/{location\}/documents/{target_documentid\}.
         *       parent: 'projects/my-project/locations/my-location/documents/my-document',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *     // Required. The name of the document to update. Format: projects/{project_number\}/locations/{location\}/documents/{documentid\} or projects/{project_number\}/locations/{location\}/documents/referenceId/{referenceid\}.
         *     name: 'projects/my-project/locations/my-location/documents/my-document',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Locations$Documents$Documentlinks {
         ...
         *       // Required. Parent of the document-link to be created. parent of document-link should be a document. Format: projects/{project_number\}/locations/{location\}/documents/{source_documentid\}.
         *       parent: 'projects/my-project/locations/my-location/documents/my-document',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *       // Required. The name of the document-link to be deleted. Format: projects/{project_number\}/locations/{location\}/documents/{source_documentid\}/documentLinks/{document_linkid\}.
    ...
    export class Resource$Projects$Locations$Documentschemas {
         ...
         *     // Required. The name of the document schema to update. Format: projects/{project_number\}/locations/{location\}/documentSchemas/{document_schemaid\}.
         *     name: 'projects/my-project/locations/my-location/documentSchemas/my-documentSchema',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Locations$Rulesets {
         ...
         *     // Required. The name of the rule set to delete. Format: projects/{project_number\}/locations/{location\}/ruleSets/{rule_setid\}.
         ...
         *     // Required. The name of the rule set to retrieve. Format: projects/{project_number\}/locations/{location\}/ruleSets/{rule_setid\}.
         *     name: 'projects/my-project/locations/my-location/ruleSets/my-ruleSet',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The name of the rule set to update. Format: projects/{project_number\}/locations/{location\}/ruleSets/{rule_setid\}.
         *     name: 'projects/my-project/locations/my-location/ruleSets/my-ruleSet',
         *
         *     // Request body metadata
         *     requestBody: {
