...
export declare namespace servicecontrol_v1 {
    ...
    export interface Schema$Attributes {
        /**
         * The set of attributes. Each attribute's key can be up to 128 bytes long. The value can be a string up to 256 bytes, a signed 64-bit integer, or the Boolean values `true` and `false`. For example: "/instanceid": "my-instance" "/http/user_agent": "" "/http/request_bytes": 300 "example.com/myattribute": true
         */
        attributeMap?: {
    ...
    export interface Schema$Auth {
        /**
         * A list of access level resource names that allow resources to be accessed by authenticated requester. It is part of Secure GCP processing for the incoming request. An access level string has the format: "//{api_service_name\}/accessPolicies/{policyid\}/accessLevels/{short_name\}" Example: "//accesscontextmanager.googleapis.com/accessPolicies/MY_POLICY_ID/accessLevels/MY_LEVEL"
         */
    ...
    export interface Schema$CheckInfo {
        ...
        /**
         * Whether or not the api key should be ignored in the credentialid during reporting.
         */
    ...
    export interface Schema$QuotaOperation {
        ...
        methodName?: string | null;
        /**
         * Identity of the operation. For Allocation Quota, this is expected to be unique within the scope of the service that generated the operation, and guarantees idempotency in case of retries. In order to ensure best performance and latency in the Quota backends, operationids are optimally associated with time, so that related operations can be accessed fast in storage. For this reason, the recommended token for services that intend to operate at a high QPS is Unix time in nanos + UUID
         */
        operationId?: string | null;
        /**
    ...
    export interface Schema$ReportError {
        /**
         * The Operation.operationid value from the request.
         */
        operationId?: string | null;
        /**
