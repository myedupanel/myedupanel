...
export declare namespace docs_v1 {
    ...
    export interface Schema$DocumentStyle {
        ...
        /**
         * The ID of the footer used only for even pages. The value of use_even_page_header_footer determines whether to use the default_footerid or this value for the footer on even pages. If not set, there's no even page footer. This property is read-only.
         */
        evenPageFooterId?: string | null;
        /**
         * The ID of the header used only for even pages. The value of use_even_page_header_footer determines whether to use the default_headerid or this value for the header on even pages. If not set, there's no even page header. This property is read-only.
         */
        evenPageHeaderId?: string | null;
        /**
         * The ID of the footer used only for the first page. If not set then a unique footer for the first page does not exist. The value of use_first_page_header_footer determines whether to use the default_footerid or this value for the footer on the first page. If not set, there's no first page footer. This property is read-only.
         */
        firstPageFooterId?: string | null;
        /**
         * The ID of the header used only for the first page. If not set then a unique header for the first page does not exist. The value of use_first_page_header_footer determines whether to use the default_headerid or this value for the header on the first page. If not set, there's no first page header. This property is read-only.
         */
    ...
    export interface Schema$DocumentStyleSuggestionState {
        ...
        /**
         * Indicates if there was a suggested change to default_footerid.
         */
        defaultFooterIdSuggested?: boolean | null;
        /**
         * Indicates if there was a suggested change to default_headerid.
         */
        defaultHeaderIdSuggested?: boolean | null;
        /**
         * Indicates if there was a suggested change to even_page_footerid.
         */
        evenPageFooterIdSuggested?: boolean | null;
        /**
         * Indicates if there was a suggested change to even_page_headerid.
         */
        evenPageHeaderIdSuggested?: boolean | null;
        /**
         * Indicates if there was a suggested change to first_page_footerid.
         */
        firstPageFooterIdSuggested?: boolean | null;
        /**
         * Indicates if there was a suggested change to first_page_headerid.
         */
    ...
    export interface Schema$Location {
        /**
         * The zero-based index, in UTF-16 code units. The index is relative to the beginning of the segment specified by segmentid.
         */
        index?: number | null;
        /**
         * The ID of the header, footer or footnote the location is in. An empty segment ID signifies the document's body.
    ...
    export interface Schema$SectionStyle {
        ...
        /**
         * The ID of the default footer. If unset, the value inherits from the previous SectionBreak's SectionStyle. If the value is unset in the first SectionBreak, it inherits from DocumentStyle's default_footerid. This property is read-only.
         */
        defaultFooterId?: string | null;
        /**
         * The ID of the default header. If unset, the value inherits from the previous SectionBreak's SectionStyle. If the value is unset in the first SectionBreak, it inherits from DocumentStyle's default_headerid. This property is read-only.
         */
        defaultHeaderId?: string | null;
        /**
         * The ID of the footer used only for even pages. If the value of DocumentStyle's use_even_page_header_footer is true, this value is used for the footers on even pages in the section. If it is false, the footers on even pages use the default_footerid. If unset, the value inherits from the previous SectionBreak's SectionStyle. If the value is unset in the first SectionBreak, it inherits from DocumentStyle's even_page_footerid. This property is read-only.
         */
        evenPageFooterId?: string | null;
        /**
         * The ID of the header used only for even pages. If the value of DocumentStyle's use_even_page_header_footer is true, this value is used for the headers on even pages in the section. If it is false, the headers on even pages use the default_headerid. If unset, the value inherits from the previous SectionBreak's SectionStyle. If the value is unset in the first SectionBreak, it inherits from DocumentStyle's even_page_headerid. This property is read-only.
         */
        evenPageHeaderId?: string | null;
        /**
         * The ID of the footer used only for the first page of the section. If use_first_page_header_footer is true, this value is used for the footer on the first page of the section. If it's false, the footer on the first page of the section uses the default_footerid. If unset, the value inherits from the previous SectionBreak's SectionStyle. If the value is unset in the first SectionBreak, it inherits from DocumentStyle's first_page_footerid. This property is read-only.
         */
        firstPageFooterId?: string | null;
        /**
         * The ID of the header used only for the first page of the section. If use_first_page_header_footer is true, this value is used for the header on the first page of the section. If it's false, the header on the first page of the section uses the default_headerid. If unset, the value inherits from the previous SectionBreak's SectionStyle. If the value is unset in the first SectionBreak, it inherits from DocumentStyle's first_page_headerid. This property is read-only.
         */
        firstPageHeaderId?: string | null;
        /**
