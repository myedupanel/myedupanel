...
export declare namespace mybusinessbusinessinformation_v1 {
    ...
    export interface Schema$Category {
        /**
         * Output only. The human-readable name of the category. This is set when reading the location. When modifying the location, `categoryid` must be set.
         */
        displayName?: string | null;
        /**
    ...
    export interface Schema$Chain {
        ...
        /**
         * Required. The chain's resource name, in the format `chains/{chainid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$FreeFormServiceItem {
        /**
         * Required. This field represents the category name (i.e. the category's stable ID). The `category` and `service_typeid` should match the possible combinations provided in the `Category` message.
         */
        category?: string | null;
        /**
         * Required. Language-tagged labels for the item. We recommend that item names be 140 characters or less, and descriptions 250 characters or less. This field should only be set if the input is a custom service item. Standardized service types should be updated via service_typeid.
         */
        label?: Schema$Label;
    }
    /**
    ...
    export interface Schema$StructuredServiceItem {
        ...
        description?: string | null;
        /**
         * Required. The `service_typeid` field is a Google provided unique ID that can be found in `ServiceType`. This information is provided by `BatchGetCategories` rpc service.
         */
        serviceTypeId?: string | null;
    }
    /**
    ...
    export class Resource$Attributes {
         ...
         *     // The primary category stable ID to find available attributes. Must be of the format categories/{categoryid\}.
    ...
    export class Resource$Chains {
         ...
         *     // Required. The chain's resource name, in the format `chains/{chain_placeid\}`.
