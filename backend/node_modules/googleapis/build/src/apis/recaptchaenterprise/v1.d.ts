...
export declare namespace recaptchaenterprise_v1 {
    ...
    export interface Schema$GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest {
        /**
         * Optional. A stable account identifier to apply to the assessment. This is an alternative to setting `accountid` in `CreateAssessment`, for example when a stable account identifier is not yet known in the initial request.
         */
        ...
        /**
         * Optional. A stable hashed account identifier to apply to the assessment. This is an alternative to setting `hashed_accountid` in `CreateAssessment`, for example when a stable account identifier is not yet known in the initial request.
         */
    ...
    export interface Schema$GoogleCloudRecaptchaenterpriseV1Assessment {
        ...
        name?: string | null;
        /**
         * Output only. Assessment returned when a site key, a token, and a phone number as `userid` are provided. Account defender and SMS toll fraud protection need to be enabled.
         */
    ...
    export interface Schema$GoogleCloudRecaptchaenterpriseV1Event {
        ...
        /**
         * Optional. Deprecated: use `user_info.accountid` instead. Unique stable hashed user identifier for the request. The identifier must be hashed using hmac-sha256 with stable secret.
         */
        hashedAccountId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRecaptchaenterpriseV1IOSKeySettings {
        /**
         * Optional. If set to true, allowed_bundleids are not enforced.
         */
    ...
    export interface Schema$GoogleCloudRecaptchaenterpriseV1RelatedAccountGroupMembership {
        ...
        accountId?: string | null;
        /**
         * Deprecated: use `accountid` instead. The unique stable hashed account identifier of the member. The identifier corresponds to a `hashed_accountid` provided in a previous `CreateAssessment` or `AnnotateAssessment` call.
         */
        hashedAccountId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRecaptchaenterpriseV1SearchRelatedAccountGroupMembershipsRequest {
        /**
         * Optional. The unique stable account identifier used to search connections. The identifier should correspond to an `accountid` provided in a previous `CreateAssessment` or `AnnotateAssessment` call. Either hashed_accountid or accountid must be set, but not both.
         */
        accountId?: string | null;
        /**
         * Optional. Deprecated: use `accountid` instead. The unique stable hashed account identifier used to search connections. The identifier should correspond to a `hashed_accountid` provided in a previous `CreateAssessment` or `AnnotateAssessment` call. Either hashed_accountid or accountid must be set, but not both.
         */
        hashedAccountId?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudRecaptchaenterpriseV1TransactionDataUser {
        /**
         * Optional. Unique account identifier for this user. If using account defender, this should match the hashed_accountid field. Otherwise, a unique and persistent identifier for this account.
         */
        accountId?: string | null;
        /**
