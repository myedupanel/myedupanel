...
export declare namespace mybusinessaccountmanagement_v1 {
    ...
    export interface Schema$Account {
        ...
        /**
         * Immutable. The resource name, in the format `accounts/{accountid\}`.
         */
        name?: string | null;
        /**
        ...
        /**
         * Required. Input only. The resource name of the account which will be the primary owner of the account being created. It should be of the form `accounts/{accountid\}`.
         */
    ...
    export interface Schema$Admin {
        ...
        admin?: string | null;
        /**
         * Immutable. The resource name. For account admins, this is in the form: `accounts/{accountid\}/admins/{adminid\}` For location admins, this is in the form: `locations/{locationid\}/admins/{adminid\}` This field will be ignored if set during admin creation.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Invitation {
        /**
         * Required. The resource name for the invitation. `accounts/{accountid\}/invitations/{invitationid\}`.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Accounts {
         ...
         *     // Optional. The resource name of the account for which the list of directly accessible accounts is to be retrieved. This only makes sense for Organizations and User Groups. If empty, will return `ListAccounts` for the authenticated user. `accounts/{accountid\}`.
    ...
    export class Resource$Accounts$Admins {
         ...
         *     // Required. The resource name of the account this admin is created for. `accounts/{accountid\}`.
         ...
         *     // Required. The resource name of the admin to remove from the account. `accounts/{accountid\}/admins/{adminid\}`.
         ...
         *     // Required. The name of the account from which to retrieve a list of admins. `accounts/{accountid\}/admins`.
         *     parent: 'accounts/my-account',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Accounts$Invitations {
         ...
         *     // Required. The name of the invitation that is being accepted. `accounts/{accountid\}/invitations/{invitationid\}`
         ...
         *     // Required. The name of the account invitation that is being declined. `accounts/{accountid\}/invitations/{invitationid\}`
         *     name: 'accounts/my-account/invitations/my-invitation',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     filter: 'placeholder-value',
         *     // Required. The name of the account from which the list of invitations is being retrieved. `accounts/{accountid\}/invitations`
         *     parent: 'accounts/my-account',
         *   });
         *   console.log(res.data);
         *
