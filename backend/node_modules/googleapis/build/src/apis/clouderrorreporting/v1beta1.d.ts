...
export declare namespace clouderrorreporting_v1beta1 {
    ...
    export class Resource$Projects$Events {
         ...
         *     // Required. The group for which events shall be returned. The `groupid` is a unique identifier for a particular error group. The identifier is derived from key parts of the error-log content and is treated as Service Data. For information about how Service Data is handled, see [Google Cloud Privacy Notice](https://cloud.google.com/terms/cloud-privacy-notice).
    ...
    export class Resource$Projects$Groupstats {
         ...
         *     // Optional. List all ErrorGroupStats with these IDs. The `groupid` is a unique identifier for a particular error group. The identifier is derived from key parts of the error-log content and is treated as Service Data. For information about how Service Data is handled, see [Google Cloud Privacy Notice] (https://cloud.google.com/terms/cloud-privacy-notice).
         *     groupId: 'placeholder-value',
