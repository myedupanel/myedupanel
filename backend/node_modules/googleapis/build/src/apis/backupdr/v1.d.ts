...
export declare namespace backupdr_v1 {
    ...
    export interface Schema$BackupPlan {
        ...
        /**
         * Output only. The resource id of the `BackupPlanRevision`. Format: `projects/{project\}/locations/{location\}/backupPlans/{backup_plan\}/revisions/{revisionid\}`
         */
    ...
    export interface Schema$BackupRule {
        ...
        /**
         * Required. Immutable. The unique id of this `BackupRule`. The `ruleid` is unique per `BackupPlan`.The `ruleid` must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens. Pattern, /a-z{,62\}/.
         */
        ruleId?: string | null;
        /**
    ...
    export interface Schema$TriggerBackupRequest {
        ...
        requestId?: string | null;
        /**
         * Optional. backup ruleid for which a backup needs to be triggered. If not specified, on-demand backup with custom retention will be triggered.
         */
        ruleId?: string | null;
    }
    /**
    ...
    export class Resource$Projects$Locations$Backupplanassociations {
         ...
         *     // Required. The backup plan association project and location in the format `projects/{projectid\}/locations/{location\}`. In Cloud BackupDR locations map to GCP regions, for example **us-central1**.
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The project and location for which to retrieve backup Plan Associations information, in the format `projects/{projectid\}/locations/{location\}`. In Cloud BackupDR, locations map to GCP regions, for example **us-central1**. To retrieve backup plan associations for all locations, use "-" for the `{location\}` value.
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Backupvaults {
         ...
         *     // Required. ID of the requesting object If auto-generating ID server-side, remove this field and backup_vaultid from the method_signature of Create RPC
         ...
         *     // Required. Name of the backupvault store resource name, in the format 'projects/{projectid\}/locations/{location\}/backupVaults/{resource_name\}'
         *     name: 'projects/my-project/locations/my-location/backupVaults/my-backupVault',
    ...
    export class Resource$Projects$Locations$Backupvaults$Datasources {
         ...
         *     // Required. Name of the data source resource name, in the format 'projects/{projectid\}/locations/{location\}/backupVaults/{resource_name\}/dataSource/{resource_name\}'
         *     name: 'projects/my-project/locations/my-location/backupVaults/my-backupVault/dataSources/my-dataSource',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Backupvaults$Datasources$Backups {
         ...
         *       // Optional. A token identifying a page of results the server should return.
         *       pageToken: 'placeholder-value',
         *       // Required. The project and location for which to retrieve backup information, in the format 'projects/{projectid\}/locations/{location\}'. In Cloud Backup and DR, locations map to Google Cloud regions, for example **us-central1**. To retrieve data sources for all locations, use "-" for the '{location\}' value.
         *       parent:
         *         'projects/my-project/locations/my-location/backupVaults/my-backupVault/dataSources/my-dataSource',
         *       // Optional. Reserved for future use to provide a BASIC & FULL view of Backup resource.
         *       view: 'placeholder-value',
    ...
    export class Resource$Projects$Locations$Managementservers {
         ...
         *     // Required. Name of the management server resource name, in the format 'projects/{projectid\}/locations/{location\}/managementServers/{resource_name\}'
         *     name: 'projects/my-project/locations/my-location/managementServers/my-managementServer',
         *   });
         *   console.log(res.data);
         *
