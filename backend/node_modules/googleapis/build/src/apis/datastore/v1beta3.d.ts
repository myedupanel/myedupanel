...
export declare namespace datastore_v1beta3 {
    ...
    /**
     * Identifies a subset of entities in a project. This is specified as combinations of kinds and namespaces (either or both of which may be all, as described in the following examples). Example usage: Entire project: kinds=[], namespaceids=[] Kinds Foo and Bar in all namespaces: kinds=['Foo', 'Bar'], namespaceids=[] Kinds Foo and Bar only in the default namespace: kinds=['Foo', 'Bar'], namespaceids=[''] Kinds Foo and Bar in both the default and Baz namespaces: kinds=['Foo', 'Bar'], namespaceids=['', 'Baz'] The entire Baz namespace: kinds=[], namespaceids=['Baz']
     */
    ...
    /**
     * Metadata for Datastore to Firestore migration operations. The DatastoreFirestoreMigration operation is not started by the end-user via an explicit "creation" method. This is an intentional deviation from the LRO design pattern. This singleton resource can be accessed at: "projects/{projectid\}/operations/datastore-firestore-migration"
     */
