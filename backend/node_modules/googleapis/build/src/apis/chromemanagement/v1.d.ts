...
export declare namespace chromemanagement_v1 {
    ...
    export interface Schema$GoogleChromeManagementV1AppDetails {
        ...
        /**
         * Output only. Format: name=customers/{customerid\}/apps/{chrome|android|web\}/{appid\}@{version\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleChromeManagementV1ChromeAppRequest {
        /**
         * Output only. Format: app_details=customers/{customerid\}/apps/chrome/{appid\}
         */
    ...
    export interface Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfile {
        ...
        /**
         * Identifier. Format: customers/{customerid\}/profiles/{profile_permanentid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand {
        ...
        /**
         * Identifier. Format: customers/{customerid\}/profiles/{profile_permanentid\}/commands/{commandid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleChromeManagementVersionsV1DeviceInfo {
        ...
        /**
         * Output only. Machine name of the device on which the profile exists. On platforms which do not report the machine name (currently iOS and Android) this is instead set to the browser's deviceid - but note that this is a different deviceid than the |affiliated_deviceid|.
         */
        machine?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleChromeManagementVersionsV1ThirdPartyProfileUser {
        /**
         * Identifier. Format: customers/{customerid\}/thirdPartyProfileUsers/{third_party_profile_userid\}
         */
        name?: string | null;
        /**
    ...
    export class Resource$Customers$Certificateprovisioningprocesses {
        ...
        constructor(context: APIRequestContext);
        /**
         * Claims a certificate provisioning process. For each certificate provisioning process, this operation can succeed only for one `caller_instanceid`.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Customers$Profiles {
         ...
         *     // Required. Format: customers/{customerid\}/profiles/{profile_permanentid\}
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Format: customers/{customerid\}
    ...
    export class Resource$Customers$Profiles$Commands {
         ...
         *     // Required. Format: customers/{customerid\}/profiles/{profile_permanentid\}/commands/{commandid\}
    ...
    export class Resource$Customers$Reports {
         ...
         *     // Required. Customer id or "my_customer" to use the customer associated to the account making the request.
         *     customer: 'customers/my-customer',
         *     // Query string to filter results, AND-separated fields in EBNF syntax. Note: OR operations are not supported in this filter. Supported filter fields: * app_name * app_type * install_type * number_of_permissions * total_install_count * latest_profile_active_date * permission_name * appid * manifest_versions * risk_score
         *     filter: 'placeholder-value',
         *     // Field used to order results. Supported order by fields: * app_name * app_type * install_type * number_of_permissions * total_install_count * appid * manifest_versions * risk_score
         *     orderBy: 'placeholder-value',
         *     // The ID of the organizational unit.
         *     orgUnitId: 'placeholder-value',
         *     // Maximum number of results to return. Maximum and default are 100.
         ...
         *     // Required. Customer ID prefixed with "customers/" or "customers/my_customer" to use the customer associated to the account making the request.
         *     customer: 'customers/my-customer',
         *     // Query string to filter results, AND-separated fields in EBNF syntax. Note: OR operations are not supported in this filter. Note: Only \>= and <= comparators are supported for `complete_time`. Note: Only = comparator supported for `userid` and `printerid`. Supported filter fields: * complete_time * printerid * userid
         *     filter: 'placeholder-value',
         ...
         *     // Query string to filter results, AND-separated fields in EBNF syntax. Note: OR operations are not supported in this filter. Supported filter fields: * last_active_date
         *     filter: 'placeholder-value',
         *     // Field used to order results. Supported order by fields: * machine * deviceid
         *     orderBy: 'placeholder-value',
         *     // The ID of the organizational unit.
         *     orgUnitId: 'placeholder-value',
         *     // Maximum number of results to return. Maximum and default are 100.
    ...
    export class Resource$Customers$Telemetry$Events {
         ...
         *     // Optional. Only include resources that match the filter. Although this parameter is currently optional, this parameter will be required- please specify at least 1 event type. Supported filter fields: - deviceid - userid - device_org_unitid - user_org_unitid - timestamp - event_type The "timestamp" filter accepts either the Unix Epoch milliseconds format or the RFC3339 UTC "Zulu" format with nanosecond resolution and up to nine fractional digits. Both formats should be surrounded by simple double quotes. Examples: "2014-10-02T15:01:23Z", "2014-10-02T15:01:23.045123456Z", "1679283943823".
         *     filter: 'placeholder-value',
    ...
    export class Resource$Customers$Telemetry$Users {
         ...
         *     // Read mask to specify which fields to return. Supported read_mask paths are: - name - org_unitid - userid - user_email - user_device.deviceid - user_device.audio_status_report - user_device.device_activity_report - user_device.network_bandwidth_report - user_device.peripherals_report - user_device.app_report
         *     readMask: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Only include resources that match the filter. Supported filter fields: - userid - user_org_unitid
         *     filter: 'placeholder-value',
         *     // Maximum number of results to return. Default value is 100. Maximum value is 1000.
         *     pageSize: 'placeholder-value',
         *     // Token to specify next page in the list.
    ...
    export class Resource$Customers$Thirdpartyprofileusers {
         ...
         *     // Required. Format: customers/{customerid\}/thirdPartyProfileUsers/{third_party_profile_userid\}
