...
export declare namespace transcoder_v1 {
    ...
    export interface Schema$AudioStream {
        ...
        /**
         * The BCP-47 language code, such as `en-US` or `sr-Latn`. For more information, see https://www.unicode.org/reports/tr35/#Unicode_localeidentifier. Not supported in MP4 files.
         */
    ...
    export interface Schema$Job {
        ...
        state?: string | null;
        /**
         * Input only. Specify the `templateid` to use for populating `Job.config`. The default is `preset/web-hd`, which is the only supported preset. User defined JobTemplate: `{job_templateid\}`
         */
    ...
    export interface Schema$JobConfig {
        ...
        /**
         * List of encryption configurations for the content. Each configuration has an ID. Specify this ID in the MuxStream.encryptionid field to indicate the configuration to use for that `MuxStream` output.
         */
    ...
    export interface Schema$SecretManagerSource {
        /**
         * Required. The name of the Secret Version containing the encryption key in the following format: `projects/{project\}/secrets/{secretid\}/versions/{version_number\}` Note that only numbered versions are supported. Aliases like "latest" are not supported.
         */
    ...
    export interface Schema$TrackDefinition {
        /**
         * Output only. A list of languages detected in the input asset, represented by a BCP 47 language code, such as "en-US" or "sr-Latn". For more information, see https://www.unicode.org/reports/tr35/#Unicode_localeidentifier. This field is only populated if the detect_languages field is set to true.
         */
        ...
        inputTrack?: number | null;
        /**
         * Optional. A list of languages spoken in the input asset, represented by a BCP 47 language code, such as "en-US" or "sr-Latn". For more information, see https://www.unicode.org/reports/tr35/#Unicode_localeidentifier.
         */
