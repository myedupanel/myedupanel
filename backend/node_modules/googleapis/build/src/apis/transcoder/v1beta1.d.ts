...
export declare namespace transcoder_v1beta1 {
    ...
    export interface Schema$Job {
        ...
        state?: string | null;
        /**
         * Input only. Specify the `templateid` to use for populating `Job.config`. The default is `preset/web-hd`. Preset Transcoder templates: - `preset/{presetid\}` - User defined JobTemplate: `{job_templateid\}`
         */
    ...
    export interface Schema$TextStream {
        ...
        codec?: string | null;
        /**
         * Required. The BCP-47 language code, such as `"en-US"` or `"sr-Latn"`. For more information, see https://www.unicode.org/reports/tr35/#Unicode_localeidentifier.
         */
