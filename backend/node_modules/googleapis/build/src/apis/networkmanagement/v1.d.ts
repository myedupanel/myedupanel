...
export declare namespace networkmanagement_v1 {
    ...
    export interface Schema$ConnectivityTest {
        ...
        /**
         * Identifier. Unique name of the resource using the form: `projects/{projectid\}/locations/global/connectivityTests/{testid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$EffectiveVpcFlowLogsConfig {
        ...
        /**
         * Unique name of the configuration. The name can have one of the following forms: - For project-level configurations: `projects/{projectid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}` - For organization-level configurations: `organizations/{organizationid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}` - For a Compute config, the name will be the path of the subnet: `projects/{projectid\}/regions/{region\}/subnetworks/{subnetid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$RedisClusterInfo {
        ...
        location?: string | null;
        /**
         * URI of the network containing the Redis Cluster endpoints in format "projects/{projectid\}/global/networks/{networkid\}".
         */
        networkUri?: string | null;
        /**
        ...
        /**
         * URI of a Redis Cluster in format "projects/{projectid\}/locations/{location\}/clusters/{clusterid\}"
         */
        uri?: string | null;
    }
    /**
    ...
    export interface Schema$VpcFlowLogsConfig {
        ...
        metadataFields?: string[] | null;
        /**
         * Identifier. Unique name of the configuration. The name can have one of the following forms: - For project-level configurations: `projects/{projectid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}` - For organization-level configurations: `organizations/{organizationid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}`
         */
        name?: string | null;
        /**
         * Traffic will be logged from VMs, VPN tunnels and Interconnect Attachments within the network. Format: projects/{projectid\}/global/networks/{name\}
    ...
    export class Resource$Organizations$Locations$Vpcflowlogsconfigs {
         ...
         *       // Required. The parent resource of the VpcFlowLogsConfig to create, in one of the following formats: - For project-level resources: `projects/{projectid\}/locations/global` - For organization-level resources: `organizations/{organizationid\}/locations/global`
         ...
         *       // Required. The resource name of the VpcFlowLogsConfig, in one of the following formats: - For a project-level resource: `projects/{projectid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}` - For an organization-level resource: `organizations/{organizationid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}`
         ...
         *       // Required. The resource name of the VpcFlowLogsConfig, in one of the following formats: - For project-level resources: `projects/{projectid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}` - For organization-level resources: `organizations/{organizationid\}/locations/global/vpcFlowLogsConfigs/{vpc_flow_logs_configid\}`
         *       name: 'organizations/my-organization/locations/my-location/vpcFlowLogsConfigs/my-vpcFlowLogsConfig',
         *     });
         *   console.log(res.data);
         *
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. The parent resource of the VpcFlowLogsConfig, in one of the following formats: - For project-level resourcs: `projects/{projectid\}/locations/global` - For organization-level resources: `organizations/{organizationid\}/locations/global`
         *       parent: 'organizations/my-organization/locations/my-location',
         *     });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Global$Connectivitytests {
         ...
         *       // Required. Connectivity Test resource name using the form: `projects/{projectid\}/locations/global/connectivityTests/{testid\}`
         ...
         *       // Required. `ConnectivityTest` resource name using the form: `projects/{projectid\}/locations/global/connectivityTests/{testid\}`
         *       name: 'projects/my-project/locations/global/connectivityTests/my-connectivityTest',
         *     });
         *   console.log(res.data);
         *
