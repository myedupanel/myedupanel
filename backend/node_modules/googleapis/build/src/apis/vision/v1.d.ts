...
export declare namespace vision_v1 {
    ...
    export interface Schema$DetectedLanguage {
        ...
        confidence?: number | null;
        /**
         * The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier.
         */
    ...
    export interface Schema$GoogleCloudVisionV1p1beta1WebDetectionWebLabel {
        ...
        label?: string | null;
        /**
         * The BCP-47 language code for `label`, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier.
         */
        languageCode?: string | null;
    }
    /**
    ...
    export interface Schema$ProductSetPurgeConfig {
        /**
         * The ProductSet that contains the Products to delete. If a Product is a member of product_setid in addition to other ProductSets, the Product will still be deleted.
         */
