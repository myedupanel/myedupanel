...
export declare namespace securityposture_v1 {
    ...
    export interface Schema$GoogleCloudSecuritypostureV1CustomConstraint {
        ...
        /**
         * Immutable. The name of the constraint, in the format `organizations/{organizationid\}/customConstraints/custom.{custom_constraintid\}`. For example, `organizations/123456789012/customConstraints/custom.createOnlyE2TypeVms`. Must contain 1 to 62 characters, excluding the prefix `organizations/{organizationid\}/customConstraints/custom.`.
         */
        name?: string | null;
        /**
    ...
    /**
     * The allowed and denied values for a list constraint. For all constraints, these fields can contain literal values. Optionally, you can add the `is:` prefix to these values. If the value contains a colon (`:`), then the `is:` prefix is required. Some constraints allow you to specify a portion of the resource hierarchy, known as a [_hierarchy subtree_](https://cloud.google.com/resource-manager/help/organization-policy/hierarchy-subtree), that the constraint applies to. To specify a hierarchy subtree, use the `under:` prefix, followed by a value with one of these formats: - `projects/{projectid\}` (for example, `projects/tokyo-rain-123`) - `folders/{folderid\}` (for example, `folders/1234567890123`) - `organizations/{organizationid\}` (for example, `organizations/123456789012`) A constraint's `supports_under` field indicates whether you can specify a hierarchy subtree. To learn which predefined constraints let you specify a hierarchy subtree, see the [constraints reference](https://cloud.google.com/resource-manager/help/organization-policy/constraints/reference).
     */
    ...
    export interface Schema$PolicySet {
        ...
        description?: string | null;
        /**
         * Required. The Policy resources in the policy set. Each policy must have a policyid that's unique within the policy set.
         */
    ...
    export interface Schema$PostureDeployment {
        ...
        /**
         * Required. Identifier. The name of the posture deployment, in the format `organizations/{organization\}/locations/global/postureDeployments/{deploymentid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$PostureDetails {
        ...
        posture?: string | null;
        /**
         * The name of the posture deployment, in the format `organizations/{organization\}/locations/global/postureDeployments/{deploymentid\}`.
         */
    ...
    export interface Schema$Report {
        ...
        /**
         * Required. The name of the report, in the format `organizations/{organization\}/locations/global/reports/{reportid\}`.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Organizations$Locations$Posturedeployments {
         ...
         *       // Required. The name of the PostureDeployment, in the format `organizations/{organization\}/locations/global/postureDeployments/{posture_deploymentid\}`.
         *       name: 'organizations/my-organization/locations/my-location/postureDeployments/my-postureDeployment',
         *     });
         *   console.log(res.data);
         *
         ...
         *       // Required. Identifier. The name of the posture deployment, in the format `organizations/{organization\}/locations/global/postureDeployments/{deploymentid\}`.
         *       name: 'organizations/my-organization/locations/my-location/postureDeployments/my-postureDeployment',
         *       // Required. The fields in the PostureDeployment to update. You can update only the following fields: * PostureDeployment.postureid * PostureDeployment.posture_revisionid
    ...
    export class Resource$Organizations$Locations$Postures {
         ...
         *     etag: 'placeholder-value',
         *     // Required. The name of the Posture, in the format `organizations/{organization\}/locations/global/postures/{postureid\}`.
