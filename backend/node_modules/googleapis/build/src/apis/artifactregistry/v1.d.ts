...
export declare namespace artifactregistry_v1 {
    ...
    export interface Schema$GenericArtifact {
        ...
        createTime?: string | null;
        /**
         * Resource name of the generic artifact. project, location, repository, packageid and versionid create a unique generic artifact. i.e. "projects/test-project/locations/us-west4/repositories/test-repo/ genericArtifacts/packageid:versionid"
         */
        name?: string | null;
        /**
    ...
    /**
     * The request to upload a generic artifact. The created GenericArtifact will have the resource name {parent\}/genericArtifacts/packageid:versionid. The created file will have the resource name {parent\}/files/packageid:versionid:filename.
     */
