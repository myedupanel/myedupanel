...
export declare namespace cloudbilling_v1 {
    ...
    export interface Schema$BillingAccount {
        ...
        /**
         * Output only. The resource name of the billing account. The resource name has the form `billingAccounts/{billing_accountid\}`. For example, `billingAccounts/012345-567890-ABCDEF` would be the resource name for billing account `012345-567890-ABCDEF`.
         */
        name?: string | null;
        /**
        ...
        open?: boolean | null;
        /**
         * Output only. The billing account's parent resource identifier. Use the `MoveBillingAccount` method to update the account's parent resource if it is a organization. Format: - `organizations/{organizationid\}`, for example, `organizations/12345678` - `billingAccounts/{billing_accountid\}`, for example, `billingAccounts/012345-567890-ABCDEF`
         */
        parent?: string | null;
    }
    /**
    ...
    export interface Schema$MoveBillingAccountRequest {
        /**
         * Required. The resource name of the Organization to move the billing account under. Must be of the form `organizations/{organizationid\}`.
         */
    ...
    export class Resource$Billingaccounts {
         ...
         *     // Optional. The parent to create a billing account from. Format: - `billingAccounts/{billing_accountid\}`, for example, `billingAccounts/012345-567890-ABCDEF`
         ...
         *     // Optional. The parent resource to list billing accounts from. Format: - `organizations/{organizationid\}`, for example, `organizations/12345678` - `billingAccounts/{billing_accountid\}`, for example, `billingAccounts/012345-567890-ABCDEF`
         *     parent: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The resource name of the billing account to move. Must be of the form `billingAccounts/{billing_accountid\}`. The specified billing account cannot be a subaccount, since a subaccount always belongs to the same organization as its parent account.
         *     name: 'billingAccounts/my-billingAccount',
         *
         *     // Request body metadata
         *     requestBody: {
