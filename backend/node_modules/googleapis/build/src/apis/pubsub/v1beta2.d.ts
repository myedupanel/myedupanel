...
export declare namespace pubsub_v1beta2 {
    ...
    export interface Schema$ModifyAckDeadlineRequest {
        ...
        /**
         * The acknowledgment ID. Either this or ackids must be populated, but not both.
         */
        ackId?: string | null;
        /**
