...
export declare namespace firebaseapphosting_v1 {
    ...
    export interface Schema$Backend {
        ...
        /**
         * Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.appid) associated with the backend.
         */
        appId?: string | null;
        /**
