...
export declare namespace securesourcemanager_v1 {
    ...
    export interface Schema$CreatePullRequestCommentRequest {
        /**
         * Required. The pull request in which to create the pull request comment. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         */
        parent?: string | null;
        /**
    ...
    export interface Schema$Instance {
        ...
        /**
         * Optional. A unique identifier for an instance. The name should be of the format: `projects/{project_number\}/locations/{locationid\}/instances/{instanceid\}` `project_number`: Maps to a unique int64 id assigned to each project. `locationid`: Refers to the region where the instance will be deployed. Since Secure Source Manager is a regional service, it must be one of the valid GCP regions. `instanceid`: User provided name for the instance, must be unique for a project_number and locationid combination.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Issue {
        ...
        etag?: string | null;
        /**
         * Identifier. Unique identifier for an issue. The issue id is generated by the server. Format: `projects/{project\}/locations/{location\}/repositories/{repository\}/issues/{issueid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$IssueComment {
        ...
        createTime?: string | null;
        /**
         * Identifier. Unique identifier for an issue comment. The comment id is generated by the server. Format: `projects/{project\}/locations/{location\}/repositories/{repository\}/issues/{issue\}/issueComments/{commentid\}`
         */
        name?: string | null;
        /**
         * Output only. Last updated timestamp.
    ...
    export interface Schema$PullRequest {
        ...
        head?: Schema$Branch;
        /**
         * Output only. A unique identifier for a PullRequest. The number appended at the end is generated by the server. Format: `projects/{project\}/locations/{location\}/repositories/{repository\}/pullRequests/{pull_requestid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$PullRequestComment {
        ...
        createTime?: string | null;
        /**
         * Identifier. Unique identifier for the pull request comment. The comment id is generated by the server. Format: `projects/{project\}/locations/{location\}/repositories/{repository\}/pullRequests/{pull_request\}/pullRequestComments/{commentid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ResolvePullRequestCommentsRequest {
        ...
        /**
         * Required. The names of the pull request comments to resolve. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}/pullRequestComments/{commentid\}` Only comments from the same threads are allowed in the same request.
         */
        names?: string[] | null;
    }
    /**
    ...
    export interface Schema$UnresolvePullRequestCommentsRequest {
        ...
        autoFill?: boolean | null;
        /**
         * Required. The names of the pull request comments to unresolve. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}/pullRequestComments/{commentid\}` Only comments from the same threads are allowed in the same request.
         */
        names?: string[] | null;
    }
    /**
    ...
    export class Resource$Projects$Locations$Repositories {
         ...
         *     // Required. The project in which to create the repository. Values are of the form `projects/{project_number\}/locations/{locationid\}`
         *     parent: 'projects/my-project/locations/my-location',
         ...
         *     // Required. Name of the repository to retrieve. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}`.
         *     name: 'projects/my-project/locations/my-location/repositories/my-repositorie',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Repositories$Hooks {
         ...
         *       // Required. The repository in which to create the hook. Values are of the form `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}`
         *       parent:
         *         'projects/my-project/locations/my-location/repositories/my-repositorie',
         *
         *       // Request body metadata
         ...
         *       // Required. Name of the hook to delete. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/hooks/{hookid\}`.
         ...
         *       // Required. Name of the hook to retrieve. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/hooks/{hookid\}`.
         *       name: 'projects/my-project/locations/my-location/repositories/my-repositorie/hooks/my-hook',
         *     });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Repositories$Issues {
         ...
         *       // Required. Name of the issue to close. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/issues/{issueid\}`.
         ...
         *       // Required. The repository in which to create the issue. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}`
         *       parent:
         *         'projects/my-project/locations/my-location/repositories/my-repositorie',
         *
         *       // Request body metadata
         ...
         *       // Required. Name of the issue to delete. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/issues/{issueid\}`.
         *       name: 'projects/my-project/locations/my-location/repositories/my-repositorie/issues/my-issue',
         *     });
         *   console.log(res.data);
         *
         ...
         *       // Required. Name of the issue to retrieve. The format is `projects/{project\}/locations/{location\}/repositories/{repository\}/issues/{issueid\}`.
         *       name: 'projects/my-project/locations/my-location/repositories/my-repositorie/issues/my-issue',
         *     });
         *   console.log(res.data);
         *
         ...
         *       // Required. Name of the issue to open. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/issues/{issueid\}`.
         *       name: 'projects/my-project/locations/my-location/repositories/my-repositorie/issues/my-issue',
         *
         *       // Request body metadata
         *       requestBody: {
    ...
    export class Resource$Projects$Locations$Repositories$Issues$Issuecomments {
         ...
         *       {
         *         // Required. The issue in which to create the issue comment. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/issues/{issueid\}`
         *         parent:
         ...
         *       {
         *         // Required. Name of the issue comment to delete. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/issues/{issueid\}/issueComments/{commentid\}`.
         ...
         *       {
         *         // Required. Name of the issue comment to retrieve. The format is `projects/{project\}/locations/{location\}/repositories/{repository\}/issues/{issueid\}/issueComments/{commentid\}`.
         *         name: 'projects/my-project/locations/my-location/repositories/my-repositorie/issues/my-issue/issueComments/my-issueComment',
         *       },
         *     );
         *   console.log(res.data);
         ...
         *         // Optional. A token identifying a page of results the server should return.
         *         pageToken: 'placeholder-value',
         *         // Required. The issue in which to list the comments. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/issues/{issueid\}`
         *         parent:
         *           'projects/my-project/locations/my-location/repositories/my-repositorie/issues/my-issue',
         *       },
         *     );
    ...
    export class Resource$Projects$Locations$Repositories$Pullrequests {
         ...
         *       {
         *         // Required. The pull request to close. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         ...
         *       {
         *         // Required. The repository that the pull request is created from. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}`
         *         parent:
         *           'projects/my-project/locations/my-location/repositories/my-repositorie',
         *
         *         // Request body metadata
         ...
         *         // Optional. A token identifying a page of results the server should return.
         *         pageToken: 'placeholder-value',
         *         // Required. The repository in which to list pull requests. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}`
         *         parent:
         *           'projects/my-project/locations/my-location/repositories/my-repositorie',
         *       },
         *     );
         ...
         *       {
         *         // Required. The pull request to list file diffs for. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         *         name: 'projects/my-project/locations/my-location/repositories/my-repositorie/pullRequests/my-pullRequest',
         *         // Optional. Requested page size. Server may return fewer items than requested. If unspecified, server will pick an appropriate default.
         *         pageSize: 'placeholder-value',
         *         // Optional. A token identifying a page of results the server should return.
         ...
         *       {
         *         // Required. The pull request to merge. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         *         name: 'projects/my-project/locations/my-location/repositories/my-repositorie/pullRequests/my-pullRequest',
         *
         *         // Request body metadata
         *         requestBody: {
         ...
         *       {
         *         // Required. The pull request to open. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         *         name: 'projects/my-project/locations/my-location/repositories/my-repositorie/pullRequests/my-pullRequest',
         *
         *         // Request body metadata
         *         requestBody: {
    ...
    export class Resource$Projects$Locations$Repositories$Pullrequests$Pullrequestcomments {
         ...
         *       {
         *         // Required. The pull request in which to create the pull request comments. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         *         parent:
         ...
         *       {
         *         // Required. Name of the pull request comment to delete. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}/pullRequestComments/{commentid\}`.
         ...
         *       {
         *         // Required. Name of the pull request comment to retrieve. The format is `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}/pullRequestComments/{commentid\}`.
         *         name: 'projects/my-project/locations/my-location/repositories/my-repositorie/pullRequests/my-pullRequest/pullRequestComments/my-pullRequestComment',
         *       },
         *     );
         *   console.log(res.data);
         ...
         *         // Optional. A token identifying a page of results the server should return.
         *         pageToken: 'placeholder-value',
         *         // Required. The pull request in which to list pull request comments. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         *         parent:
         *           'projects/my-project/locations/my-location/repositories/my-repositorie/pullRequests/my-pullRequest',
         *       },
         *     );
         ...
         *       {
         *         // Required. The pull request in which to resolve the pull request comments. Format: `projects/{project_number\}/locations/{locationid\}/repositories/{repositoryid\}/pullRequests/{pull_requestid\}`
         *         parent:
         *           'projects/my-project/locations/my-location/repositories/my-repositorie/pullRequests/my-pullRequest',
         *
         *         // Request body metadata
