...
export declare namespace paymentsresellersubscription_v1 {
    ...
    export interface Schema$EntitleSubscriptionIntent {
        /**
         * Required. The name of the subscription resource that is entitled to the current end user. It is in the format of "partners/{partnerid\}/subscriptions/{subscriptionId\}".
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$EntitleSubscriptionRequestLineItemEntitlementDetails {
        ...
        /**
         * Optional. Only applicable if the line item corresponds to a hard bundle. Product resource names that identify the bundle elements to be entitled in the line item. If unspecified, all bundle elements will be entitled. The format is 'partners/{partnerid\}/products/{productid\}'.
         */
    ...
    export interface Schema$GoogleTypeLocalizedText {
        /**
         * The text's BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier.
         */
    ...
    export interface Schema$Product {
        ...
        /**
         * Identifier. Response only. Resource name of the product. It will have the format of "partners/{partnerid\}/products/{productid\}"
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ProductBundleDetailsBundleElement {
        /**
         * Required. Output only. Product resource name that identifies the bundle element. The format is 'partners/{partnerid\}/products/{productid\}'.
         */
        product?: string | null;
    }
    /**
    ...
    export interface Schema$Promotion {
        ...
        /**
         * Identifier. Response only. Resource name of the subscription promotion. It will have the format of "partners/{partnerid\}/promotion/{promotionid\}"
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Subscription {
        ...
        /**
         * Identifier. Resource name of the subscription. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}". This is available for authorizeAddon, but otherwise is response only.
         */
        name?: string | null;
        /**
        ...
        /**
         * Optional. Deprecated: consider using `line_items` as the input. Required. Resource name that identifies the purchased products. The format will be 'partners/{partnerid\}/products/{productid\}'.
         */
        products?: string[] | null;
        /**
         * Optional. Deprecated: consider using the top-level `promotion_specs` as the input. Optional. Resource name that identifies one or more promotions that can be applied on the product. A typical promotion for a subscription is Free trial. The format will be 'partners/{partnerid\}/promotions/{promotionid\}'.
         */
    ...
    export interface Schema$SubscriptionLineItem {
        ...
        /**
         * Required. Product resource name that identifies one the line item The format is 'partners/{partnerid\}/products/{productid\}'.
         */
        product?: string | null;
        /**
    ...
    export interface Schema$SubscriptionLineItemBundleDetailsBundleElementDetails {
        /**
         * Output only. Product resource name that identifies the bundle element. The format is 'partners/{partnerid\}/products/{productid\}'.
         */
        product?: string | null;
        /**
    ...
    export interface Schema$SubscriptionPromotionSpec {
        ...
        introductoryPricingDetails?: Schema$PromotionIntroductoryPricingDetails;
        /**
         * Required. Promotion resource name that identifies a promotion. The format is 'partners/{partnerid\}/promotions/{promotionid\}'.
         */
    ...
    export interface Schema$SubscriptionUpgradeDowngradeDetails {
        ...
        /**
         * Required. The previous subscription id to be replaced. The format can be one of the following: 1. `subscriptionid`: the old subscription id under the same partnerid. 2. `partners/{partnerid\}/subscriptions/{subscriptionid\}`. A different partnerid is allowed. But they must be under the same partner group.
         */
    ...
    export interface Schema$YoutubePayload {
        ...
        /**
         * The list of eligibilityids which are applicable for the line item.
         */
    ...
    export class Resource$Partners$Subscriptions {
         ...
         *     // Required. The name of the subscription resource to be cancelled. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}"
         ...
         *     // Required. The parent resource name, which is the identifier of the partner. It will have the format of "partners/{partnerid\}".
         *     parent: 'partners/my-partner',
         *     // Required. Identifies the subscription resource on the Partner side. The value is restricted to 63 ASCII characters at the maximum. If a subscription was previously created with the same subscriptionid, we will directly return that one.
         ...
         *     {
         *       // Required. The name of the subscription resource that is entitled to the current end user. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}"
         *       name: 'partners/my-partner/subscriptions/my-subscription',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *     // Required. The name of the subscription resource to be extended. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}".
         *     name: 'partners/my-partner/subscriptions/my-subscription',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The name of the subscription resource to retrieve. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}"
         *     name: 'partners/my-partner/subscriptions/my-subscription',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The name of the subscription resource to be resumed. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}"
         *     name: 'partners/my-partner/subscriptions/my-subscription',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     {
         *       // Required. The name of the subscription resource to be suspended. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}"
         *       name: 'partners/my-partner/subscriptions/my-subscription',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *       // Required. The name of the subscription resource whose pending cancellation needs to be undone. It will have the format of "partners/{partnerid\}/subscriptions/{subscriptionid\}"
         *       name: 'partners/my-partner/subscriptions/my-subscription',
         *
         *       // Request body metadata
         *       requestBody: {
