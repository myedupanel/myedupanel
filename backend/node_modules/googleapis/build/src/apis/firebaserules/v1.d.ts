...
export declare namespace firebaserules_v1 {
    ...
    export interface Schema$Release {
        ...
        /**
         * Required. Format: `projects/{projectid\}/releases/{releaseid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Ruleset {
        ...
        /**
         * Output only. Name of the `Ruleset`. The rulesetid is auto generated by the service. Format: `projects/{projectid\}/rulesets/{rulesetid\}`
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects {
         ...
         *     // Required. Tests may either provide `source` or a `Ruleset` resource name. For tests against `source`, the resource name must refer to the project: Format: `projects/{projectid\}` For tests against a `Ruleset`, this must be the `Ruleset` resource name: Format: `projects/{projectid\}/rulesets/{rulesetid\}`
         *     name: 'projects/.*',
         *
    ...
    export class Resource$Projects$Releases {
         ...
         *     // Required. Resource name for the project which owns this `Release`. Format: `projects/{projectid\}`
         ...
         *     // Required. Resource name for the `Release` to delete. Format: `projects/{projectid\}/releases/{releaseid\}`
         ...
         *     // Required. Resource name of the `Release`. Format: `projects/{projectid\}/releases/{releaseid\}`
         *     name: 'projects/my-project/releases/.*',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. Resource name for the project. Format: `projects/{projectid\}`
         *     name: 'projects/my-project',
    ...
    export class Resource$Projects$Rulesets {
         ...
         *     // Required. Resource name for Project which owns this `Ruleset`. Format: `projects/{projectid\}`
         *     name: 'projects/my-project',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. Resource name for the ruleset to delete. Format: `projects/{projectid\}/rulesets/{rulesetid\}`
         ...
         *     // Required. Resource name for the ruleset to get. Format: `projects/{projectid\}/rulesets/{rulesetid\}`
         *     name: 'projects/my-project/rulesets/my-ruleset',
         *   });
         *   console.log(res.data);
         *
