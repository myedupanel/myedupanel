...
export declare namespace clouddeploy_v1 {
    ...
    export interface Schema$GkeCluster {
        /**
         * Optional. Information specifying a GKE Cluster. Format is `projects/{projectid\}/locations/{locationid\}/clusters/{clusterid\}`.
         */
        cluster?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Customtargettypes {
         ...
         *     // Required. The name of the `CustomTargetType` to delete. Format must be `projects/{projectid\}/locations/{location_name\}/customTargetTypes/{custom_target_type\}`.
         ...
         *     // Required. Name of the `CustomTargetType`. Format must be `projects/{projectid\}/locations/{location_name\}/customTargetTypes/{custom_target_type\}`.
         *     name: 'projects/my-project/locations/my-location/customTargetTypes/my-customTargetType',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Deliverypipelines {
         ...
         *     // Required. The parent collection in which the `DeliveryPipeline` must be created. The format is `projects/{projectid\}/locations/{location_name\}`.
         *     parent: 'projects/my-project/locations/my-location',
         *     // Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server knows to ignore the request if it has already been completed. The server guarantees that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
         *     requestId: 'placeholder-value',
         *     // Optional. If set to true, the request is validated and the user is provided with an expected result, but no actual change is made.
         ...
         *     // Required. The name of the `DeliveryPipeline` to delete. The format is `projects/{projectid\}/locations/{location_name\}/deliveryPipelines/{pipeline_name\}`.
         ...
         *     // Required. Name of the `DeliveryPipeline`. Format must be `projects/{projectid\}/locations/{location_name\}/deliveryPipelines/{pipeline_name\}`.
         *     name: 'projects/my-project/locations/my-location/deliveryPipelines/my-deliveryPipeline',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent, which owns this collection of pipelines. Format must be `projects/{projectid\}/locations/{location_name\}`.
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Deliverypipelines$Automations {
         ...
         *       // Required. The parent collection in which the `Automation` must be created. The format is `projects/{projectid\}/locations/{location_name\}/deliveryPipelines/{pipeline_name\}`.
         *       parent:
         *         'projects/my-project/locations/my-location/deliveryPipelines/my-deliveryPipeline',
         *       // Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server knows to ignore the request if it has already been completed. The server guarantees that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
         *       requestId: 'placeholder-value',
    ...
    export class Resource$Projects$Locations$Deliverypipelines$Releases {
         ...
         *       // Required. The parent collection in which the `Release` is created. The format is `projects/{projectid\}/locations/{location_name\}/deliveryPipelines/{pipeline_name\}`.
         *       parent:
         *         'projects/my-project/locations/my-location/deliveryPipelines/my-deliveryPipeline',
    ...
    export class Resource$Projects$Locations$Deliverypipelines$Releases$Rollouts {
         ...
         *       {
         *         // Required. Name of the `Rollout`. Format must be `projects/{projectid\}/locations/{location_name\}/deliveryPipelines/{pipeline_name\}/releases/{release_name\}/rollouts/{rollout_name\}`.
         *         name: 'projects/my-project/locations/my-location/deliveryPipelines/my-deliveryPipeline/releases/my-release/rollouts/my-rollout',
         *       },
         *     );
         *   console.log(res.data);
    ...
    export class Resource$Projects$Locations$Deliverypipelines$Releases$Rollouts$Jobruns {
         ...
         *       {
         *         // Required. Name of the `JobRun`. Format must be `projects/{projectid\}/locations/{location_name\}/deliveryPipelines/{pipeline_name\}/releases/{release_name\}/rollouts/{rollout_name\}/jobRuns/{job_run_name\}`.
    ...
    export class Resource$Projects$Locations$Deploypolicies {
         ...
         *     // Required. The parent collection in which the `DeployPolicy` must be created. The format is `projects/{projectid\}/locations/{location_name\}`.
         *     parent: 'projects/my-project/locations/my-location',
         *     // Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server knows to ignore the request if it has already been completed. The server guarantees that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
         *     requestId: 'placeholder-value',
         *     // Optional. If set to true, the request is validated and the user is provided with an expected result, but no actual change is made.
         ...
         *     // Optional. This checksum is computed by the server based on the value of other fields, and may be sent on update and delete requests to ensure the client has an up-to-date value before proceeding.
         *     etag: 'placeholder-value',
         *     // Required. The name of the `DeployPolicy` to delete. The format is `projects/{projectid\}/locations/{location_name\}/deployPolicies/{deploy_policy_name\}`.
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent, which owns this collection of deploy policies. Format must be `projects/{projectid\}/locations/{location_name\}`.
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Targets {
         ...
         *     // Required. The parent collection in which the `Target` must be created. The format is `projects/{projectid\}/locations/{location_name\}`.
         *     parent: 'projects/my-project/locations/my-location',
         *     // Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server knows to ignore the request if it has already been completed. The server guarantees that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
         *     requestId: 'placeholder-value',
         ...
         *     // Optional. This checksum is computed by the server based on the value of other fields, and may be sent on update and delete requests to ensure the client has an up-to-date value before proceeding.
         *     etag: 'placeholder-value',
         *     // Required. The name of the `Target` to delete. The format is `projects/{projectid\}/locations/{location_name\}/targets/{target_name\}`.
         ...
         *     // Required. Name of the `Target`. Format must be `projects/{projectid\}/locations/{location_name\}/targets/{target_name\}`.
         *     name: 'projects/my-project/locations/my-location/targets/my-target',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent, which owns this collection of targets. Format must be `projects/{projectid\}/locations/{location_name\}`.
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
