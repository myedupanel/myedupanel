...
export declare namespace videointelligence_v1p3beta1 {
    ...
    export interface Schema$GoogleCloudVideointelligenceV1p3beta1_StreamingAnnotateVideoResponse {
        ...
        /**
         * Google Cloud Storage URI that stores annotation results of one streaming session in JSON format. It is the annotation_result_storage_directory from the request followed by '/cloud_project_number-sessionid'.
         */
