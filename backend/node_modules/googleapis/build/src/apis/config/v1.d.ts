...
export declare namespace config_v1 {
    ...
    export interface Schema$ResourceChange {
        ...
        intent?: string | null;
        /**
         * Identifier. The name of the resource change. Format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}/resourceChanges/{resource_change\}'.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ResourceDrift {
        /**
         * Identifier. The name of the resource drift. Format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}/resourceDrifts/{resource_drift\}'.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Deployments {
         ...
         *     // Required. The parent in whose context the Deployment is created. The parent value is in the format: 'projects/{projectid\}/locations/{location\}'.
         ...
         *     // Required. The name of the Deployment in the format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}'.
         ...
         *     // Required. The parent in whose context the statefile is listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}'.
         *     parent:
         ...
         *     // Required. The name of the deployment. Format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}'.
         *     name: 'projects/my-project/locations/my-location/deployments/my-deployment',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent in whose context the Deployments are listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}'.
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Deployments$Revisions {
         ...
         *     {
         *       // Required. The parent in whose context the statefile is listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}/revisions/{revision\}'.
         *       parent:
         ...
         *     // Required. The name of the Revision in the format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}/revisions/{revision\}'.
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent in whose context the Revisions are listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}'.
         *     parent:
         *       'projects/my-project/locations/my-location/deployments/my-deployment',
         *   });
         *   console.log(res.data);
    ...
    export class Resource$Projects$Locations$Deployments$Revisions$Resources {
         ...
         *       // Required. The name of the Resource in the format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}/revisions/{revision\}/resource/{resource\}'.
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. The parent in whose context the Resources are listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}/deployments/{deployment\}/revisions/{revision\}'.
         *       parent:
         *         'projects/my-project/locations/my-location/deployments/my-deployment/revisions/my-revision',
         *     });
         *   console.log(res.data);
    ...
    export class Resource$Projects$Locations$Previews {
         ...
         *     // Required. The parent in whose context the Preview is created. The parent value is in the format: 'projects/{projectid\}/locations/{location\}'.
         *     parent: 'projects/my-project/locations/my-location',
         ...
         *     // Required. The name of the Preview in the format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}'.
         ...
         *     // Required. The preview whose results should be exported. The preview value is in the format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}'.
         ...
         *     // Required. The name of the preview. Format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}'.
         *     name: 'projects/my-project/locations/my-location/previews/my-preview',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent in whose context the Previews are listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}'.
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Previews$Resourcechanges {
         ...
         *     // Required. The name of the resource change to retrieve. Format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}/resourceChanges/{resource_change\}'.
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent in whose context the ResourceChanges are listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}'.
         *     parent: 'projects/my-project/locations/my-location/previews/my-preview',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Previews$Resourcedrifts {
         ...
         *     // Required. The name of the resource drift to retrieve. Format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}/resourceDrifts/{resource_drift\}'.
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent in whose context the ResourceDrifts are listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}/previews/{preview\}'.
         *     parent: 'projects/my-project/locations/my-location/previews/my-preview',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Terraformversions {
         ...
         *     // Required. The name of the TerraformVersion. Format: 'projects/{projectid\}/locations/{location\}/terraformVersions/{terraform_version\}'
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent in whose context the TerraformVersions are listed. The parent value is in the format: 'projects/{projectid\}/locations/{location\}'.
         *     parent: 'projects/my-project/locations/my-location',
         *   });
         *   console.log(res.data);
         *
