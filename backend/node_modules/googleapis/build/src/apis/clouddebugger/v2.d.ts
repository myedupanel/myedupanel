...
export declare namespace clouddebugger_v2 {
    ...
    export class Resource$Controller$Debuggees {
        ...
        constructor(context: APIRequestContext);
        /**
         * Registers the debuggee with the controller service. All agents attached to the same application must call this method with exactly the same request content to get back the same stable `debuggeeid`. Agents should call this method again whenever `google.rpc.Code.NOT_FOUND` is returned from any controller method. This protocol allows the controller service to disable debuggees, recover from data loss, or change the `debuggeeid` format. Agents must handle `debuggeeid` value changing upon re-registration.
         * @example
         * ```js
