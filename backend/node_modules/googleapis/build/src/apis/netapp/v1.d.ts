...
export declare namespace netapp_v1 {
    ...
    export interface Schema$ActiveDirectory {
        ...
        /**
         * Identifier. The resource name of the active directory. Format: `projects/{project_number\}/locations/{locationid\}/activeDirectories/{active_directoryid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Backup {
        /**
         * Output only. Region in which backup is stored. Format: `projects/{projectid\}/locations/{location\}`
         */
        ...
        /**
         * Identifier. The resource name of the backup. Format: `projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}/backups/{backupid\}`.
         */
        name?: string | null;
        /**
        ...
        /**
         * Volume full name of this backup belongs to. Format: `projects/{projectsid\}/locations/{location\}/volumes/{volumeid\}`
         */
        ...
        state?: string | null;
        /**
         * Output only. Region of the volume from which the backup was created. Format: `projects/{projectid\}/locations/{location\}`
         */
    ...
    export interface Schema$BackupConfig {
        ...
        /**
         * Optional. Name of backup vault. Format: projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}
         */
    ...
    export interface Schema$BackupPolicy {
        ...
        /**
         * Identifier. The resource name of the backup policy. Format: `projects/{projectid\}/locations/{location\}/backupPolicies/{backup_policyid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$BackupVault {
        ...
        description?: string | null;
        /**
         * Output only. Name of the Backup vault created in backup region. Format: `projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}`
         */
        ...
        /**
         * Identifier. The resource name of the backup vault. Format: `projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}`.
         */
        name?: string | null;
        /**
         * Output only. Name of the Backup vault created in source region. Format: `projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}`
         */
    ...
    export interface Schema$QuotaRule {
        ...
        /**
         * Identifier. The resource name of the quota rule. Format: `projects/{project_number\}/locations/{locationid\}/volumes/volumes/{volumeid\}/quotaRules/{quota_ruleid\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$RestoreBackupFilesRequest {
        /**
         * Required. The backup resource name, in the format `projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}/backups/{backupid\}`
         */
        backup?: string | null;
        /**
    ...
    export interface Schema$RestoreParameters {
        /**
         * Full name of the backup resource. Format: projects/{project\}/locations/{location\}/backupVaults/{backup_vaultid\}/backups/{backupid\}
         */
    ...
    export class Resource$Projects$Locations$Backuppolicies {
         ...
         *     // Required. The backup policy resource name, in the format `projects/{projectid\}/locations/{location\}/backupPolicies/{backup_policyid\}`
        ...
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         * Returns the description of the specified backup policy by backup_policyid.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *     // Required. The backupPolicy resource name, in the format `projects/{projectid\}/locations/{location\}/backupPolicies/{backup_policyid\}`
         *     name: 'projects/my-project/locations/my-location/backupPolicies/my-backupPolicie',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Backupvaults {
         ...
         *     // Required. The backupVault resource name, in the format `projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}`
    ...
    export class Resource$Projects$Locations$Backupvaults$Backups {
         ...
         *     // Required. The NetApp backupVault to create the backups of, in the format `projects/x/locations/x/backupVaults/{backup_vaultid\}`
         *     parent:
         ...
         *     // The next_page_token value to use if there are additional results to retrieve for this list request.
         *     pageToken: 'placeholder-value',
         *     // Required. The backupVault for which to retrieve backup information, in the format `projects/{projectid\}/locations/{location\}/backupVaults/{backup_vaultid\}`. To retrieve backup information for all locations, use "-" for the `{location\}` value. To retrieve backup information for all backupVaults, use "-" for the `{backup_vaultid\}` value. To retrieve backup information for a volume, use "-" for the `{backup_vaultid\}` value and specify volume full name with the filter.
         *     parent:
         *       'projects/my-project/locations/my-location/backupVaults/my-backupVault',
         *   });
         *   console.log(res.data);
    ...
    export class Resource$Projects$Locations$Kmsconfigs {
        ...
        /**
         * Returns the description of the specified KMS config by kms_configid.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Projects$Locations$Volumes$Replications {
         ...
         *     // Required. The NetApp volume to create the replications of, in the format `projects/{projectid\}/locations/{location\}/volumes/{volumeid\}`
         *     parent: 'projects/my-project/locations/my-location/volumes/my-volume',
         ...
         *     // Required. The replication resource name, in the format `projects/x/locations/x/volumes/x/replications/{replicationid\}`
         ...
         *     // Required. The replication resource name, in the format `projects/{projectid\}/locations/{location\}/volumes/{volumeid\}/replications/{replicationid\}`
         *     name: 'projects/my-project/locations/my-location/volumes/my-volume/replications/my-replication',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Locations$Volumes$Snapshots {
         ...
         *     // Required. The NetApp volume to create the snapshots of, in the format `projects/{projectid\}/locations/{location\}/volumes/{volumeid\}`
         *     parent: 'projects/my-project/locations/my-location/volumes/my-volume',
         ...
         *     // Required. The snapshot resource name, in the format `projects/x/locations/x/volumes/x/snapshots/{snapshotid\}`
         ...
         *     // Required. The snapshot resource name, in the format `projects/{projectid\}/locations/{location\}/volumes/{volumeid\}/snapshots/{snapshotid\}`
         *     name: 'projects/my-project/locations/my-location/volumes/my-volume/snapshots/my-snapshot',
         *   });
         *   console.log(res.data);
         *
