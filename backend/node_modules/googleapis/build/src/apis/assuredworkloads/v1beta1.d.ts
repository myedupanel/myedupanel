...
export declare namespace assuredworkloads_v1beta1 {
    ...
    export interface Schema$GoogleCloudAssuredworkloadsV1beta1Violation {
        ...
        /**
         * Output only. Immutable. Name of the Violation. Format: organizations/{organization\}/locations/{location\}/workloads/{workloadid\}/violations/{violationsid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudAssuredworkloadsV1beta1Workload {
        ...
        /**
         * Optional. The billing account used for the resources which are direct children of workload. This billing account is initially associated with the resources created as part of Workload creation. After the initial creation of these resources, the customer can change the assigned billing account. The resource name has the form `billingAccounts/{billing_accountid\}`. For example, `billingAccounts/012345-567890-ABCDEF`.
         */
    ...
    export interface Schema$GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings {
        ...
        displayName?: string | null;
        /**
         * Resource identifier. For a project this represents projectid. If the project is already taken, the workload creation will fail. For KeyRing, this represents the keyringid. For a folder, don't set this value as folderid is assigned by Google.
         */
        resourceId?: string | null;
        /**
    ...
    export class Resource$Organizations$Locations$Workloads {
         ...
         *     // Required. The resource name of the new Workload's parent. Must be of the form `organizations/{orgid\}/locations/{locationid\}`.
         ...
         *     // Required. The `name` field is used to identify the workload. Format: organizations/{orgid\}/locations/{locationid\}/workloads/{workloadid\}
         ...
         *     // Required. The resource name of the Workload to fetch. This is the workloads's relative path in the API, formatted as "organizations/{organizationid\}/locations/{locationid\}/workloads/{workloadid\}". For example, "organizations/123/locations/us-east1/workloads/assured-workload-1".
         *     name: 'organizations/my-organization/locations/my-location/workloads/my-workload',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Parent Resource to list workloads from. Must be of the form `organizations/{orgid\}/locations/{location\}`.
         *     parent: 'organizations/my-organization/locations/my-location',
         *   });
         *   console.log(res.data);
         *
         ...
         *       {
         *         // Required. The resource name of the Workload. This is the workloads's relative path in the API, formatted as "organizations/{organizationid\}/locations/{locationid\}/workloads/{workloadid\}". For example, "organizations/123/locations/us-east1/workloads/assured-workload-1".
         *         name: 'organizations/my-organization/locations/my-location/workloads/my-workload',
         *
         *         // Request body metadata
         *         requestBody: {
    ...
    export class Resource$Organizations$Locations$Workloads$Updates {
         ...
         *       // Required. The resource name of the update. Format: organizations/{orgid\}/locations/{locationid\}/workloads/{workloadid\}/updates/{updateid\}
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. organizations/{orgid\}/locations/{locationid\}/workloads/{workloadid\}
         *       parent:
         *         'organizations/my-organization/locations/my-location/workloads/my-workload',
         *     });
         *   console.log(res.data);
    ...
    export class Resource$Organizations$Locations$Workloads$Violations {
        ...
        /**
         * Lists the Violations in the AssuredWorkload Environment. Callers may also choose to read across multiple Workloads as per [AIP-159](https://google.aip.dev/159) by using '-' (the hyphen or dash character) as a wildcard character instead of workload-id in the parent. Format `organizations/{orgid\}/locations/{location\}/workloads/-`
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. The Workload name. Format `organizations/{orgid\}/locations/{location\}/workloads/{workload\}`.
         *       parent:
         *         'organizations/my-organization/locations/my-location/workloads/my-workload',
         *     });
         *   console.log(res.data);
