...
export declare namespace forms_v1 {
    ...
    export interface Schema$Answer {
        ...
        grade?: Schema$Grade;
        /**
         * Output only. The question's ID. See also Question.questionid.
         */
    ...
    export interface Schema$SetPublishSettingsResponse {
        /**
         * Required. The ID of the Form. This is same as the Form.formid field.
         */
        formId?: string | null;
        /**
    ...
    export interface Schema$Watch {
        ...
        /**
         * Output only. The ID of this watch. See notes on CreateWatchRequest.watchid.
         */
        id?: string | null;
        /**
    ...
    export class Resource$Forms {
         ...
         *     // Required. The ID of the form. You can get the id from Form.formid field.
         *     formId: 'placeholder-value',
         *
         *     // Request body metadata
         *     requestBody: {
