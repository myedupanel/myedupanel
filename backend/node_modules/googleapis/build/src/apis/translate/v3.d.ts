...
export declare namespace translate_v3 {
    ...
    export interface Schema$Example {
        /**
         * Output only. The resource name of the example, in form of `projects/{project-number-or-id\}/locations/{locationid\}/datasets/{datasetid\}/examples/{exampleid\}`
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Adaptivemtdatasets$Adaptivemtfiles {
         ...
         *       {
         *         // Required. The resource name of the file to delete, in form of `projects/{project-number-or-id\}/locations/{locationid\}/adaptiveMtDatasets/{dataset\}/adaptiveMtFiles/{file\}`
