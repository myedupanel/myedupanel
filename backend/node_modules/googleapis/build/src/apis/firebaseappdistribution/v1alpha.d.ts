...
export declare namespace firebaseappdistribution_v1alpha {
    ...
    export interface Schema$GoogleFirebaseAppdistroV1alphaBatchDeleteTestCasesRequest {
        /**
         * Required. The name of the test cases to delete. A maximum number of 1000 test cases can be deleted in one batch Format: `projects/{project_number\}/apps/{appid\}/testCases/{test_caseid\}`
         */
        names?: string[] | null;
    }
    /**
    ...
    export interface Schema$GoogleFirebaseAppdistroV1alphaEnableAccessOnReleaseRequest {
        /**
         * Optional. Ignored. Used to be build version of the app release if an instance identifier was provided for the releaseid.
         */
        buildVersion?: string | null;
        /**
         * Optional. Ignored. Used to be display version of the app release if an instance identifier was provided for the releaseid.
         */
    ...
    export interface Schema$GoogleFirebaseAppdistroV1alphaReleaseTest {
        ...
        /**
         * The name of the release test resource. Format: `projects/{project_number\}/apps/{appid\}/releases/{releaseid\}/tests/{testid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppdistroV1alphaTestCase {
        ...
        displayName?: string | null;
        /**
         * Identifier. The name of the test case resource. Format: `projects/{project_number\}/apps/{appid\}/testCases/{test_caseid\}`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppdistroV1alphaTestConfig {
        ...
        displayName?: string | null;
        /**
         * Identifier. The name of the test configuration resource. Format: `projects/{project_number\}/apps/{appid\}/testConfig`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleFirebaseAppdistroV1alphaUpdateTestCaseRequest {
        ...
        /**
         * Required. The test case to update. The test case's `name` field is used to identify the test case to update. Format: `projects/{project_number\}/apps/{appid\}/testCases/{test_caseid\}`
         */
    ...
    export interface Schema$GoogleFirebaseAppdistroV1Release {
        ...
        /**
         * The name of the release resource. Format: `projects/{project_number\}/apps/{appid\}/releases/{releaseid\}`
         */
        name?: string | null;
        /**
    ...
    export class Resource$Apps {
         ...
         *     // Unique id for a Firebase app of the format: {version\}:{project_number\}:{platform\}:{hash(bundleid)\} Example: 1:581234567376:android:aa0a3c7b135e90289
         ...
         *     // Required. Unique id for a Firebase app of the format: {version\}:{project_number\}:{platform\}:{hash(bundleid)\} Example: 1:581234567376:android:aa0a3c7b135e90289
         *     mobilesdkAppId: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Apps {
         ...
         *     // Required. The name of the `TestConfig` resource to retrieve. Format: `projects/{project_number\}/apps/{appid\}/testConfig`
    ...
    export class Resource$Projects$Apps$Releases$Tests {
         ...
         *     {
         *       // Required. The name of the release test resource. Format: `projects/{project_number\}/apps/{appid\}/releases/{releaseid\}/tests/{testid\}`
         ...
         *     {
         *       // Required. The name of the release resource, which is the parent of the test Format: `projects/{project_number\}/apps/{appid\}/releases/{releaseid\}`
         ...
         *     // Required. The name of the release resource, which is the parent of the tests Format: `projects/{project_number\}/apps/{appid\}/releases/{releaseid\}`
         *     parent: 'projects/my-project/apps/my-app/releases/my-release',
    ...
    export class Resource$Projects$Apps$Testcases {
         ...
         *     {
         *       // Required. The parent resource of the test cases being deleted. Format: `projects/{project_number\}/apps/{appid\}`
         ...
         *     {
         *       // Required. The parent resource of the test cases being updated. Format: `projects/{project_number\}/apps/{appid\}`
         *       parent: 'projects/my-project/apps/my-app',
         *
         *       // Request body metadata
         *       requestBody: {
         ...
         *     // Required. The parent resource where this test case will be created. Format: `projects/{project_number\}/apps/{appid\}`
         *     parent: 'projects/my-project/apps/my-app',
         ...
         *     // Required. The name of the test case resource to delete. Format: `projects/{project_number\}/apps/{appid\}/testCases/{test_caseid\}`
         ...
         *     // Required. The name of the test case resource to retrieve. Format: `projects/{project_number\}/apps/{appid\}/testCases/{test_caseid\}`
         *     name: 'projects/my-project/apps/my-app/testCases/my-testCase',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The parent resource from which to list test cases. Format: `projects/{project_number\}/apps/{appid\}`
         *     parent: 'projects/my-project/apps/my-app',
         *   });
         *   console.log(res.data);
         *
