...
export declare namespace containeranalysis_v1alpha1 {
    ...
    export interface Schema$Note {
        ...
        longDescription?: string | null;
        /**
         * The name of the note in the form "projects/{provider_projectid\}/notes/{NOTE_ID\}"
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ScanConfig {
        ...
        /**
         * Output only. The name of the ScanConfig in the form “projects/{projectid\}/scanConfigs/{scan_configid\}".
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Notes {
         ...
         *     // The name of the project. Should be of the form "providers/{providerid\}". @Deprecated
         *     name: 'placeholder-value',
         *     // The ID to use for this note.
         *     noteId: 'placeholder-value',
         *     // This field contains the project Id for example: "projects/{projectid\}
         ...
         *     // The name of the note in the form of "providers/{providerid\}/notes/{NOTE_ID\}"
         ...
         *     // The name field will contain the project Id for example: "providers/{providerid\} @Deprecated
         *     name: 'placeholder-value',
         ...
         *     // The name of the note. Should be of the form "projects/{providerid\}/notes/{noteid\}".
         *     name: 'projects/my-project/notes/my-note',
         *     // The fields to update.
    ...
    export class Resource$Projects$Notes$Occurrences {
         ...
         *     // The filter expression.
         *     filter: 'placeholder-value',
         *     // The name field will contain the note name for example: "provider/{providerid\}/notes/{noteid\}"
         *     name: 'projects/my-project/notes/my-note',
         *     // Number of notes to return in the list.
         *     pageSize: 'placeholder-value',
         *     // Token to provide to skip to a particular spot in the list.
    ...
    export class Resource$Projects$Occurrences {
         ...
         *     // The name of the occurrence in the form of "projects/{projectid\}/occurrences/{OCCURRENCE_ID\}"
         ...
         *     // The name of the occurrence of the form "projects/{projectid\}/occurrences/{OCCURRENCE_ID\}"
         *     name: 'projects/my-project/occurrences/my-occurrence',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // The name of the occurrence in the form "projects/{projectid\}/occurrences/{OCCURRENCE_ID\}"
         *     name: 'projects/my-project/occurrences/my-occurrence',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // The name field contains the project Id. For example: "projects/{projectid\} @Deprecated
         *     name: 'placeholder-value',
         ...
         *     // The name of the occurrence. Should be of the form "projects/{projectid\}/occurrences/{OCCURRENCE_ID\}".
         *     name: 'projects/my-project/occurrences/my-occurrence',
         *     // The fields to update.
         *     updateMask: 'placeholder-value',
         *
    ...
    export class Resource$Projects$Operations {
         ...
         *     // The name of the Operation. Should be of the form "projects/{providerid\}/operations/{operationid\}".
    ...
    export class Resource$Projects$Scanconfigs {
         ...
         *     // The name of the ScanConfig in the form projects/{projectid\}/scanConfigs/{scan_configid\}
         ...
         *     pageToken: 'placeholder-value',
         *     // This containers the project Id i.e.: projects/{projectid\}
         *     parent: 'projects/my-project',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // The scan config to update of the form projects/{projectid\}/scanConfigs/{scan_configid\}.
         *     name: 'projects/my-project/scanConfigs/my-scanConfig',
         *     // The fields to update.
         *     updateMask: 'placeholder-value',
         *
