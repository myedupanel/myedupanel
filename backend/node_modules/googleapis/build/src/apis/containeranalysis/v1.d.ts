...
export declare namespace containeranalysis_v1 {
    ...
    export interface Schema$ExportSBOMResponse {
        /**
         * The name of the discovery occurrence in the form "projects/{projectid\}/occurrences/{OCCURRENCE_ID\} It can be used to track the progress of the SBOM export.
         */
    ...
    export interface Schema$UpgradeDistribution {
        /**
         * The operating system classification of this Upgrade, as specified by the upstream operating system upgrade feed. For Windows the classification is one of the categoryids listed at https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ff357803(v=vs.85)
         */
