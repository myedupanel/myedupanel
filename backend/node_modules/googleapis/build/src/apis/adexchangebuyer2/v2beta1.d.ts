...
export declare namespace adexchangebuyer2_v2beta1 {
    ...
    /**
     * A set of filters that is applied to a request for data. Within a filter set, an AND operation is performed across the filters represented by each field. An OR operation is performed across the filters represented by the multiple values of a repeated field, for example, "format=VIDEO AND dealid=12 AND (seller_networkid=34 OR seller_networkid=56)".
     */
    ...
    export interface Schema$PauseProposalDealsRequest {
        /**
         * The external_dealid's of the deals to be paused. If empty, all the deals in the proposal will be paused.
         */
    ...
    export interface Schema$ResumeProposalDealsRequest {
        /**
         * The external_dealid's of the deals to resume. If empty, all the deals in the proposal will be resumed.
         */
        externalDealIds?: string[] | null;
    }
    /**
    ...
    export interface Schema$WatchCreativeRequest {
        /**
         * The Pub/Sub topic to publish notifications to. This topic must already exist and must give permission to ad-exchange-buyside-reports@google.com to write to the topic. This should be the full resource name in "projects/{projectid\}/topics/{topicid\}" format.
         */
        topic?: string | null;
    }
    ...
    export class Resource$Accounts$Creatives {
         ...
         *     pageToken: 'placeholder-value',
         *     // An optional query string to filter creatives. If no filter is specified, all active creatives will be returned. Supported queries are: - accountId=*accountid_string* - creativeId=*creativeid_string* - dealsStatus: {approved, conditionally_approved, disapproved, not_checked\} - openAuctionStatus: {approved, conditionally_approved, disapproved, not_checked\} - attribute: {a numeric attribute from the list of attributes\} - disapprovalReason: {a reason from DisapprovalReason\} Example: 'accountId=12345 AND (dealsStatus:disapproved AND disapprovalReason:unacceptable_content) OR attribute:47'
    ...
    export class Resource$Accounts$Creatives$Dealassociations {
         ...
         *     pageToken: 'placeholder-value',
         *     // An optional query string to filter deal associations. If no filter is specified, all associations will be returned. Supported queries are: - accountId=*accountid_string* - creativeId=*creativeid_string* - dealsId=*dealsid_string* - dealsStatus:{approved, conditionally_approved, disapproved, not_checked\} - openAuctionStatus:{approved, conditionally_approved, disapproved, not_checked\} Example: 'dealsId=12345 AND dealsStatus:disapproved'
         *     query: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Accounts$Finalizedproposals {
        ...
        /**
         * Update given deals to resume serving. This method will set the `DealServingMetadata.DealPauseStatus.has_buyer_paused` bit to false for all listed deals in the request. Currently, this method only applies to PG and PD deals. For PA deals, call accounts.proposals.resume endpoint. It is a no-op to resume running deals or deals paused by the other party. It is an error to call ResumeProposalDeals for deals which are not part of the proposal of proposalid or which are not finalized or renegotiating.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
    ...
    export class Resource$Accounts$Proposals {
        ...
        resume(callback: BodyResponseCallback<Schema$Proposal>): void;
        /**
         * Update the given proposal at the client known revision number. If the server revision has advanced since the passed-in `proposal.proposal_revision`, an `ABORTED` error message will be returned. Only the buyer-modifiable fields of the proposal will be updated. Note that the deals in the proposal will be updated to match the passed-in copy. If a passed-in deal does not have a `dealid`, the server will assign a new unique ID and create the deal. If passed-in deal has a `dealid`, it will be updated to match the passed-in copy. Any existing deals not present in the passed-in proposal will be deleted. It is an error to pass in a deal with a `dealid` not present at head.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
