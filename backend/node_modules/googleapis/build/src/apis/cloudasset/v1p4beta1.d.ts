...
export declare namespace cloudasset_v1p4beta1 {
    ...
    export interface Schema$GoogleCloudAssetV1p4beta1Identity {
        ...
        analysisState?: Schema$GoogleCloudAssetV1p4beta1AnalysisState;
        /**
         * The identity name in any form of members appear in [IAM policy binding](https://cloud.google.com/iam/reference/rest/v1/Binding), such as: - user:foo@google.com - group:group1@google.com - serviceAccount:s1@prj1.iam.gserviceaccount.com - projectOwner:some_projectid - domain:google.com - allUsers - etc.
         */
        name?: string | null;
    }
