...
export declare namespace cloudasset_v1 {
    ...
    export interface Schema$CreateFeedRequest {
        /**
         * Required. The feed details. The field `name` must be empty and it will be generated in the format of: projects/project_number/feeds/feedid folders/folder_number/feeds/feedid organizations/organization_number/feeds/feedid
         */
        feed?: Schema$Feed;
        /**
    ...
    export interface Schema$Feed {
        ...
        /**
         * Required. The format will be projects/{project_number\}/feeds/{client-assigned_feedidentifier\} or folders/{folder_number\}/feeds/{client-assigned_feedidentifier\} or organizations/{organization_number\}/feeds/{client-assigned_feedidentifier\} The client-assigned feed identifier must be unique within the parent project/folder/organization.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudAssetV1CustomConstraint {
        ...
        /**
         * Name of the constraint. This is unique within the organization. Format of the name should be * `organizations/{organizationid\}/customConstraints/{custom_constraintid\}` Example : "organizations/123/customConstraints/custom.createOnlyE2TypeVms"
         */
        name?: string | null;
        /**
    ...
    export interface Schema$IamPolicyAnalysisQuery {
        ...
        /**
         * Required. The relative name of the root asset. Only resources and IAM policies within the scope will be analyzed. This can only be an organization number (such as "organizations/123"), a folder number (such as "folders/123"), a project ID (such as "projects/my-project-id"), or a project number (such as "projects/12345"). To know how to get organization ID, visit [here ](https://cloud.google.com/resource-manager/docs/creating-managing-organization#retrieving_your_organizationid). To know how to get folder or project ID, visit [here ](https://cloud.google.com/resource-manager/docs/creating-managing-folders#viewing_or_listing_folders_and_projects).
         */
        scope?: string | null;
    }
    /**
    ...
    export interface Schema$Inventory {
        ...
        /**
         * Output only. The `Inventory` API resource name. Format: `projects/{project_number\}/locations/{location\}/instances/{instanceid\}/inventory`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$SavedQuery {
        ...
        /**
         * The resource name of the saved query. The format must be: * projects/project_number/savedQueries/saved_queryid * folders/folder_number/savedQueries/saved_queryid * organizations/organization_number/savedQueries/saved_queryid
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$UpdateFeedRequest {
        /**
         * Required. The new values of feed details. It must match an existing feed and the field `name` must be in the format of: projects/project_number/feeds/feedid or folders/folder_number/feeds/feedid or organizations/organization_number/feeds/feedid.
         */
        feed?: Schema$Feed;
        /**
    ...
    export class Resource$Feeds {
         ...
         *     // Required. The name of the feed and it must be in the format of: projects/project_number/feeds/feedid folders/folder_number/feeds/feedid organizations/organization_number/feeds/feedid
         *     name: '[^/]+/[^/]+/feeds/my-feed',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Savedqueries {
         ...
         *     // Required. The name of the saved query to delete. It must be in the format of: * projects/project_number/savedQueries/saved_queryid * folders/folder_number/savedQueries/saved_queryid * organizations/organization_number/savedQueries/saved_queryid
         ...
         *     // Required. The name of the saved query and it must be in the format of: * projects/project_number/savedQueries/saved_queryid * folders/folder_number/savedQueries/saved_queryid * organizations/organization_number/savedQueries/saved_queryid
         *     name: '[^/]+/[^/]+/savedQueries/my-savedQuerie',
         *   });
         *   console.log(res.data);
         *
