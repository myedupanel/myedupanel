...
export declare namespace cloudresourcemanager_v3 {
    ...
    export interface Schema$Capability {
        /**
         * Immutable. Identifier. The resource name of the capability. Must be in the following form: * `folders/{folderid\}/capabilities/{capability_name\}` For example, `folders/123/capabilities/app-management` Following are the allowed {capability_name\} values: * `app-management`
         */
        name?: string | null;
        /**
    ...
    export interface Schema$EffectiveTag {
        ...
        /**
         * The namespaced name of the TagKey. Can be in the form `{organizationid\}/{tag_key_short_name\}` or `{projectid\}/{tag_key_short_name\}` or `{project_number\}/{tag_key_short_name\}`.
         */
        namespacedTagKey?: string | null;
        /**
         * The namespaced name of the TagValue. Can be in the form `{organizationid\}/{tag_key_short_name\}/{tag_value_short_name\}` or `{projectid\}/{tag_key_short_name\}/{tag_value_short_name\}` or `{project_number\}/{tag_key_short_name\}/{tag_value_short_name\}`.
         */
        ...
        tagKey?: string | null;
        /**
         * The parent name of the tag key. Must be in the format `organizations/{organizationid\}` or `projects/{project_number\}`
         */
    ...
    export interface Schema$Folder {
        ...
        /**
         * Identifier. The resource name of the folder. Its format is `folders/{folderid\}`, for example: "folders/1234".
         */
        name?: string | null;
        /**
    ...
    export interface Schema$MoveFolderRequest {
        /**
         * Required. The resource name of the folder or organization which should be the folder's new parent. Must be of the form `folders/{folderid\}` or `organizations/{orgid\}`.
         */
        destinationParent?: string | null;
    }
    /**
    ...
    export interface Schema$TagBinding {
        ...
        tagValue?: string | null;
        /**
         * The namespaced name for the TagValue of the TagBinding. Must be in the format `{parentid\}/{tag_key_short_name\}/{short_name\}`. For methods that support TagValue namespaced name, only one of tag_value_namespaced_name or tag_value may be filled. Requests with both fields will be rejected.
         */
    ...
    export interface Schema$TagKey {
        ...
        etag?: string | null;
        /**
         * Immutable. The resource name for a TagKey. Must be in the format `tagKeys/{tag_keyid\}`, where `tag_keyid` is the generated numeric id for the TagKey.
         */
        name?: string | null;
        /**
        ...
        /**
         * Immutable. The resource name of the TagKey's parent. A TagKey can be parented by an Organization or a Project. For a TagKey parented by an Organization, its parent must be in the form `organizations/{orgid\}`. For a TagKey parented by a Project, its parent can be in the form `projects/{projectid\}` or `projects/{project_number\}`.
         */
        parent?: string | null;
        /**
    ...
    export interface Schema$TagValue {
        ...
        name?: string | null;
        /**
         * Output only. The namespaced name of the TagValue. Can be in the form `{organizationid\}/{tag_key_short_name\}/{tag_value_short_name\}` or `{projectid\}/{tag_key_short_name\}/{tag_value_short_name\}` or `{project_number\}/{tag_key_short_name\}/{tag_value_short_name\}`.
         */
        namespacedName?: string | null;
        /**
         * Immutable. The resource name of the new TagValue's parent TagKey. Must be of the form `tagKeys/{tag_keyid\}`.
         */
        parent?: string | null;
        /**
    ...
    export class Resource$Folders {
         ...
         *     // Required. The resource name of the folder to be deleted. Must be of the form `folders/{folderid\}`.
        ...
        /**
         * Retrieves a folder identified by the supplied resource name. Valid folder resource names have the format `folders/{folderid\}` (for example, `folders/1234`). The caller must have `resourcemanager.folders.get` permission on the identified folder.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *     // Required. The resource name of the folder to retrieve. Must be of the form `folders/{folderid\}`.
         *     name: 'folders/my-folder',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The resource name of the Folder to move. Must be of the form folders/{folderid\}
         *     name: 'folders/my-folder',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the folder to undelete. Must be of the form `folders/{folderid\}`.
         *     name: 'folders/my-folder',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The name of the parent resource whose projects are being listed. Only children of this parent resource are listed; descendants are not listed. If the parent is a folder, use the value `folders/{folderid\}`. If the parent is an organization, use the value `organizations/{orgid\}`.
         *     parent: 'placeholder-value',
    ...
    export class Resource$Tagkeys {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The resource name of the TagKey's parent. Must be of the form `organizations/{orgid\}` or `projects/{projectid\}` or `projects/{project_number\}`
         *     parent: 'placeholder-value',
         *   });
         *   console.log(res.data);
         *
