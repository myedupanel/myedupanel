...
export declare namespace cloudresourcemanager_v2beta1 {
    ...
    export interface Schema$Folder {
        ...
        /**
         * Output only. The resource name of the Folder. Its format is `folders/{folderid\}`, for example: "folders/1234".
         */
        name?: string | null;
        /**
    ...
    export interface Schema$MoveFolderRequest {
        /**
         * Required. The resource name of the Folder or Organization to reparent the folder under. Must be of the form `folders/{folderid\}` or `organizations/{orgid\}`.
         */
        destinationParent?: string | null;
    }
    /**
    ...
    export class Resource$Folders {
         ...
         *     // Required. The resource name of the new Folder's parent. Must be of the form `folders/{folderid\}` or `organizations/{orgid\}`.
         ...
         *     // Required. The resource name of the Organization or Folder whose Folders are being listed. Must be of the form `folders/{folderid\}` or `organizations/{orgid\}`. Access to this method is controlled by checking the `resourcemanager.folders.list` permission on the `parent`.
         *     parent: 'placeholder-value',
