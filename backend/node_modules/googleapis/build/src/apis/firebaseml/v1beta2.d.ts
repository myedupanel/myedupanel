...
export declare namespace firebaseml_v1beta2 {
    ...
    export interface Schema$Model {
        ...
        /**
         * The resource name of the Model. Model names have the form `projects/{projectid\}/models/{modelid\}` The name is ignored when creating a model.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$ModelOperationMetadata {
        ...
        /**
         * The name of the model we are creating/updating The name must have the form `projects/{projectid\}/models/{modelid\}`
         */
        name?: string | null;
    }
    /**
    ...
    export class Resource$Projects$Models {
         ...
         *     // Required. The parent project resource where the model is to be created. The parent must have the form `projects/{projectid\}`
         ...
         *     // Required. The name of the model to delete. The name must have the form `projects/{projectid\}/models/{modelid\}`
         ...
         *     // Required. The name of the model to get. The name must have the form `projects/{projectid\}/models/{modelid\}`
         *     name: 'projects/my-project/models/my-model',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. The name of the parent to list models for. The parent must have the form `projects/{projectid\}'
         *     parent: 'projects/my-project',
         *   });
         *   console.log(res.data);
         *
