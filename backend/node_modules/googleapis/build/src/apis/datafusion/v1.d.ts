...
export declare namespace datafusion_v1 {
    ...
    export interface Schema$EventPublishConfig {
        ...
        /**
         * Required. The resource name of the Pub/Sub topic. Format: projects/{projectid\}/topics/{topicid\}
         */
        topic?: string | null;
    }
    /**
    ...
    export interface Schema$Instance {
        ...
        /**
         * Output only. Deprecated. Use tenant_projectid instead to extract the tenant project ID.
         */
