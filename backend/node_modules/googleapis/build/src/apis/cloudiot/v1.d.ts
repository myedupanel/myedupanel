...
export declare namespace cloudiot_v1 {
    ...
    export interface Schema$BindDeviceToGatewayRequest {
        /**
         * Required. The device to associate with the specified gateway. The value of `deviceid` can be either the device numeric ID or the user-defined device identifier.
         */
        deviceId?: string | null;
        /**
         * Required. The value of `gatewayid` can be either the device numeric ID or the user-defined device identifier.
         */
    ...
    export interface Schema$UnbindDeviceFromGatewayRequest {
        /**
         * Required. The device to disassociate from the specified gateway. The value of `deviceid` can be either the device numeric ID or the user-defined device identifier.
         */
        deviceId?: string | null;
        /**
         * Required. The value of `gatewayid` can be either the device numeric ID or the user-defined device identifier.
    ...
    export class Resource$Projects$Locations$Registries$Devices {
         ...
         *     // Required. The name of the device. For example, `projects/p0/locations/us-central1/registries/registry0/devices/device0` or `projects/p0/locations/us-central1/registries/registry0/devices/{numid\}`.
         ...
         *     // The fields of the `Device` resource to be returned in the response. The fields `id` and `numid` are always returned, along with any other fields specified in snake_case format, for example: `last_heartbeat_time`.
         *     fieldMask: 'placeholder-value',
         *     // If set, returns only the gateways with which the specified device is associated. The device ID can be numeric (`numid`) or the user-defined string (`id`). For example, if `456` is specified, returns only the gateways to which the device with `numid` 456 is bound.
