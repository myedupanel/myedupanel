...
export declare namespace monitoring_v1 {
    ...
    export interface Schema$TableDataSet {
        ...
        /**
         * Optional. A template string for naming TimeSeries in the resulting data set. This should be a string with interpolations of the form ${label_name\}, which will resolve to the label's value i.e. "${resource.labels.projectid\}."
         */
