...
export declare namespace jobs_v3p1beta1 {
    ...
    export interface Schema$ClientEvent {
        ...
        /**
         * Required. A unique identifier, generated by the client application. This `eventid` is used to establish the relationship between different events (see parent_eventid).
         */
        eventId?: string | null;
        /**
        ...
        /**
         * Required. A unique ID generated in the API responses. It can be found in ResponseMetadata.requestid.
         */
    ...
    export interface Schema$Company {
        ...
        /**
         * Required during company update. The resource name for a company. This is generated by the service when a company is created. The format is "projects/{projectid\}/companies/{companyid\}", for example, "projects/api-test-project/companies/foo".
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Job {
        /**
         * Optional but strongly recommended for the best service experience. Location(s) where the employer is looking to hire for this job posting. Specifying the full street address(es) of the hiring location enables better API results, especially job searches by commute time. At most 50 locations are allowed for best search performance. If a job has more locations, it is suggested to split it into multiple jobs with unique requisitionids (e.g. 'ReqA' becomes 'ReqA-1', 'ReqA-2', etc.) as multiple jobs with the same company_name, language_code and requisitionid are not allowed. If the original requisitionid must be preserved, a custom field should be used for storage. It is also suggested to group the locations that close to each other in the same job for better search experience. Jobs with multiple addresses must have their addresses with the same LocationType to allow location filtering to work properly. (For example, a Job with addresses "1600 Amphitheatre Parkway, Mountain View, CA, USA" and "London, UK" may not have location filters applied correctly at search time since the first is a LocationType.STREET_ADDRESS and the second is a LocationType.LOCALITY.) If a job needs to have multiple addresses, it is suggested to split it into multiple jobs with same LocationTypes. The maximum number of allowed characters is 500.
         */
        ...
        /**
         * Required. The requisition ID, also referred to as the posting ID, assigned by the client to identify a job. This field is intended to be used by clients for client identification and tracking of postings. A job is not allowed to be created if there is another job with the same [company_name], language_code and requisitionid. The maximum number of allowed characters is 255.
         */
    ...
    export interface Schema$RequestMetadata {
        ...
        domain?: string | null;
        /**
         * Required. A unique session identification string. A session is defined as the duration of an end user's interaction with the service over a certain period. Obfuscate this field for privacy concerns before providing it to the service. If this field is not available for some reason, send "UNKNOWN". Note that any improvements to the model for a particular tenant site, rely on this field being set correctly to some unique sessionid. The maximum number of allowed characters is 255.
         */
        sessionId?: string | null;
        /**
         * Required. A unique user identification string, as determined by the client. To have the strongest positive impact on search quality make sure the client-level is unique. Obfuscate this field for privacy concerns before providing it to the service. If this field is not available for some reason, send "UNKNOWN". Note that any improvements to the model for a particular tenant site, rely on this field being set correctly to a unique userid. The maximum number of allowed characters is 255.
         */
        userId?: string | null;
    }
    /**
    ...
    export class Resource$Projects {
         ...
         *     // Optional. If provided, restricts completion to specified company. The format is "projects/{projectid\}/companies/{companyid\}", for example, "projects/api-test-project/companies/foo".
    ...
    export class Resource$Projects$Companies {
         ...
         *     // Required. The resource name of the company to be deleted. The format is "projects/{projectid\}/companies/{companyid\}", for example, "projects/api-test-project/companies/foo".
         ...
         *     // Required. The resource name of the company to be retrieved. The format is "projects/{projectid\}/companies/{companyid\}", for example, "projects/api-test-project/companies/foo".
         *     name: 'projects/my-project/companies/my-companie',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Jobs {
         ...
         *     // Required. The resource name of the job to be deleted. The format is "projects/{projectid\}/jobs/{jobid\}", for example, "projects/api-test-project/jobs/1234".
         ...
         *     // Required. The resource name of the job to retrieve. The format is "projects/{projectid\}/jobs/{jobid\}", for example, "projects/api-test-project/jobs/1234".
         *     name: 'projects/my-project/jobs/my-job',
         *   });
         *   console.log(res.data);
         *
