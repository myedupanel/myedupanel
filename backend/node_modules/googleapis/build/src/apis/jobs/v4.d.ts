...
export declare namespace jobs_v4 {
    ...
    export interface Schema$BatchDeleteJobsRequest {
        /**
         * The names of the jobs to delete. The format is "projects/{projectid\}/tenants/{tenantid\}/jobs/{jobid\}". For example, "projects/foo/tenants/bar/jobs/baz". A maximum of 200 jobs can be deleted in a batch.
         */
        names?: string[] | null;
    }
    /**
    ...
    export interface Schema$ClientEvent {
        ...
        /**
         * Strongly recommended for the best service experience. A unique ID generated in the API responses. It can be found in ResponseMetadata.requestid.
         */
    ...
    export interface Schema$Company {
        ...
        /**
         * Required during company update. The resource name for a company. This is generated by the service when a company is created. The format is "projects/{projectid\}/tenants/{tenantid\}/companies/{companyid\}", for example, "projects/foo/tenants/bar/companies/baz".
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Job {
        /**
         * Strongly recommended for the best service experience. Location(s) where the employer is looking to hire for this job posting. Specifying the full street address(es) of the hiring location enables better API results, especially job searches by commute time. At most 50 locations are allowed for best search performance. If a job has more locations, it is suggested to split it into multiple jobs with unique requisitionids (e.g. 'ReqA' becomes 'ReqA-1', 'ReqA-2', and so on.) as multiple jobs with the same company, language_code and requisitionid are not allowed. If the original requisitionid must be preserved, a custom field should be used for storage. It is also suggested to group the locations that close to each other in the same job for better search experience. Jobs with multiple addresses must have their addresses with the same LocationType to allow location filtering to work properly. (For example, a Job with addresses "1600 Amphitheatre Parkway, Mountain View, CA, USA" and "London, UK" may not have location filters applied correctly at search time since the first is a LocationType.STREET_ADDRESS and the second is a LocationType.LOCALITY.) If a job needs to have multiple addresses, it is suggested to split it into multiple jobs with same LocationTypes. The maximum number of allowed characters is 500.
         */
        ...
        /**
         * Required. The resource name of the company listing the job. The format is "projects/{projectid\}/tenants/{tenantid\}/companies/{companyid\}". For example, "projects/foo/tenants/bar/companies/baz".
         */
        company?: string | null;
        /**
        ...
        /**
         * Required during job update. The resource name for the job. This is generated by the service when a job is created. The format is "projects/{projectid\}/tenants/{tenantid\}/jobs/{jobid\}". For example, "projects/foo/tenants/bar/jobs/baz". Use of this field in job queries and API calls is preferred over the use of requisitionid since this value is unique.
         */
        name?: string | null;
        /**
        ...
        /**
         * Required. The requisition ID, also referred to as the posting ID, is assigned by the client to identify a job. This field is intended to be used by clients for client identification and tracking of postings. A job isn't allowed to be created if there is another job with the same company, language_code and requisitionid. The maximum number of allowed characters is 255.
         */
    ...
    export interface Schema$JobResult {
        /**
         * Here Job only contains basic information including name, company, language_code and requisitionid, use getJob method to retrieve detailed information of the created/updated job.
         */
        job?: Schema$Job;
        /**
    ...
    export class Resource$Projects$Tenants {
         ...
         *     // If provided, restricts completion to specified company. The format is "projects/{projectid\}/tenants/{tenantid\}/companies/{companyid\}", for example, "projects/foo/tenants/bar/companies/baz".
         ...
         *     // Required. The resource name of the tenant to be deleted. The format is "projects/{projectid\}/tenants/{tenantid\}", for example, "projects/foo/tenants/bar".
         ...
         *     // Required. The resource name of the tenant to be retrieved. The format is "projects/{projectid\}/tenants/{tenantid\}", for example, "projects/foo/tenants/bar".
         *     name: 'projects/my-project/tenants/my-tenant',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Tenants$Clientevents {
         ...
         *     // Required. Resource name of the tenant under which the event is created. The format is "projects/{projectid\}/tenants/{tenantid\}", for example, "projects/foo/tenants/bar".
    ...
    export class Resource$Projects$Tenants$Companies {
         ...
         *     // Required. Resource name of the tenant under which the company is created. The format is "projects/{projectid\}/tenants/{tenantid\}", for example, "projects/foo/tenants/bar".
         *     parent: 'projects/my-project/tenants/my-tenant',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the company to be deleted. The format is "projects/{projectid\}/tenants/{tenantid\}/companies/{companyid\}", for example, "projects/foo/tenants/bar/companies/baz".
         ...
         *     // Required. The resource name of the company to be retrieved. The format is "projects/{projectid\}/tenants/{tenantid\}/companies/{companyid\}", for example, "projects/api-test-project/tenants/foo/companies/bar".
         *     name: 'projects/my-project/tenants/my-tenant/companies/my-companie',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Tenants$Jobs {
         ...
         *     // Required. The resource name of the tenant under which the job is created. The format is "projects/{projectid\}/tenants/{tenantid\}". For example, "projects/foo/tenants/bar".
         *     parent: 'projects/my-project/tenants/my-tenant',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the tenant under which the job is created. The format is "projects/{projectid\}/tenants/{tenantid\}". For example, "projects/foo/tenants/bar". The parent of all of the jobs specified in `names` must match this field.
         *     parent: 'projects/my-project/tenants/my-tenant',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. The resource name of the job to be deleted. The format is "projects/{projectid\}/tenants/{tenantid\}/jobs/{jobid\}". For example, "projects/foo/tenants/bar/jobs/baz".
         ...
         *     // Required. The resource name of the job to retrieve. The format is "projects/{projectid\}/tenants/{tenantid\}/jobs/{jobid\}". For example, "projects/foo/tenants/bar/jobs/baz".
         *     name: 'projects/my-project/tenants/my-tenant/jobs/my-job',
         *   });
         *   console.log(res.data);
         *
