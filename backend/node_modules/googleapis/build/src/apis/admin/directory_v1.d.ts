...
export declare namespace admin_directory_v1 {
    ...
    export interface Schema$CreatePrinterRequest {
        /**
         * Required. The name of the customer. Format: customers/{customerid\}
         */
        parent?: string | null;
        /**
         * Required. A printer to create. If you want to place the printer under particular OU then populate printer.org_unitid filed. Otherwise the printer will be placed under root OU.
         */
    ...
    export interface Schema$CreatePrintServerRequest {
        ...
        parent?: string | null;
        /**
         * Required. A print server to create. If you want to place the print server under a specific organizational unit (OU), then populate the `org_unitid`. Otherwise the print server is created under the root OU. The `org_unitid` can be retrieved using the [Directory API](https://developers.google.com/workspace/admin/directory/v1/guides/manage-org-units).
         */
    ...
    export interface Schema$ListPrintersResponse {
        ...
        nextPageToken?: string | null;
        /**
         * List of printers. If `org_unitid` was given in the request, then only printers visible for this OU will be returned. If `org_unitid` was not given in the request, then all printers will be returned.
         */
        printers?: Schema$Printer[];
    }
    ...
    export interface Schema$PrintServer {
        ...
        name?: string | null;
        /**
         * ID of the organization unit (OU) that owns this print server. This value can only be set when the print server is initially created. If it's not populated, the print server is placed under the root OU. The `org_unitid` can be retrieved using the [Directory API](https://developers.google.com/workspace/admin/directory/reference/rest/v1/orgunits).
         */
        orgUnitId?: string | null;
        /**
    ...
    export interface Schema$RoleAssignment {
        /**
         * The unique ID of the entity this role is assigned to—either the `userid` of a user, the `groupid` of a group, or the `uniqueId` of a service account as defined in [Identity and Access Management (IAM)](https://cloud.google.com/iam/docs/reference/rest/v1/projects.serviceAccounts).
         */
    ...
    export class Resource$Customers$Chrome$Printers {
         ...
         *     // Required. The name of the printer to be updated. Format: customers/{customerid\}/chrome/printers/{printerid\}
         ...
         *     // Required. The name of the printer to retrieve. Format: customers/{customerid\}/chrome/printers/{printerid\}
         *     name: 'customers/my-customer/chrome/printers/my-printer',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. The name of the customer who owns this collection of printers. Format: customers/{customerid\}
         *     parent: 'customers/my-customer',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Customers$Chrome$Printservers {
         ...
         *     orderBy: 'placeholder-value',
         *     // If `org_unitid` is present in the request, only print servers owned or inherited by the organizational unit (OU) are returned. If the `PrintServer` resource's `org_unitid` matches the one in the request, the OU owns the server. If `org_unitid` is not specified in the request, all print servers are returned or filtered against.
         *     orgUnitId: 'placeholder-value',
