...
export declare namespace streetviewpublish_v1 {
    ...
    export interface Schema$UploadRef {
        /**
         * An upload reference should be unique for each user. It follows the form: "https://streetviewpublish.googleapis.com/media/user/{accountid\}/photo/{upload_reference\}"
         */
    ...
    export class Resource$Photo {
         ...
         *     // The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier. If language_code is unspecified, the user's language preference for Google services is used.
    ...
    export class Resource$Photos {
         ...
         *     // Optional. The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_localeidentifier. If language_code is unspecified, the user's language preference for Google services is used.
         *     languageCode: 'placeholder-value',
