...
export declare namespace managedidentities_v1beta1 {
    ...
    export interface Schema$Domain {
        ...
        /**
         * Output only. The unique name of the domain using the form: `projects/{projectid\}/locations/global/domains/{domain_name\}`.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Global$Domains$Sqlintegrations {
         ...
         *       {
         *         // Required. SqlIntegration resource name using the form: `projects/{projectid\}/locations/global/domains/x/sqlIntegrations/{name\}`
