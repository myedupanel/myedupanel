...
export declare namespace managedidentities_v1alpha1 {
    ...
    export interface Schema$Backup {
        ...
        /**
         * Output only. The unique name of the Backup in the form of projects/{projectid\}/locations/global/domains/{domain_name\}/backups/{name\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Domain {
        ...
        /**
         * Output only. Unique name of the domain in this scope including projects and location using the form: `projects/{projectid\}/locations/global/domains/{domain_name\}`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudSaasacceleratorManagementProvidersV1Instance {
        ...
        createTime?: string | null;
        /**
         * Optional. The instance_type of this instance of format: projects/{project_number\}/locations/{locationid\}/instanceTypes/{instance_typeid\}. Instance Type represents a high-level tier or SKU of the service that this instance belong to. When enabled(eg: Maintenance Rollout), Rollout uses 'instance_type' along with 'software_versions' to determine whether instance needs an update or not.
         */
        ...
        /**
         * Unique name of the resource. It uses the form: `projects/{project_number\}/locations/{locationid\}/instances/{instanceid\}` Note: This name is passed, stored and logged across the rollout system. So use of consumer projectid or any other consumer PII in the name is strongly discouraged for wipeout (go/wipeout) compliance. See go/elysium/projectids#storage-guidance for more details.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata {
        ...
        location?: string | null;
        /**
         * The id of the node. This should be equal to SaasInstanceNode.nodeid.
         */
        nodeId?: string | null;
        /**
    ...
    export interface Schema$MaintenancePolicy {
        ...
        /**
         * Required. MaintenancePolicy name using the form: `projects/{projectid\}/locations/{locationid\}/maintenancePolicies/{maintenance_policyid\}` where {projectid\} refers to a GCP consumer project ID, {locationid\} refers to a GCP region/zone, {maintenance_policyid\} must be 1-63 characters long and match the regular expression `[a-z0-9]([-a-z0-9]*[a-z0-9])?`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$Peering {
        ...
        createTime?: string | null;
        /**
         * Required. Full domain resource path for the Managed AD Domain involved in peering. The resource path should be in the form: `projects/{projectid\}/locations/global/domains/{domain_name\}`
         */
    ...
    export interface Schema$SQLIntegration {
        ...
        createTime?: string | null;
        /**
         * The unique name of the sql integration in the form of `projects/{projectid\}/locations/global/domains/{domain_name\}/sqlIntegrations/{sql_integration\}`
         */
        name?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Global$Domains {
         ...
         *       // The resource domain name, project name and location using the form: `projects/{projectid\}/locations/global/domains/{domain_name\}`
         ...
         *       {
         *         // Required. The domain resource name using the form: `projects/{projectid\}/locations/global/domains/{domain_name\}`
         ...
         *     // Resource project name and location using the form: `projects/{projectid\}/locations/global`
         ...
         *     // Domain resource name using the form: `projects/{projectid\}/locations/global/domains/{domain_name\}`
         *     name: 'projects/my-project/locations/global/domains/my-domain',
         *   });
         *   console.log(res.data);
         *
        ...
        /**
         * Resets managed identities admin password identified by managedidentities_admin_name
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
         ...
         *       {
         *         // The domain resource name using the form: `projects/{projectid\}/locations/global/domains/{domain_name\}`
         *         name: 'projects/my-project/locations/global/domains/my-domain',
         *
         *         // Request body metadata
         *         requestBody: {
    ...
    export class Resource$Projects$Locations$Global$Domains$Backups {
         ...
         *       // Required. The backup resource name using the form: `projects/{projectid\}/locations/global/domains/{domain_name\}/backups/{backupid\}`
    ...
    export class Resource$Projects$Locations$Global$Domains$Sqlintegrations {
         ...
         *       {
         *         // Required. MangedOU resource name using the form: `projects/{projectid\}/locations/global/domains/x/sqlIntegrations/{name\}`
         ...
         *         // Optional. The next_page_token value returned from a previous List request, if any.
         *         pageToken: 'placeholder-value',
         *         // Required. The resource name of the SqlIntegrations using the form: `projects/{projectid\}/locations/global/domains/x`
         *         parent: 'projects/my-project/locations/global/domains/my-domain',
         *       },
         *     );
         *   console.log(res.data);
    ...
    export class Resource$Projects$Locations$Global$Peerings {
         ...
         *     {
         *       // Required. Resource project name and location using the form: `projects/{projectid\}/locations/global`
         *       parent: 'projects/my-project/locations/global',
         ...
         *     {
         *       // Required. Peering resource name using the form: `projects/{projectid\}/locations/global/peerings/{peeringid\}`
