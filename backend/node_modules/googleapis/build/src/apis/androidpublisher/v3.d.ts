...
export declare namespace androidpublisher_v3 {
    ...
    export interface Schema$OneTimePurchaseDetails {
        ...
        offerId?: string | null;
        /**
         * ID of the purchase option. This field is set for both purchase options and variant offers. For purchase options, this ID identifies the purchase option itself. For variant offers, this ID refers to the associated purchase option, and in conjunction with offerid it identifies the variant offer.
         */
        purchaseOptionId?: string | null;
        /**
    ...
    export interface Schema$SubscriptionPurchaseV2 {
        ...
        kind?: string | null;
        /**
         * Deprecated: Use line_items.latest_successful_orderid instead. The order id of the latest order associated with the purchase of the subscription. For autoRenewing subscription, this is the order id of signup order if it is not renewed yet, or the last recurring order id (success, pending, or declined order). For prepaid subscription, this is the order id associated with the queried purchase token.
         */
    ...
    export interface Schema$UpdateOneTimeProductOfferRequest {
        /**
         * Optional. If set to true, and the offer with the given package_name, productid, purchase_optionid and offerid doesn't exist, an offer will be created. If a new offer is created, the update_mask is ignored.
         */
        allowMissing?: boolean | null;
        /**
    ...
    export interface Schema$UpdateOneTimeProductRequest {
        /**
         * Optional. If set to true, and the one-time product with the given package_name and productid doesn't exist, the one-time product will be created. If a new one-time product is created, update_mask is ignored.
         */
        allowMissing?: boolean | null;
        /**
    ...
    export interface Schema$UpdateSubscriptionOfferRequest {
        /**
         * Optional. If set to true, and the subscription offer with the given package_name, productid, base_planid and offerid doesn't exist, an offer will be created. If a new offer is created, update_mask is ignored.
         */
        allowMissing?: boolean | null;
        /**
         * Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive.
    ...
    export interface Schema$UpdateSubscriptionRequest {
        /**
         * Optional. If set to true, and the subscription with the given package_name and productid doesn't exist, the subscription will be created. If a new subscription is created, update_mask is ignored.
         */
        allowMissing?: boolean | null;
        /**
         * Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive.
    ...
    export class Resource$Monetization$Onetimeproducts$Purchaseoptions$Offers {
         ...
         *         pageSize: 'placeholder-value',
         *         // Optional. A page token, received from a previous `ListOneTimeProductsOffers` call. Provide this to retrieve the subsequent page. When paginating, productid, package_name and purchase_optionid provided to `ListOneTimeProductsOffersRequest` must match the call that provided the page token.
         *         pageToken: 'placeholder-value',
    ...
    export class Resource$Monetization$Subscriptions$Baseplans$Offers {
         ...
         *       // Required. The parent base plan (ID) for which the offer should be created. Must be equal to the base_planid field on the SubscriptionOffer resource.
         *       basePlanId: 'placeholder-value',
