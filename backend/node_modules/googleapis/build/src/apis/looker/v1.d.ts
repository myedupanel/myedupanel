...
export declare namespace looker_v1 {
    ...
    export interface Schema$InstanceBackup {
        ...
        /**
         * Immutable. The relative resource name of the backup, in the following form: `projects/{project_number\}/locations/{locationid\}/instances/{instanceid\}/backups/{backup\}`
         */
        name?: string | null;
        /**
