...
export declare namespace gkebackup_v1 {
    ...
    export interface Schema$Backup {
        ...
        /**
         * Output only. Server generated global unique identifier of [UUID4](https://en.wikipedia.org/wiki/Universally_uniqueidentifier)
         */
        uid?: string | null;
        /**
    ...
    export interface Schema$BackupChannel {
        ...
        name?: string | null;
        /**
         * Output only. Server generated global unique identifier of [UUID](https://en.wikipedia.org/wiki/Universally_uniqueidentifier) format.
         */
        uid?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Restorechannels {
         ...
         *     // Identifier. The fully qualified name of the RestoreChannel. `projects/x/locations/x/restoreChannels/x`
         *     name: 'projects/my-project/locations/my-location/restoreChannels/my-restoreChannel',
         *     // Optional. This is used to specify the fields to be overwritten in the RestoreChannel targeted for update. The values for each of these updated fields will be taken from the `restore_channel` provided with this request. Field names are relative to the root of the resource (e.g., `description`, `destination_projectid`, etc.) If no `update_mask` is provided, all fields in `restore_channel` will be written to the target RestoreChannel resource. Note that OUTPUT_ONLY and IMMUTABLE fields in `restore_channel` are ignored and are not used to update the target RestoreChannel.
         *     updateMask: 'placeholder-value',
         *
         *     // Request body metadata
         *     requestBody: {
