...
export declare namespace mybusinessplaceactions_v1 {
    ...
    export interface Schema$PlaceActionLink {
        ...
        /**
         * Optional. The resource name, in the format `locations/{locationid\}/placeActionLinks/{place_action_linkid\}`. The name field will only be considered in UpdatePlaceActionLink and DeletePlaceActionLink requests for updating and deleting links respectively. However, it will be ignored in CreatePlaceActionLink request, where `place_action_linkid` will be assigned by the server on successful creation of a new link and returned as part of the response.
         */
        name?: string | null;
        /**
