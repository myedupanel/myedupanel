...
export declare namespace billingbudgets_v1beta1 {
    ...
    export interface Schema$GoogleCloudBillingBudgetsV1beta1Filter {
        ...
        /**
         * Optional. A set of subaccounts of the form `billingAccounts/{accountid\}`, specifying that usage from only this set of subaccounts should be included in the budget. If a subaccount is set to the name of the parent account, usage from the parent account will be included. If omitted, the report will include usage from the parent account and all subaccounts, if they exist.
         */
