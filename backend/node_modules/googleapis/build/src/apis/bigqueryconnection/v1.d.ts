...
export declare namespace bigqueryconnection_v1 {
    ...
    export interface Schema$Connection {
        ...
        /**
         * Optional. The Cloud KMS key that is used for credentials encryption. If omitted, internal Google owned encryption keys are used. Example: `projects/[kms_projectid]/locations/[region]/keyRings/[key_region]/cryptoKeys/[key]`
         */
    ...
    export interface Schema$SparkHistoryServerConfig {
        /**
         * Optional. Resource name of an existing Dataproc Cluster to act as a Spark History Server for the connection. Example: * `projects/[projectid]/regions/[region]/clusters/[cluster_name]`
         */
