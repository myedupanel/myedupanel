...
export declare namespace datalabeling_v1beta1 {
    ...
    export interface Schema$GoogleCloudDatalabelingV1alpha1CreateInstructionMetadata {
        ...
        /**
         * The name of the created Instruction. projects/{projectid\}/instructions/{instructionid\}
         */
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1AnnotatedDataset {
        ...
        /**
         * Output only. AnnotatedDataset resource name in format of: projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/ {annotated_datasetid\}
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1Annotation {
        ...
        /**
         * Output only. Unique name of this annotation, format is: projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_dataset\}/examples/{exampleid\}/annotations/{annotationid\}
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1AnnotationSpecSet {
        ...
        displayName?: string | null;
        /**
         * Output only. The AnnotationSpecSet resource name in the following format: "projects/{projectid\}/annotationSpecSets/{annotation_spec_setid\}"
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1BigQuerySource {
        /**
         * Required. BigQuery URI to a table, up to 2,000 characters long. If you specify the URI of a table that does not exist, Data Labeling Service creates a table at the URI with the correct schema when you create your EvaluationJob. If you specify the URI of a table that already exists, it must have the [correct schema](/ml-engine/docs/continuous-evaluation/create-job#table-schema). Provide the table URI in the following format: "bq://{your_projectid\}/ {your_dataset_name\}/{your_table_name\}" [Learn more](/ml-engine/docs/continuous-evaluation/create-job#table-schema).
         */
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1DataItem {
        ...
        /**
         * Output only. Name of the data item, in format of: projects/{projectid\}/datasets/{datasetid\}/dataItems/{data_itemid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1Dataset {
        ...
        /**
         * Output only. Dataset resource name, format is: projects/{projectid\}/datasets/{datasetid\}
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1Evaluation {
        ...
        /**
         * Output only. Resource name of an evaluation. The name has the following format: "projects/{projectid\}/datasets/{datasetid\}/evaluations/ {evaluationid\}'
         */
        name?: string | null;
    }
    /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1EvaluationJob {
        /**
         * Required. Name of the AnnotationSpecSet describing all the labels that your machine learning model outputs. You must create this resource before you create an evaluation job and provide its name in the following format: "projects/{projectid\}/annotationSpecSets/{annotation_spec_setid\}"
         */
        annotationSpecSet?: string | null;
        /**
        ...
        /**
         * Required. The [AI Platform Prediction model version](/ml-engine/docs/prediction-overview) to be evaluated. Prediction input and output is sampled from this model version. When creating an evaluation job, specify the model version in the following format: "projects/{projectid\}/models/{model_name\}/versions/{version_name\}" There can only be one evaluation job per model version.
         */
        modelVersion?: string | null;
        /**
         * Output only. After you create a job, Data Labeling Service assigns a name to the job with the following format: "projects/{projectid\}/evaluationJobs/ {evaluation_jobid\}"
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1Example {
        ...
        imagePayload?: Schema$GoogleCloudDatalabelingV1beta1ImagePayload;
        /**
         * Output only. Name of the example, in format of: projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/ {annotated_datasetid\}/examples/{exampleid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1ExportDataRequest {
        /**
         * Required. Annotated dataset resource name. DataItem in Dataset and their annotations in specified annotated dataset will be exported. It's in format of projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/ {annotated_datasetid\}
         */
        annotatedDataset?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1FeedbackMessage {
        ...
        image?: string | null;
        /**
         * Name of the feedback message in a feedback thread. Format: 'project/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}/feedbackThreads/{feedback_threadid\}/feedbackMessage/{feedback_messageid\}'
         */
        name?: string | null;
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1FeedbackThread {
        ...
        /**
         * Name of the feedback thread. Format: 'project/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}/feedbackThreads/{feedback_threadid\}'
         */
        name?: string | null;
    }
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1Instruction {
        ...
        displayName?: string | null;
        /**
         * Output only. Instruction resource name, format: projects/{projectid\}/instructions/{instructionid\}
         */
        name?: string | null;
        /**
    ...
    export interface Schema$GoogleCloudDatalabelingV1beta1SegmentationConfig {
        /**
         * Required. Annotation spec set resource name. format: projects/{projectid\}/annotationSpecSets/{annotation_spec_setid\}
         */
        annotationSpecSet?: string | null;
        /**
    ...
    export class Resource$Projects$Annotationspecsets {
         ...
         *     // Required. AnnotationSpecSet resource parent, format: projects/{projectid\}
         ...
         *     // Required. AnnotationSpec resource name, format: `projects/{projectid\}/annotationSpecSets/{annotation_spec_setid\}`.
         ...
         *     // Required. AnnotationSpecSet resource name, format: projects/{projectid\}/annotationSpecSets/{annotation_spec_setid\}
         *     name: 'projects/my-project/annotationSpecSets/my-annotationSpecSet',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Required. Parent of AnnotationSpecSet resource, format: projects/{projectid\}
         *     parent: 'projects/my-project',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Datasets {
         ...
         *     // Required. Dataset resource parent, format: projects/{projectid\}
         *     parent: 'projects/my-project',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. Dataset resource name, format: projects/{projectid\}/datasets/{datasetid\}
    ...
    export class Resource$Projects$Datasets$Annotateddatasets {
         ...
         *     // Required. Name of the annotated dataset to delete, format: projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/ {annotated_datasetid\}
         ...
         *     // Required. Name of the annotated dataset to get, format: projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/ {annotated_datasetid\}
         *     name: 'projects/my-project/datasets/my-dataset/annotatedDatasets/my-annotatedDataset',
         *   });
         *   console.log(res.data);
         *
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Name of the dataset to list annotated datasets, format: projects/{projectid\}/datasets/{datasetid\}
    ...
    export class Resource$Projects$Datasets$Annotateddatasets$Dataitems {
         ...
         *       // Required. The name of the data item to get, format: projects/{projectid\}/datasets/{datasetid\}/dataItems/{data_itemid\}
         ...
         *       pageToken: 'placeholder-value',
         *       // Required. Name of the dataset to list data items, format: projects/{projectid\}/datasets/{datasetid\}
         *       parent:
    ...
    export class Resource$Projects$Datasets$Annotateddatasets$Examples {
         ...
         *       filter: 'placeholder-value',
         *       // Required. Name of example, format: projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/ {annotated_datasetid\}/examples/{exampleid\}
    ...
    export class Resource$Projects$Datasets$Annotateddatasets$Feedbackthreads {
         ...
         *       {
         *         // Required. Name of the FeedbackThread that is going to be deleted. Format: 'projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}/feedbackThreads/{feedback_threadid\}'.
         ...
         *       // Required. Name of the feedback. Format: 'projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}/feedbackThreads/{feedback_threadid\}'.
         *       name: 'projects/my-project/datasets/my-dataset/annotatedDatasets/my-annotatedDataset/feedbackThreads/my-feedbackThread',
         *     });
         *   console.log(res.data);
         *
         ...
         *         pageToken: 'placeholder-value',
         *         // Required. FeedbackThread resource parent. Format: "projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}"
         *         parent:
         *           'projects/my-project/datasets/my-dataset/annotatedDatasets/my-annotatedDataset',
         *       },
         *     );
    ...
    export class Resource$Projects$Datasets$Annotateddatasets$Feedbackthreads$Feedbackmessages {
         ...
         *       {
         *         // Required. FeedbackMessage resource parent, format: projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}/feedbackThreads/{feedback_threadid\}.
         *         parent:
         ...
         *       {
         *         // Required. Name of the FeedbackMessage that is going to be deleted. Format: 'projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}/feedbackThreads/{feedback_threadid\}/feedbackMessages/{feedback_messageid\}'.
         ...
         *       {
         *         // Required. Name of the feedback. Format: 'projects/{projectid\}/datasets/{datasetid\}/annotatedDatasets/{annotated_datasetid\}/feedbackThreads/{feedback_threadid\}/feedbackMessages/{feedback_messageid\}'.
         *         name: 'projects/my-project/datasets/my-dataset/annotatedDatasets/my-annotatedDataset/feedbackThreads/my-feedbackThread/feedbackMessages/my-feedbackMessage',
         *       },
         *     );
         *   console.log(res.data);
    ...
    export class Resource$Projects$Datasets$Evaluations {
         ...
         *     // Required. Name of the evaluation. Format: "projects/{projectid\}/datasets/ {datasetid\}/evaluations/{evaluationid\}'
    ...
    export class Resource$Projects$Datasets$Evaluations$Examplecomparisons {
         ...
         *       // Required. Name of the Evaluation resource to search for example comparisons from. Format: "projects/{projectid\}/datasets/{datasetid\}/evaluations/ {evaluationid\}"
         *       parent:
    ...
    export class Resource$Projects$Datasets$Image {
         ...
         *     // Required. Name of the dataset to request labeling task, format: projects/{projectid\}/datasets/{datasetid\}
         *     parent: 'projects/my-project/datasets/my-dataset',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Datasets$Text {
         ...
         *     // Required. Name of the data set to request labeling task, format: projects/{projectid\}/datasets/{datasetid\}
         *     parent: 'projects/my-project/datasets/my-dataset',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Evaluationjobs {
         ...
         *     // Required. Evaluation job resource parent. Format: "projects/{projectid\}"
         *     parent: 'projects/my-project',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. Name of the evaluation job that is going to be deleted. Format: "projects/{projectid\}/evaluationJobs/{evaluation_jobid\}"
         ...
         *     // Required. Name of the evaluation job. Format: "projects/{projectid\} /evaluationJobs/{evaluation_jobid\}"
         *     name: 'projects/my-project/evaluationJobs/my-evaluationJob',
         *   });
         *   console.log(res.data);
         *
         ...
         *     // Optional. You can filter the jobs to list by modelid (also known as model_name, as described in EvaluationJob.modelVersion) or by evaluation job state (as described in EvaluationJob.state). To filter by both criteria, use the `AND` operator or the `OR` operator. For example, you can use the following string for your filter: "evaluation_job.modelid = {model_name\} AND evaluation_job.state = {evaluation_job_state\}"
         *     filter: 'placeholder-value',
         *     // Optional. Requested page size. Server may return fewer results than requested. Default value is 100.
         *     pageSize: 'placeholder-value',
         ...
         *     // Required. Name of the evaluation job that is going to be paused. Format: "projects/{projectid\}/evaluationJobs/{evaluation_jobid\}"
         *     name: 'projects/my-project/evaluationJobs/my-evaluationJob',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. Name of the evaluation job that is going to be resumed. Format: "projects/{projectid\}/evaluationJobs/{evaluation_jobid\}"
         *     name: 'projects/my-project/evaluationJobs/my-evaluationJob',
         *
         *     // Request body metadata
         *     requestBody: {
    ...
    export class Resource$Projects$Evaluations {
         ...
         *     pageToken: 'placeholder-value',
         *     // Required. Evaluation search parent (project ID). Format: "projects/ {projectid\}"
         *     parent: 'projects/my-project',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Instructions {
         ...
         *     // Required. Instruction resource parent, format: projects/{projectid\}
         *     parent: 'projects/my-project',
         *
         *     // Request body metadata
         *     requestBody: {
         ...
         *     // Required. Instruction resource name, format: projects/{projectid\}/instructions/{instructionid\}
