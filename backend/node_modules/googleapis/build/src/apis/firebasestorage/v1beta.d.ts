...
export declare namespace firebasestorage_v1beta {
    ...
    export class Resource$Projects {
         ...
         *     // Required. The name of the default bucket to delete, `projects/{projectid_or_number\}/defaultBucket`.
         ...
         *     // Required. The name of the default bucket to retrieve, `projects/{projectid_or_number\}/defaultBucket`.
         *     name: 'projects/my-project/defaultBucket',
         *   });
         *   console.log(res.data);
         *
    ...
    export class Resource$Projects$Buckets {
         ...
         *     // Required. Resource name of the bucket, mirrors the ID of the underlying Google Cloud Storage bucket, `projects/{projectid_or_number\}/buckets/{bucketid\}`.
         ...
         *     // Required. Resource name of the parent Firebase project, `projects/{projectid_or_number\}`.
    ...
    export class Resource$Projects$Defaultbucket {
         ...
         *     // Required. The parent resource where the default bucket will be created, `projects/{projectid_or_number\}`.
         *     parent: 'projects/my-project',
         *
         *     // Request body metadata
         *     requestBody: {
