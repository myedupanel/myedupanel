...
export declare namespace readerrevenuesubscriptionlinking_v1 {
    ...
    export class Resource$Publications$Readers {
         ...
         *       // Required. The resource name of the reader. Format: publications/{publicationid\}/readers/{ppid\}
         ...
         *       {
         *         // Required. The name of the reader entitlements to retrieve. Format: publications/{publicationid\}/readers/{readerid\}/entitlements
