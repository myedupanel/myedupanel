...
export declare namespace authorizedbuyersmarketplace_v1alpha {
    ...
    export interface Schema$AuctionPackage {
        ...
        /**
         * Immutable. The unique identifier for the auction package. Format: `buyers/{accountId\}/auctionPackages/{auctionPackageId\}` The auction_packageid part of name is sent in the BidRequest to all RTB bidders and is returned as dealid by the bidder in the BidResponse.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Buyers$Finalizeddeals {
        ...
        constructor(context: APIRequestContext);
        /**
         * Add creative to be used in the bidding process for a finalized deal. For programmatic guaranteed deals, it's recommended that you associate at least one approved creative with the deal before calling SetReadyToServe, to help reduce the number of bid responses filtered because they don't contain approved creatives. Creatives successfully added to a deal can be found in the Realtime-bidding Creatives API creative.dealids. This method only applies to programmatic guaranteed deals. Maximum number of 1000 creatives can be added to a finalized deal.
         * @example
         * ```js
         * // Before running the sample:
         * // - Enable the API at:
