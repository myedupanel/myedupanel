...
export declare namespace language_v1beta2 {
    ...
    export interface Schema$XPSColumnSpec {
        /**
         * The unique id of the column. When Preprocess, the Tables BE will popuate the order id of the column, which reflects the order of the column inside the table, i.e. 0 means the first column in the table, N-1 means the last column. AutoML BE will persist this order id in Spanner and set the order id here when calling RefreshTablesStats and Train. Note: it's different than the column_specid that is generated in AutoML BE.
         */
    ...
    export interface Schema$XPSConfusionMatrix {
        /**
         * For the following three repeated fields, only one is intended to be set. annotation_specid_token is preferable to be set. ID tokens of the annotation specs used in the confusion matrix.
         */
        annotationSpecIdToken?: string[] | null;
        /**
         * Category (mainly for segmentation). Set only for image segmentation models. Note: uCAIP Image Segmentation should use annotation_specid_token.
         */
        category?: number[] | null;
        /**
         * Rows in the confusion matrix. The number of rows is equal to the size of `annotation_specid_token`. `row[i].value[j]` is the number of examples that have ground truth of the `annotation_specid_token[i]` and are predicted as `annotation_specid_token[j]` by the model being evaluated.
         */
        row?: Schema$XPSConfusionMatrixRow[];
        /**
         * Sentiment labels used in the confusion matrix. Set only for text sentiment models. For AutoML Text Revamp, use `annotation_specid_token` instead and leave this field empty.
         */
    ...
    export interface Schema$XPSConfusionMatrixRow {
        ...
        count?: string[] | null;
        /**
         * Value of the specific cell in the confusion matrix. The number of values each row has (i.e. the length of the row) is equal to the length of the annotation_specid_token field.
         */
    ...
    export interface Schema$XPSEvaluationMetrics {
        /**
         * The annotation_spec for which this evaluation metrics instance had been created. Empty iff this is an overall model evaluation (like Tables evaluation metrics), i.e. aggregated across all labels. The value comes from the input annotations in AnnotatedExample. For MVP product or for text sentiment models where annotation_specid_token is not available, set label instead.
         */
        annotationSpecIdToken?: string | null;
        /**
         * The integer category label for which this evaluation metric instance had been created. Valid categories are 0 or higher. Overall model evaluation should set this to negative values (rather than implicit zero). Only used for Image Segmentation (prefer to set annotation_specid_token instead). Note: uCAIP Image Segmentation should use annotation_specid_token.
         */
        category?: number | null;
        /**
    ...
    export interface Schema$XPSMetricEntry {
        /**
         * For billing metrics that are using legacy sku's, set the legacy billing metric id here. This will be sent to Chemist as the "cloudbilling.googleapis.com/argentum_metricid" label. Otherwise leave empty.
         */
    ...
    export interface Schema$XPSRow {
        ...
        /**
         * The values of the row cells, given in the same order as the columnids. If columnids is not set, then in the same order as the input_feature_columnids in TablesModelMetadata.
         */
        values?: any[] | null;
    }
    ...
    export interface Schema$XPSSpeechModelSpec {
        /**
         * Required for speech xps backend. Speech xps has to use datasetid and modelid as the primary key in db so that speech API can query the db directly.
         */
    ...
    export interface Schema$XPSSpeechModelSpecSubModelSpec {
        ...
        biasingModelType?: string | null;
        /**
         * In S3, Recognition ClientContextId.clientid
         */
        clientId?: string | null;
        /**
         * In S3, Recognition ClientContextId.contextid
         */
