...
function validatePaymentVerification() {
  ...
  if (isDefined(params.orderid) === true) {

    var orderId = params.orderid;
    var payload = orderId + '|' + paymentId;
  } else if (isDefined(params.subscriptionid) === true) {

    var subscriptionId = params.subscriptionid;
    var payload = paymentId + '|' + subscriptionId;
  } else if (isDefined(params.payment_linkid) === true) {

    var paymentLinkId = params.payment_linkid;
    var paymentLinkRefId = params.payment_link_referenceid;
    var paymentLinkStatus = params.payment_link_status;

    var payload = paymentLinkId + '|' + paymentLinkRefId + '|' + paymentLinkStatus + '|' + paymentId;
  } else {
    throw new Error('Either orderid or subscriptionid is mandatory');
  }
