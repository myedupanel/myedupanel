...
export declare namespace Payments {
    ...
    interface RazorpayRecurringPaymentCreateRequestBody extends Payments.RazorpayPaymentBaseRequestBody {
        /**
         * he `tokenid` generated when the customer successfully completes the authorization payment. 
         * Different payment instruments for the same customer have different `tokenid`.
         */
        token: string;
        /**
    ...
    interface RazorpayPaymentThirdPartyCreateRequestBody extends Omit<RazorpayPaymentBaseRequestBody, 'customerid' | 'notes' | 'description'> {
        /**
    ...
    interface RazorpayPaymentUpiCreateRequestBody extends PartialOptional<RazorpayPaymentBaseRequestBody, 'customerid'> {
        method: string;
        /**
...
declare function payments(api: any): {
    ...
    *
    */
    createUpi(params: Payments.RazorpayPaymentUpiCreateRequestBody): Promise<{ razorpay_paymentid: string; link?: string; }>
