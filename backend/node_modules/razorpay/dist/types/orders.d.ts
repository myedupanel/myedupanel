...
export declare namespace Orders {
    ...
    interface RazorpayAuthorizationCreateRequestBody extends Omit<RazorpayOrderBaseRequestBody, 'offerid' | 'bank_account' | 'partial_payment' | 'first_payment_min_amount'> {
        /**
    ...
    interface LineItems {
        ...
        sku: string;
        /**
         * Unique variantid defined by you.
         */
        variantid: string;
        /**
