...
export declare namespace PaymentLinks {
    ...
    interface RazorpayPaymentLinkUpdateRequestBody extends Pick<RazorpayPaymentLinkBaseRequestBody, 'accept_partial' | 'referenceid' | 'expire_by' | 'notes' | 'reminder_enable'> { }
    ...
    interface RazorpayOffer {
        /**
          * Options to associate the offerid with the Payment Link. 
          * Parent parameter under which the `order` child parameter must be passed.
          */
        order: {
            /**
