...
declare function refunds(api: any): {
    ...
    *
    */
    fetch(refundId: string, params?: { paymentid: string }): Promise<Refunds.RazorpayRefund>
    fetch(refundId: string, params: { paymentid?: string }, callback: (err: INormalizeError | null, data: Refunds.RazorpayRefund) => void): void
    /**
