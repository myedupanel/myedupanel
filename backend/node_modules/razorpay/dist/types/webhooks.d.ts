...
export declare namespace Webhooks {
    ...
    interface RazorpayWebhook extends RazorpayWebhookBaseRequestBody {
        ...
        entity: string;
        /**
         * The unique identifier generated by Razorpay for the sub-merchant who will receive the webhooks. For example, in this case, it will be `accountid` passed in the API URL.
         */
        ownerid: string;
        owner_type: string;
        context: string[];
