...
var CloudinaryStorage = /** @class */ (function () {
    ...
    CloudinaryStorage.prototype._handleFile = function (req, file, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var uploadOptions, _a, publicid, otherParams, _b, _c, _d, _i, untypedKey, key, getterOrValue, value, _e, resp, err_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 9];
                    case 2:
                        _a = this.params, publicid = _a.publicid, otherParams = __rest(_a, ["publicid"]);
                        _b = {};
                        return [4 /*yield*/, (publicid === null || publicid === void 0 ? void 0 : publicid(req, file))];
                    case 3:
                        uploadOptions = (_b.publicid = _f.sent(), _b);
                        _c = [];
